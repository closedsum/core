...
struct CSBLOCKCHAIN_API FCsEthereumABIInput
{
...
USTRUCT(BlueprintType)
struct CSBLOCKCHAIN_API FCsEthereumABIOutput
{
	GENERATED_USTRUCT_BODY()
...
USTRUCT(BlueprintType)
struct CSBLOCKCHAIN_API FCsEthereumABI
{
	GENERATED_USTRUCT_BODY()
...
USTRUCT(BlueprintType)
struct CSBLOCKCHAIN_API FCsEthereumWeb3DeployLink
{
	GENERATED_USTRUCT_BODY()
...
class CSBLOCKCHAIN_API CsEthereumContract : public ICsBlockchainContract
{
// Interface
#pragma region
