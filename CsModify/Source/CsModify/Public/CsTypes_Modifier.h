...
struct CSMODIFY_API EMCsNumericValueModifierApplication : public TCsEnumMap<ECsNumericValueModifierApplication>
{
...
namespace NCsNumericValueModifierApplication
{
	...
	namespace Ref
	{
		extern CSMODIFY_API const Type Multiply;
		extern CSMODIFY_API const Type Add;
		extern CSMODIFY_API const Type Replace;
		extern CSMODIFY_API const Type ReplaceOnlyIfGreater;
		extern CSMODIFY_API const Type PercentAddFirst;
		extern CSMODIFY_API const Type PercentAddLast;
		extern CSMODIFY_API const Type PercentSubtractFirst;
		extern CSMODIFY_API const Type PercentSubtractLast;
		extern CSMODIFY_API const Type ECsNumericValueModifierApplication_MAX;
	}
}
	...
	namespace NValue
	{
		namespace NNumeric
		{
			...
			*/
			...
			struct CSMODIFY_API EMApplication : public TCsEnumMap<EApplication>
			{
			...
			namespace NApplication
			{
				namespace Ref
				{
					...
					extern CSMODIFY_API const Type PercentSubtractFirst;
					extern CSMODIFY_API const Type PercentSubtractLast;
					extern CSMODIFY_API const Type EApplication_MAX;
				}
...
struct CSMODIFY_API EMCsNumericValueCreateModifier : public TCsEnumMap<ECsNumericValueCreateModifier>
{
...
namespace NCsNumericValueCreateModifier
{
	...
	namespace Ref
	{
		extern CSMODIFY_API const Type Current;
		extern CSMODIFY_API const Type CurrentAndMultiplyBy;
		extern CSMODIFY_API const Type CurrentAndAddTo;
		extern CSMODIFY_API const Type ECsNumericValueCreateModifier_MAX;
	}
}
...
namespace NCsModifier
{
	namespace NValue
	{
		namespace NNumeric
		{
			...
			struct CSMODIFY_API EMCreate : public TCsEnumMap<ECreate>
			{
			...
			namespace NCreate
			{
				namespace Ref
				{
					...
					extern CSMODIFY_API const Type CurrentAndMultiplyBy;
					extern CSMODIFY_API const Type CurrentAndAddTo;
					extern CSMODIFY_API const Type ECreate_MAX;
				}
