...
namespace NCsResource
{
	namespace NManager
	{
		namespace NValue
		{
			...
			class TAbstract : public NCsResource::NManager::IManager
			{
				static_assert(std::is_base_of<TCsResourceContainer<ResourceType>, ResourceContainerType>(), "NCsResource::NManager::NValue::TAbstract: ResourceContainerType does NOT derive from TCsResourceContainer<ResourceType>.");
	
				static_assert(std::is_abstract<ResourceType>(), "NCsResource::NManager::NValue::TAbstract: ResourceType must be Abstract.");
			...
			public:
				...
				TAbstract() :
					...
					AllocationOrder()
				{
					Name = TEXT("NCsResource::NManager::NValue::TAbstract");
					Name_Internal = FName(*Name);

					AdvancePoolIndex = &TAbstract<ResourceType, ResourceContainerType>::AdvancePoolIndexByOrder;
				}
			...
			private:
				...
				void (TAbstract<ResourceType, ResourceContainerType>::* AdvancePoolIndex)();
			...
			public:
				...
				*  Default value is NCsResource::NManager::NValue::TAbstract.
				*
