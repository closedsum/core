...
class CSCOREDEPRECATED_API FCsManager_Widget : public TCsManager_PooledObjects_TMap<ECsSimpleWidgetType, UCsPooledWidget, FCsWidgetPayload, CS_POOLED_WIDGET_PAYLOAD_SIZE>
{
private:
...
UCLASS()
class CSCOREDEPRECATED_API UICsManager_Widget : public UObject
{
