...
struct CSSKELETALMESH_API FCsSkeletalMeshAttachment
{
	GENERATED_USTRUCT_BODY()

	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "CsSkeletalMesh|Skeletal Mesh")
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "CsSkeletalMesh|Skeletal Mesh", meta = (Bitmask, BitmaskEnum = "/Script.CsTypes.ECsTransformRules"))
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "CsSkeletalMesh|Skeletal Mesh")
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "CsSkeletalMesh|Skeletal Mesh", meta = (UIMin = "0", ClampMin = "0", UIMax = "255", ClampMax = "255"))
...
#undef AttachmentType
	...
	bool AttachSafe(const FString& Context, USceneComponent* Parent, USkeletalMeshComponent* Child, void(*Log)(const FString&) = &NCsSkeletalMesh::FLog::Warning) const;
...
namespace NCsSkeletalMesh
{
	...
	{
		struct CSSKELETALMESH_API FAttachment
		{
		private:
