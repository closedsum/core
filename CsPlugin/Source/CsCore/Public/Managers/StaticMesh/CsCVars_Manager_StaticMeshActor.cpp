...
namespace NCsCVarLog
{
	...
	namespace Map
	{
		CSCORE_API CS_ADD_TO_CVAR_MAP(LogManagerStaticMeshActorTransactions, CsCVarLogManagerStaticMeshActorTransactions);
		// Scoped Timer
		CSCORE_API CS_ADD_TO_CVAR_MAP(LogManagerStaticMeshActorScopedTimer, CsCVarLogManagerStaticMeshActorScopedTimer);
		CSCORE_API CS_ADD_TO_CVAR_MAP(LogManagerStaticMeshActorScopedTimerCreatePool, CsCVarLogManagerStaticMeshActorScopedTimerCreatePool);
		CSCORE_API CS_ADD_TO_CVAR_MAP(LogManagerStaticMeshActorScopedTimerUpdate, CsCVarLogManagerStaticMeshActorScopedTimerUpdate);
		CSCORE_API CS_ADD_TO_CVAR_MAP(LogManagerStaticMeshActorScopedTimerUpdateObject, CsCVarLogManagerStaticMeshActorScopedTimerUpdateObject);
		CSCORE_API CS_ADD_TO_CVAR_MAP(LogManagerStaticMeshActorScopedTimerAllocate, CsCVarLogManagerStaticMeshActorScopedTimerAllocate);
		CSCORE_API CS_ADD_TO_CVAR_MAP(LogManagerStaticMeshActorScopedTimerAllocateObject, CsCVarLogManagerStaticMeshActorScopedTimerAllocateObject);
		CSCORE_API CS_ADD_TO_CVAR_MAP(LogManagerStaticMeshActorScopedTimerDeallocate, CsCVarLogManagerStaticMeshActorScopedTimerDeallocate);
		CSCORE_API CS_ADD_TO_CVAR_MAP(LogManagerStaticMeshActorScopedTimerDeallocateObject, CsCVarLogManagerStaticMeshActorScopedTimerDeallocateObject);
		CSCORE_API CS_ADD_TO_CVAR_MAP(LogManagerStaticMeshActorScopedTimerSpawn, CsCVarLogManagerStaticMeshActorScopedTimerSpawn);
		CSCORE_API CS_ADD_TO_CVAR_MAP(LogManagerStaticMeshActorScopedTimerDestroy, CsCVarLogManagerStaticMeshActorScopedTimerDestroy);
	}
}
...
namespace NCsScopedGroup
{
	...
	namespace Map
	{
		extern CSCORE_API CS_ADD_TO_CVAR_MAP(ManagerStaticMeshActor, CsCVarLogManagerStaticMeshActorScopedTimer);
	}
}
