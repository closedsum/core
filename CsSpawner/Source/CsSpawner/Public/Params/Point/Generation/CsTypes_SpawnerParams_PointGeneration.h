...
struct CSSPAWNER_API EMCsSpawnerPointGenerationCondition : public TCsEnumMap<ECsSpawnerPointGenerationCondition>
{
...
namespace NCsSpawnerPointGenerationCondition
{
	...
	namespace Ref
	{
		...
		extern CSSPAWNER_API const Type CycleComplete;
		extern CSSPAWNER_API const Type ECsSpawnerPointGenerationCondition_MAX;
	}
}
	...
	namespace NPoint
	{
		namespace NGeneration
		{
			...
			*/
			...
			struct CSSPAWNER_API EMCondition : public TCsEnumMap<ECondition>
			{
			...
			namespace NCondition
			{
				namespace Ref
				{
					...
					extern CSSPAWNER_API const Type Once;
					extern CSSPAWNER_API const Type CycleComplete;
					extern CSSPAWNER_API const Type ECondition_MAX;
				}
			}
		}
	}
...
struct CSSPAWNER_API EMCsSpawnerPointGenerationCount : public TCsEnumMap<ECsSpawnerPointGenerationCount>
{
...
namespace NCsSpawnerPointGenerationCount
{
	...
	namespace Ref
	{
		extern CSSPAWNER_API const Type SpawnCount;
		extern CSSPAWNER_API const Type UserDefined;
		extern CSSPAWNER_API const Type ECsSpawnerPointGenerationCount_MAX;
	}
}
