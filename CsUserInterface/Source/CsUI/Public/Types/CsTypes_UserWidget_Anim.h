...
*/
USTRUCT(BlueprintType)
struct CSUI_API FCsUserWidget_Anim_PlayParams : public FTableRowBase
{
	GENERATED_USTRUCT_BODY()
...
*/
USTRUCT(BlueprintType)
struct CSUI_API FCsUserWidget_Render_Scale_Anim_OneShot_ByScalarParams
{
	GENERATED_USTRUCT_BODY()
	...
	namespace NRender
	{
		namespace NScale
		{
			namespace NAnim
			{
				namespace NOneShot
				{
					struct CSUI_API FByScalarParams
					{
					private:
