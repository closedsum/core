...
namespace ECsLoadCached
{
	namespace Str
	{
		extern CSTYPES_API const FString _Path;// = TEXT("_Path");
		extern CSTYPES_API const FString _Internal;// = TEXT("_Internal");
		extern CSTYPES_API const FString _Class;// = TEXT("_Class");
		extern CSTYPES_API const FString _SubclassOf;// = TEXT("_Class");
		extern CSTYPES_API const FString _LoadFlags;//= TEXT("_LoadFlags");
		extern CSTYPES_API const FString _1P_LoadFlags;// = TEXT("1P_LoadFlags");
		extern CSTYPES_API const FString _3P_LoadFlags;// = TEXT("3P_LoadFlags");
		extern CSTYPES_API const FString _3P_Low_LoadFlags;// = TEXT("3P_Low_LoadFlags");
		extern CSTYPES_API const FString VR_LoadFlags;// = TEXT("VR_LoadFlags");
		extern CSTYPES_API const FString _C;// = TEXT("_C");
	}
}
...
namespace NCsLoadCodes
{
	...
	namespace Ref
	{
		extern CSTYPES_API const Type CalculateResourceSizes;
		extern CSTYPES_API const Type SuppressLoadFlagsAllWarning;
		extern CSTYPES_API const Type RecursiveLoadData;
		extern CSTYPES_API const Type RecursiveLoadDataTable;
	}
	*/
...
struct CSTYPES_API EMCsLoadFlags : public TCsEnumFlagMap<ECsLoadFlags>
{
...
namespace NCsLoadFlags
{
	...
	namespace Ref
	{
		extern CSTYPES_API const Type Game;
		extern CSTYPES_API const Type Game1P;
		extern CSTYPES_API const Type Game3P;
		extern CSTYPES_API const Type Game3PLow;
		extern CSTYPES_API const Type GameVR;
		extern CSTYPES_API const Type UI;
		//extern CSTYPES_API const Type All;
	}
...
namespace NCsUnloadCodes
{
	...
	namespace Ref
	{
		extern CSTYPES_API const Type RecursiveUnloadData;
		extern CSTYPES_API const Type RecursiveUnloadDataTable;
	}
	*/
...
struct CSTYPES_API EMCsLoadAsyncOrder : public TCsEnumMap<ECsLoadAsyncOrder>
{
...
namespace NCsLoadAsyncOrder
{
	...
	namespace Ref
	{
		extern CSTYPES_API const Type None;
		extern CSTYPES_API const Type FirstToLast;
		extern CSTYPES_API const Type Bulk;
		extern CSTYPES_API const Type ECsLoadAsyncOrder_MAX;
	}
