...
UCLASS()
class CSINPUT_API UCsScriptLibrary_Input : public UObject
{
...
public:
	...
	UFUNCTION(BlueprintCallable, Category = "CsInput|Library|Input", meta = (AutoCreateRefTerm = "Context,Device,Key"))
	static bool IsKeyValidForDevice(const FString& Context, const ECsInputDevice& Device, const FKey& Key);

	UFUNCTION(BlueprintCallable, Category = "CsInput|Library|Input", meta = (AutoCreateRefTerm = "Context,Mode,Key"))
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "CsInput|Library|Input", meta = (AutoCreateRefTerm = "Context,Action,Device"))
...
public:
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "CsInput|Library|Input", meta = (WorldContext = "WorldContextObject", AutoCreateRefTerm = "Context,ControllerId,KeyMapping"))
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "CsInput|Library|Input", meta = (WorldContext = "WorldContextObject", AutoCreateRefTerm = "Context,ControllerId,Device,Action,Key,Scale"))
...
public:
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "CsInput|Library|Input", meta = (AutoCreateRefTerm = "Context,Action,Key"))
...
public:
	...
	*/
	UFUNCTION(BlueprintPure, Category = "CsInput|Library|Input", meta = (AutoCreateRefTerm = "Mask,Mode"))
