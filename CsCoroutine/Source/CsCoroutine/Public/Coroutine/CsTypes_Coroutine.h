...
namespace NCsCoroutine
{
	...
	struct CSCOROUTINE_API EMState : public TCsEnumMap<EState>
	{
	...
	namespace NState
	{
		...
		namespace Ref
		{
			extern CSCOROUTINE_API const Type Free;
			extern CSCOROUTINE_API const Type Init;
			extern CSCOROUTINE_API const Type Update;
			extern CSCOROUTINE_API const Type End;
			extern CSCOROUTINE_API const Type EState_MAX;
		}

		extern CSCOROUTINE_API const uint8 MAX;
	}
	...
	struct CSCOROUTINE_API EMMessage : public TCsEnumMap<EMessage>
	{
	...
	namespace NMessage
	{
		...
		namespace Ref
		{
			extern CSCOROUTINE_API const Type Notify;
			extern CSCOROUTINE_API const Type Listen;
			extern CSCOROUTINE_API const Type Abort;
			extern CSCOROUTINE_API const Type EMessage_MAX;
		}
	...
	struct CSCOROUTINE_API EMEndReason : public TCsEnumMap<EEndReason>
	{
	...
	namespace NEndReason
	{
		...
		namespace Ref
		{
			extern CSCOROUTINE_API const Type EndOfExecution;
			extern CSCOROUTINE_API const Type AbortMessage;
			extern CSCOROUTINE_API const Type AbortCondition;
			extern CSCOROUTINE_API const Type OwnerIsInvalid;
			extern CSCOROUTINE_API const Type Parent;
			extern CSCOROUTINE_API const Type UniqueInstance;
			extern CSCOROUTINE_API const Type Shutdown;
			extern CSCOROUTINE_API const Type Manual;
			extern CSCOROUTINE_API const Type EEndReason_MAX;
		}
	...
	struct CSCOROUTINE_API EMTransaction : public TCsEnumMap<ETransaction>
	{
	...
	namespace NTransaction
	{
		...
		namespace Ref
		{
			extern CSCOROUTINE_API const Type Allocate;
			extern CSCOROUTINE_API const Type Start;
			extern CSCOROUTINE_API const Type End;
			extern CSCOROUTINE_API const Type ETransaction_MAX;
		}
		...
		namespace Str
		{
			...
			extern CSCOROUTINE_API const TCsString Allocate;
			extern CSCOROUTINE_API const TCsString Start;
			extern CSCOROUTINE_API const TCsString End;
		}
...
#define ECS_COROUTINE_TRANSACTION_MAX (uint8)ETransaction::ETransaction_MAX
	...
	namespace NRegister
	{
		...
		*/
		...
		struct CSCOROUTINE_API EMValueType : public TCsEnumMap<EValueType>
		{
		...
		namespace NValueType
		{
			...
			namespace Ref
			{
				extern CSCOROUTINE_API const Type Flag;
				extern CSCOROUTINE_API const Type Timer;
				extern CSCOROUTINE_API const Type DeltaTime;
				extern CSCOROUTINE_API const Type Int;
				extern CSCOROUTINE_API const Type UnsignedInt;
				...
				extern CSCOROUTINE_API const Type StringPtr;
				extern CSCOROUTINE_API const Type Object;
				extern CSCOROUTINE_API const Type Void;
				extern CSCOROUTINE_API const Type EValueType_MAX;
			}
