...
namespace NCsResource
{
	namespace NManager
	{
		namespace NPointer
		{
			...
			{
				static_assert(std::is_base_of<TCsResourceContainer<ResourceType>, ResourceContainerType>(), "NCsResource::NManager::NPointer::TFixed: ResourceContainerType does NOT implement interface: ICsResourceContainer.");
			...
			public:
				...
				{
					Name		  = TEXT("NCsResource::NManager::NPointer::TFixed");
			...
			private:
				...
				void (NCsResource::NManager::NPointer::TFixed<ResourceType, ResourceContainerType, BUCKET_SIZE>::* AdvancePoolIndex)();
			...
			public:
				...
				*  Default value is NCsResource::NManager::NPointer::TFixed.
				*
