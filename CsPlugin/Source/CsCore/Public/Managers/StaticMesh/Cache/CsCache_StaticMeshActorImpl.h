...
namespace NCsStaticMeshActor
{
	namespace NCache
	{
		...
		* NCsPooledObject::NCache::ICache and NCsStaticMeshActor::NCache::ICache. This only supports 
		...
		*/
		struct CSCORE_API FImpl final : public NCsPooledObject::NCache::ICache,
										public NCsStaticMeshActor::NCache::ICache
		{
		public:
		...
		#pragma endregion NCsStaticMeshActor::NCache::ICache
