...
namespace NCsEnumStructMaskCustomization
{
	namespace NCached
	{
		namespace Str
...
{
	return NCsEnumStructMaskCustomization::NCached::Str::Empty;
}

const FName& FECsEnumStructMaskCustomization::GetEnumStructFName()
{
	return NCsEnumStructMaskCustomization::NCached::Name::None;
}
