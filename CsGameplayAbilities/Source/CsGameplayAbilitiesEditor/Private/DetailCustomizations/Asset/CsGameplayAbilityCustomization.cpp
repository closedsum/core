...
#define LOCTEXT_NAMESPACE "CsGameplayAbilityCustomization"

#define CLASS_TYPE FCsGameplayAbilityCustomization
#define TEMP_GET_MEMBER_NAME_CHECKED GET_MEMBER_NAME_CHECKED(FCsGameplayAbility, Ability)
