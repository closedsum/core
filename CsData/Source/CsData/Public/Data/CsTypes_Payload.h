...
struct CSDATA_API FCsPayload_Data
{
...
public:
	...
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "CsData|Load")
	FName Name;

	/** Object that implements the interface: ICsData. */
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "CsData|Load", meta = (MustImplement = "/Script/CsData.CsData"))
	...
	UPROPERTY(VisibleDefaultsOnly, BlueprintReadOnly, Category = "CsData|Load")
	FCsTArraySoftObjectPath Paths;

	UPROPERTY(VisibleDefaultsOnly, Category = "CsData|Load")
...
USTRUCT(BlueprintType)
struct CSDATA_API FCsPayload_ScriptData
{
	GENERATED_USTRUCT_BODY()
...
public:
	...
	/** Object that implements the interface: ICsData. */
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "CsData|Load", meta = (MustImplement = "/Script/CsData.CsScriptData"))
	TSoftClassPtr<UObject> Data;
...
USTRUCT(BlueprintType)
struct CSDATA_API FCsPayload_DataTable
{
	GENERATED_USTRUCT_BODY()
...
USTRUCT(BlueprintType)
struct CSDATA_API FCsPayload : public FTableRowBase
{
	GENERATED_USTRUCT_BODY()
