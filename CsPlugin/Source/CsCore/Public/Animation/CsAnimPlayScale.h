...
struct CSCORE_API EMCsAnimPlayScale : public TCsEnumMap<ECsAnimPlayScale>
{
...
namespace NCsAnimPlayScale
{
	...
	namespace Ref
	{
		...
		extern CSCORE_API const Type TotalTime;
		extern CSCORE_API const Type ECsAnimPlayScale_MAX;
	}
...
namespace NCsAnim
{
	...
	*/
	...
	struct CSCORE_API EMPlayScale : public TCsEnumMap<EPlayScale>
	{
	...
	namespace NPlayScale
	{
		...
		namespace Ref
		{
			extern CSCORE_API const Type Default;
			extern CSCORE_API const Type TotalTime;
			extern CSCORE_API const Type EPlayScale_MAX;
		}
