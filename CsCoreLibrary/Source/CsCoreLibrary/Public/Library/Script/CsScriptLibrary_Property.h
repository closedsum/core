...
UCLASS()
class CSCORELIBRARY_API UCsScriptLibrary_Property : public UObject
{
...
public:
	...
	*/
	UFUNCTION(BlueprintPure, Category = "CsCoreLibrary|Library|Property", meta = (AutoCreateRefTerm = "Context,Path"))
	...
	*/
	UFUNCTION(BlueprintPure, Category = "CsCoreLibrary|Library|Property", meta = (AutoCreateRefTerm = "Context,PropertyName"))
...
public:
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "CsCoreLibrary|Library|Property", meta = (AutoCreateRefTerm = "Context,PropertyName"))
