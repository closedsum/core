...
/*static*/ void UCsCoordinator_GameEvent::Init(UObject* InRoot /*=nullptr*/, TSubclassOf<UCsCoordinator_GameEvent> CoordinatorClass /*=TSubclassOf<UCsCoordinator_GameEvent>(UCsCoordinator_GameEvent::StaticClass())*/)
{
	...
	{
		UE_LOG(LogCsInput, Warning, TEXT("%s: Init has already been called."), *Context);
	}
#else
	s_bShutdown = false;
...
/*static*/ void UCsCoordinator_GameEvent::Shutdown(UObject* InRoot /*=nullptr*/)
{
	...
	if (!s_Instance)
	{
		UE_LOG(LogCsInput, Warning, TEXT("UCsCoordinator_GameEvent::Shutdown: Coorindator has already been shutdown."));
		return;
	}
...
/*static*/ ICsGetCoordinatorGameEvent* UCsCoordinator_GameEvent::GetSafe_GetCoordinatorGameEvent(UObject* Object)
{
	if (!Object)
	{
		UE_LOG(LogCsInput, Warning, TEXT("UCsStatusEffectCoordinator::GetSafe_GetCoordinatorGameEvent: Object is NULL."));
		return nullptr;
	}
	...
	{
		UE_LOG(LogCsInput, Warning, TEXT("UCsManager_Damage::GetSafe_GetCoordinatorGameEvent: Object: %s does NOT implement the interface: ICsGetManagerSingleton."), *(Object->GetName()));
		return nullptr;
	}
	...
	{
		UE_LOG(LogCsInput, Warning, TEXT("UCsManager_Damage::GetSafe_GetCoordinatorGameEvent: Failed to get object of type: UCsManager_Singleton from Object: %s."), *(Object->GetName()));
		return nullptr;
	}
...
/*static*/ UCsCoordinator_GameEvent* UCsCoordinator_GameEvent::GetFromWorldContextObject(UObject* WorldContextObject)
{
	...
	if (UObject* ContextRoot = GameEventCoordinatorLibrary::GetSafeContextRoot(Context, WorldContextObject))
	{
		...
		UE_LOG(LogCsInput, Warning, TEXT("%s: Failed to find Coordinator of type UCsCoordinator_GameEvent from ContextRoot."), *(ContextRoot->GetName()));
	}
	return nullptr;
}
