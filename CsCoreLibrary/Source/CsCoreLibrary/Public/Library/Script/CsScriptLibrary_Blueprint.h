...
UCLASS()
class CSCORELIBRARY_API UCsScriptLibrary_Blueprint : public UObject
{
...
public:
	...
	* return			Blueprint
	*/
	UFUNCTION(BlueprintCallable, Category = "CsCoreLibrary|Library|Blueprint", meta = (AutoCreateRefTerm = "Context,Path"))
...
public:
	...
	* return
	*/
	UFUNCTION(BlueprintCallable, Category = "CsCoreLibrary|Library|Blueprint", meta = (AutoCreateRefTerm = "Context"))
...
public:
	...
	UFUNCTION(BlueprintPure, Category = "CsCoreLibrary|Library|Blueprint", meta = (DisplayName = "Get Name", BlueprintThreadSafe))
	static FString GetName_SoftObjectPtr(const TSoftObjectPtr<UObject>& SoftObject);

	UFUNCTION(BlueprintPure, Category = "CsCoreLibrary|Library|Blueprint", meta = (DisplayName = "Get FName", BlueprintThreadSafe))
...
public:
	...
	UFUNCTION(BlueprintPure, Category = "CsCoreLibrary|Library|Blueprint", meta = (DisplayName = "Get (SoundCue)", CompactNodeTitle = "->", BlueprintThreadSafe))
	static USoundCue* Conv_CsSoundCueToInternal(const FCsSoundCue& Container);

	UFUNCTION(BlueprintPure, Category = "CsCoreLibrary|Library|Blueprint", meta = (DisplayName = "Get (DataTable)", CompactNodeTitle = "->", BlueprintThreadSafe))
	static UDataTable* Conv_CsDataTableToInternal(const FCsDataTable& Container);

	UFUNCTION(BlueprintPure, Category = "CsCoreLibrary|Library|Blueprint", meta = (DisplayName = "Get (Actor)", CompactNodeTitle = "->", BlueprintThreadSafe))
	static AActor* Conv_CsActorToInternal(const FCsActor& Container);

	UFUNCTION(BlueprintPure, Category = "CsCoreLibrary|Library|Blueprint", meta = (DisplayName = "Get (Class)", CompactNodeTitle = "->", BlueprintThreadSafe))
	static UClass* Conv_CsActorToClass(const FCsActor& Container);

	UFUNCTION(BlueprintPure, Category = "CsCoreLibrary|Library|Blueprint", meta = (DisplayName = "Get (SubclassOf)", CompactNodeTitle = "->", BlueprintThreadSafe))
	static TSubclassOf<AActor> Conv_CsActorToSubclassOf(const FCsActor& Container);

	UFUNCTION(BlueprintPure, Category = "CsCoreLibrary|Library|Blueprint", meta = (DisplayName = "Get (SkeletalMesh)", CompactNodeTitle = "->", BlueprintThreadSafe))
	static USkeletalMesh* Conv_CsSkeletalMeshToInternal(const FCsSkeletalMesh& Container);

	UFUNCTION(BlueprintPure, Category = "CsCoreLibrary|Library|Blueprint", meta = (DisplayName = "Get (Texture)", CompactNodeTitle = "->", BlueprintThreadSafe))
