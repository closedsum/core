...
namespace NCsSkeletalMeshActor
{
	namespace NParams
	{
		struct CSSKELETALMESH_API IParams : public ICsGetInterfaceMap
		{
		public:
		...
		namespace NAnim
		{
			namespace NSequence
			{
				struct CSSKELETALMESH_API FOneShot : public IParams
				{
				public:
...
namespace NCsSkeletalMeshActor
{
	namespace NAnim
	{
		namespace NSequence
		{
			struct CSSKELETALMESH_API FOneShot
			{
			public:
...
struct CSSKELETALMESH_API FCsSkeletalMeshAnimSequenceOneShot
{
...
*/
USTRUCT(BlueprintType)
struct CSSKELETALMESH_API FCsSkeletalMeshAnimMontageOneShot
{
	GENERATED_USTRUCT_BODY()
