...
#include "CsData_PointSequenceWeapon_Collision.generated.h"
	...
	namespace NPoint
	{
		namespace NSequence
		{
			namespace NData
			{
				...
				{
					/**
					* Interface for describing any collision associated with a Point Sequence Weapon.
...
class CSWP_API UCsData_PointSequenceWeapon_Collision : public UCsGetInterfaceMap
{
...
*  Point Sequence Weapon is an object that implements the interface: ICsPointSequenceWeapon.
*/
class CSWP_API ICsData_PointSequenceWeapon_Collision : public ICsGetInterfaceMap
{
