...
struct CSCORELIBRARY_API FCsStaticMeshAttachment
{
	GENERATED_USTRUCT_BODY()

	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "CsCoreLibrary|Static Mesh")
	FCsStaticMesh Mesh;
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "CsCoreLibrary|Static Mesh", meta = (Bitmask, BitmaskEnum = "/Script.CsTypes.ECsTransformRules"))
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "CsCoreLibrary|Static Mesh", meta = (UIMin = "0", ClampMin = "0", UIMax = "255", ClampMax = "255"))
...
#undef AttachmentType
	...
	bool IsTransformValid(const FString& Context, void(*Log)(const FString&) = &NCsCore::NLibrary::FLog::Warning) const;

	void AttachChecked(const FString& Context, USceneComponent* Parent, UStaticMeshComponent* Child) const;
	bool AttachSafe(const FString& Context, USceneComponent* Parent, UStaticMeshComponent* Child, void(*Log)(const FString&) = &NCsCore::NLibrary::FLog::Warning) const;
};
...
namespace NCsStaticMesh
{
	...
	{
		struct CSCORELIBRARY_API FAttachment
		{
		private:
