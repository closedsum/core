...
class CSEDITORDEPRECATED_API SCsGraphPin_ECsCharacterAnimVariation : public SCsGraphPin_EnumStruct
{
public:
	SLATE_BEGIN_ARGS(SCsGraphPin_ECsCharacterAnimVariation) {}
	SLATE_END_ARGS()
