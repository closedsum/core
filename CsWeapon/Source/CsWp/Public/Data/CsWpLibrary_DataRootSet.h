	...
	namespace NDataRootSet
	{
		...
		*/
		...
		/**
			...
			* return
			*/
			static const FCsWpDataRootSet* GetSafe(const FString& Context, const UObject* WorldContext);
			...
			* return				
			*/
			static const FCsWpDataRootSet& GetChecked(const FString& Context, const UGameInstance* GameInstance);
			...
			* return				
			*/
			static const FCsWpDataRootSet& GetChecked(const FString& Context, const UObject* WorldContext);
		...
		#define MemberType FCsWpDataRootSet::EMember
			...
			*/
			...
			FORCEINLINE static RowStructType* GetSafeDataTableRow(const FString& Context, const UObject* WorldContext, const MemberType& Member, const FName& RowName, void(*Log)(const FString&) = &NCsWeapon::FLog::Warning)
			{
			...
			*/
			static bool GetSafeDataTablePath(const FString& Context, const UObject* WorldContext, const MemberType& Member, FString& OutPath, void(*Log)(const FString&) = &NCsWeapon::FLog::Warning);
