...
struct CSMENU_API FECsMenu : public FECsEnum_uint8
{
...
struct CSMENU_API EMCsMenu final : public TCsEnumStructMap<FECsMenu, uint8>
{
...
USTRUCT(BlueprintType)
struct CSMENU_API FECsMenuEvent : public FECsEnum_uint8
{
	GENERATED_USTRUCT_BODY()
...
struct CSMENU_API EMCsMenuEvent final : public TCsEnumStructMap<FECsMenuEvent, uint8>
{
...
namespace NCsMenuEvent
{
	...
	CSMENU_API void PopulateEnumMapFromSettings(const FString& Context, UObject* ContextRoot);
}
