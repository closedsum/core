...
#include "CsTraceWeapon.generated.h"

UINTERFACE(BlueprintType)
class CSWP_API UCsTraceWeapon : public UInterface
{
...
struct CSWP_API FCsTraceWeapon : public TCsInterfaceObject<ICsTraceWeapon>
{
private:

	typedef TCsInterfaceObject<ICsTraceWeapon> Super;
...
public:
	...
	*  The Weapon implements a script interface of type: ICsTraceWeapon.
	*
...
public:
	...
	virtual void SetInterface(ICsTraceWeapon* InInterface) override;
