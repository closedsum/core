...
#include UE_INLINE_GENERATED_CPP_BY_NAME(CsData_ProjectileWeapon_SoundFireImplSlice)
...
const FName NCsWeapon::NProjectile::NFire::NSound::FImplSlice::Name = FName("NCsWeapon::NProjectile::NFire::NSound::FImplSlice");
	...
	namespace NProjectile
	{
		namespace NFire
		{
			namespace NSound
			{
				...
				{
					using namespace NCsWeapon::NProjectile::NFire::NSound::NImplSlice::NCached;
					...
					{
						typedef FCsProjectileWeapon_Fire_SoundParams StructType;
					...
					if (!Success)
					{
						if (Log)
						{
							...
							Log(FString::Printf(TEXT("%s: - Failed to get struct property of type: FCsProjectileWeapon_Fire_SoundParams with name: SoundFireParams.")));
						}
					}
					return Slice;
				}
