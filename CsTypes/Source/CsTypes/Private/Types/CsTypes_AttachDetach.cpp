...
#include UE_INLINE_GENERATED_CPP_BY_NAME(CsTypes_AttachDetach)
...
namespace NCsAttachmentRule
{
	namespace Ref
	{
		...
		CSTYPES_API CS_ADD_TO_ENUM_MAP_CUSTOM(KeepRelative, "Keep Relative");
		CSTYPES_API CS_ADD_TO_ENUM_MAP_CUSTOM(KeepWorld, "Keep World");
		CSTYPES_API CS_ADD_TO_ENUM_MAP_CUSTOM(SnapToTarget, "Snap to Target");
	}
}
...
namespace NCsDetachmentTransformRules
{
	namespace Ref
	{
		...
		CSTYPES_API CS_ADD_TO_ENUM_MAP_CUSTOM(KeepRelativeTransform, "Keep Relative Transform");
		CSTYPES_API CS_ADD_TO_ENUM_MAP_CUSTOM(KeepWorldTransform, "Keep World Transform");
		CSTYPES_API CS_ADD_TO_ENUM_MAP_CUSTOM(ECsDetachmentTransformRules_MAX, "MAX");
	}

	CSTYPES_API const uint8 MAX = (uint8)Type::ECsDetachmentTransformRules_MAX;
}
