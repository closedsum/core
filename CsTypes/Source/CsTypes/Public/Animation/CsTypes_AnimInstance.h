...
struct CSTYPES_API FCsAnimInstance_AnimSequence
{
...
USTRUCT(BlueprintType)
struct CSTYPES_API FCsAnimInstance_AnimMontage
{
	GENERATED_USTRUCT_BODY()
...
USTRUCT(BlueprintType)
struct CSTYPES_API FCsAnimInstance_BlendSpace1D
{
	GENERATED_USTRUCT_BODY()
...
USTRUCT(BlueprintType)
struct CSTYPES_API FCsAnimInstance_BlendSpace
{
	GENERATED_USTRUCT_BODY()
...
USTRUCT(BlueprintType)
struct CSTYPES_API FCsAnimInstance_AimOffset
{
	GENERATED_USTRUCT_BODY()
...
USTRUCT(BlueprintType)
struct CSTYPES_API FCsAnimInstance_Blueprint
{
	GENERATED_USTRUCT_BODY()
