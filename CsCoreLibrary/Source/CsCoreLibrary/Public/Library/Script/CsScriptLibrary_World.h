...
UCLASS()
class CSCORELIBRARY_API UCsScriptLibrary_World : public UObject
{
...
public:
	...
	* return
	*/
	UFUNCTION(BlueprintPure, Category = "CsCoreLibrary|Library|World", meta = (WorldContext = "WorldContextObject", CallableWithoutWorldContext))
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "CsCoreLibrary|Library|World", meta = (AutoCreateRefTerm = "Context"))
