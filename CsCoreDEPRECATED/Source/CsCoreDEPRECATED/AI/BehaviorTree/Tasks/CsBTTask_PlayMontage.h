...
struct CSCOREDEPRECATED_API FCsBTTask_PlayMontage
{
	float ElapsedTime;
...
struct CSCOREDEPRECATED_API FCsBTTask_PlayMontage_StopOnAbort
{
...
UCLASS(config = Game)
class CSCOREDEPRECATED_API UCsBTTask_PlayMontage : public UBTTaskNode
{
