...
//							TArray<FMatrix44f>& Transforms	   = EditTransforms.Transforms;
//
//							const int32& InstanceIndex = Indices[TransformIndex];
//							const FMatrix44f& Transform= Transforms[TransformIndex];
//
...
//					CreateVertexBuffer(InstanceData->GetOriginResourceArray(), (uint32)(AccessFlags | BUF_ShaderResource), 16, PF_A32B32G32R32F, InstanceOriginBuffer.VertexBufferRHI, InstanceOriginSRV);
//					CreateVertexBuffer(InstanceData->GetTransformResourceArray(), (uint32)(AccessFlags | BUF_ShaderResource), InstanceData->GetTranslationUsesHalfs() ? 8 : 16, InstanceData->GetTranslationUsesHalfs() ? PF_FloatRGBA : PF_A32B32G32R32F, InstanceTransformBuffer.VertexBufferRHI, InstanceTransformSRV);
//					CreateVertexBuffer(InstanceData->GetLightMapResourceArray(), (uint32)(AccessFlags | BUF_ShaderResource), 8, PF_R16G16B16A16_SNORM, InstanceLightmapBuffer.VertexBufferRHI, InstanceLightmapSRV);
//					if (InstanceData->GetNumCustomDataFloats() > 0)
//					{
//						CreateVertexBuffer(InstanceData->GetCustomDataResourceArray(), (uint32)(AccessFlags | BUF_ShaderResource), 4, PF_R32_FLOAT, InstanceCustomDataBuffer.VertexBufferRHI, InstanceCustomDataSRV);
...
//			}
//
//			void FBuffer::CreateVertexBuffer(FResourceArrayInterface* InResourceArray, uint32 InUsage, uint32 InStride, uint8 InFormat, FBufferRHIRef& OutVertexBufferRHI, FShaderResourceViewRHIRef& OutInstanceSRV)
//			{
...
//				FRHIResourceCreateInfo CreateInfo(TEXT("NCsStaticMesh::NInstanced::NInstance::FBuffer::CreateVertexBuffer"), InResourceArray);
...
//
//			FVector3d MinScale(0);
//			FVector3d MaxScale(0);
...
//				const FVector3d AxisScales = InstanceTransform.GetScaleVector();
//				const FVector3d BoxDimensions = RenderData->Bounds.BoxExtent * AxisScales * 2;
//
...
//			}
//
//			FBoxSphereBounds ScaledBounds = InstancingUserData->MeshRenderData->Bounds.TransformBy(FTransform3d(FRotator::ZeroRotator, FVector3d::ZeroVector, InstancingUserData->AverageInstancesScale));
...
//}
//
//FBoxSphereBounds UCsInstancedStaticMeshComponent::CalcBounds(const FTransform3d& BoundTransform) const
//{
//	if (GetStaticMesh() && 
//		PerInstanceSMData.Num() > 0)
//	{
...
//	else
//	{
//		return FBoxSphereBounds(BoundTransform.GetLocation(), FVector3d::ZeroVector, 0.f);
//	}
//}
//
...
//}
//
//static bool ComponentRequestsCPUAccess(UCsInstancedStaticMeshComponent* InComponent, ERHIFeatureLevel::Type FeatureLevel)
//{
...
//}
//
//void UCsInstancedStaticMeshComponent::GetInstancesMinMaxScale(FVector3d& MinScale, FVector3d& MaxScale) const
//{
...
//	if (Count > 0)
//	{
//		MinScale = FVector3d(MAX_flt);
//		MaxScale = FVector3d(-MAX_flt);
//
//		for (int32 I = 0; I < Count; ++I)
//		{
//			const InstanceDataType& InstanceData = PerInstanceSMData[I];
//			FVector3d ScaleVector					 = InstanceData.Transform.GetScaleVector();
//
...
//	else
//	{
//		MinScale = FVector3d(1.0f);
//		MaxScale = FVector3d(1.0f);
//	}
//}