...
namespace NCsConsoleCommand
{
	namespace NLibrary
	{
		...
		*/
		struct CSCONSOLECOMMAND_API FParams_GetValue_int32 : public TParams_GetValue<int32>
		{
		private:
		...
		*/
		struct CSCONSOLECOMMAND_API FParams_GetValue_float : public TParams_GetValue<float>
		{
		private:
		...
		struct CSCONSOLECOMMAND_API FParams_GetValue_Vector
		{
		public:
		...
		/**
		*/
		struct CSCONSOLECOMMAND_API FLibrary
		{
			/**
