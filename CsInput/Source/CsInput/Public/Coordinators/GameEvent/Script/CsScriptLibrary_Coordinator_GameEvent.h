...
UCLASS()
class CSINPUT_API UCsScriptLibrary_Coordinator_GameEvent : public UObject
{
...
public:
	...
	*/
	UFUNCTION(BlueprintPure, Category = "CsInput|Library|Coordinator|GameEvent", meta = (WorldContext = "WorldContextObject", CallableWithoutWorldContext, AutoCreateRefTerm = "Context"))
	...
	* return				Coordinator_GameEvent
	*/
	UFUNCTION(BlueprintPure, Category = "CsInput|Library|Coordinator|GameEvent", meta = (DisplayName = "Get (Checked)", WorldContext = "WorldContextObject", CallableWithoutWorldContext, AutoCreateRefTerm = "Context"))
...
public:
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "CsInput|Library|Coordinator|GameEvent", meta = (WorldContext = "WorldContextObject", CallableWithoutWorldContext, AutoCreateRefTerm = "Context,Group,Info"))
	...
	* return					Whether the info was broadcasted or not.
	*/
	UFUNCTION(BlueprintCallable, Category = "CsInput|Library|Coordinator|GameEvent", meta = (WorldContext = "WorldContextObject", CallableWithoutWorldContext, AutoCreateRefTerm = "Context,Event"))
