...
namespace NCsGraphPinMenuEvent
{
	namespace NCached
	{
		namespace Str
		{
			const FString CustomPopulateEnumMap = TEXT("SCsGraphPin_ECsMenuEvent::CustomPopulateEnumMap");
		}
	}
}
...
#define CLASS_TYPE SCsGraphPin_ECsMenuEvent
...
{
	using namespace NCsGraphPinMenuEvent::NCached;
