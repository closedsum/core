...
struct CSFX_API EMCsTraceVisualAttach : public TCsEnumMap<ECsTraceVisualAttach>
{
...
namespace NCsTraceVisualAttach
{
	...
	namespace Ref
	{
		...
		extern CSFX_API const Type Owner;
		extern CSFX_API const Type Component;
		extern CSFX_API const Type ECsTraceVisualAttach_MAX;
	}
...
struct CSFX_API EMCsTraceVisualTransform : public TCsEnumMap<ECsTraceVisualTransform>
{
...
namespace NCsTraceVisualTransform
{
	...
	namespace Ref
	{
		...
		extern CSFX_API const Type Owner;
		extern CSFX_API const Type Component;
		extern CSFX_API const Type ECsTraceVisualTransform_MAX;
	}
