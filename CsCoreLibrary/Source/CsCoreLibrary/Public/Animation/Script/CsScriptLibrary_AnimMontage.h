...
UCLASS()
class CSCORELIBRARY_API UCsScriptLibrary_AnimMontage : public UObject
{ 
...
public:
	...
	* return			AnimMontage
	*/
	UFUNCTION(BlueprintCallable, Category = "CsCoreLibrary|Library|AnimMontage", meta = (AutoCreateRefTerm = "Context,Path"))
...
public:
	...
	UFUNCTION(BlueprintCallable, Category = "CsCoreLibrary|Library|AnimMontage", meta = (DisplayName = "Unload (FCsAnimMontage)", CompactNodeTitle = "Unload"))
	static void FCsAnimMontage_Unload(UPARAM(ref) FCsAnimMontage& Anim)
	{
		Anim.Unload();
	}

	UFUNCTION(BlueprintCallable, Category = "CsCoreLibrary|Library|AnimMontage", meta = (DisplayName = "Unload (FCsAnimMontageInfo)", CompactNodeTitle = "Unload"))
	static void FCsAnimMontageInfo_Unload(UPARAM(ref) FCsAnimMontageInfo& Anim)
	{
		Anim.Unload();
	}

	UFUNCTION(BlueprintCallable, Category = "CsCoreLibrary|Library|AnimMontage", meta = (DisplayName = "Unload (TArray<FCsAnimMontage>)", CompactNodeTitle = "Unload"))
...
public:
	...
	* return			AnimMontage.
	*/
	UFUNCTION(BlueprintPure, Category = "CsCoreLibrary|Library|AnimMontage", meta = (AutoCreateRefTerm = "Context,Path"))
