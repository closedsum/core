...
struct CSFX_API FCsSettings_Manager_FX_PoolParams
{
...
*/
USTRUCT(BlueprintType)
struct CSFX_API FCsSettings_Manager_FX_Parameters
{
	GENERATED_USTRUCT_BODY()
...
USTRUCT(BlueprintType)
struct CSFX_API FCsSettings_Manager_FX
{
	GENERATED_USTRUCT_BODY()
...
USTRUCT(BlueprintType)
struct CSFX_API FCsSettings_Manager_FX_UnitTest
{
	GENERATED_USTRUCT_BODY()
