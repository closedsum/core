...
namespace NCsSound
{
	...
	*/
	...
	public:
		...
		* return			SoundBase.
		*/
		static USoundBase* SafeLoad(const FString& Context, const FSoftObjectPath& Path, void(*Log)(const FString&) = &NCsSound::FLog::Warning);
		...
		* return			SoundBase.
		*/
		static USoundBase* SafeLoad(const FString& Context, const FString& Path, void(*Log)(const FString&) = &NCsSound::FLog::Warning);
	...
	public:
		...
		*/
		static FCsRoutineHandle SafeSpawn(const FString& Context, UObject* WorldContext, ParamsResourceType* Params, void(*Log)(const FString&) = &NCsSound::FLog::Warning);
