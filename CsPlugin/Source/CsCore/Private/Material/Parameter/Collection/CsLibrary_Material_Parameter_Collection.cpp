...
namespace NCsMaterial
{
	namespace NParameter
	{
		namespace NCollection
		{
			...
			/*FUniformBufferRHIRef*/TRefCountPtr<FRHIUniformBuffer>* FLibrary::GetUniformBufferPtrChecked(const FString& Context, FMaterialParameterCollectionInstanceResource* Resource)
			{
				CS_IS_PTR_NULL_CHECKED(Resource)
				...
				return (TRefCountPtr<FRHIUniformBuffer>*)(Base + Offset);
			}

			/*FUniformBufferLayoutRHIRef*/TRefCountPtr<const FRHIUniformBufferLayout>* FLibrary::GetUniformBufferLayoutPtrChecked(const FString& Context, FMaterialParameterCollectionInstanceResource* Resource)
			{
				CS_IS_PTR_NULL_CHECKED(Resource)
				...
				Offset += sizeof(TRefCountPtr<FRHIUniformBuffer>);

				return (TRefCountPtr<const FRHIUniformBufferLayout>*)(Base + Offset);
			}
