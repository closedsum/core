...
struct CSINPUT_API FECsInputActionMap : public FECsEnumMask_int32
{
...
struct CSINPUT_API EMCsInputActionMap : public TCsEnumStructMaskMap<FECsInputActionMap, int32>
{
...
namespace NCsInputActionMap
{
	...
	CSINPUT_API void ConditionalAddLayout();
	CSINPUT_API void AddPropertyChange();
}

// FCsInputActionMapRule
#pragma region

struct CSINPUT_API FCsInputActionMapRule
{
	int32 Clear;
	int32 Set;
