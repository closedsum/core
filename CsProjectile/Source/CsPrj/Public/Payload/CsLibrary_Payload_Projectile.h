...
public:
	...
	*/
	template<typename DerivedType>
	FORCEINLINE static const DerivedType* StaticCastChecked(const FString& Context, const ICsPayload_Projectile* Payload)
	{
		return NCsInterfaceMap::StaticCastChecked<DerivedType, ICsPayload_Projectile>(Context, Payload);
	}
	...
	*/
	template<typename SliceType, typename SliceInterfaceType>
	FORCEINLINE static const SliceType* StaticCastChecked(const FString& Context, const ICsPayload_Projectile* Payload)
	{
		const SliceInterfaceType* Interface = GetInterfaceChecked<SliceInterfaceType>(Context, Payload);
	...
	*/
	template<typename SliceType, typename SliceInterfaceType>
	FORCEINLINE static const SliceType* SafeStaticCastChecked(const FString& Context, const ICsPayload_Projectile* Payload)
	{
		if (const SliceInterfaceType* Interface = GetSafeInterfaceChecked<SliceInterfaceType>(Context, Payload))
		{
			return NCsInterfaceMap::SafeStaticCastChecked<SliceType, SliceInterfaceType>(Context, Interface);
		}
		return nullptr;
	...
	*/
	template<typename OtherInterfaceType>
	FORCEINLINE static const OtherInterfaceType* GetSafeInterfaceChecked(const FString& Context, const ICsPayload_Projectile* Payload)
	{
		return NCsInterfaceMap::GetSafeInterfaceChecked<OtherInterfaceType, ICsPayload_Projectile>(Context, Payload);
	}
...
private:
	...
	*/
	template<typename SliceType, typename SliceInterfaceType>
	static bool CopySliceChecked(const FString& Context, const ICsPayload_Projectile* From, ICsPayload_Projectile* To)
	{
