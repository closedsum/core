...
// Jump
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FCsAIPawn_OnBTTask_Jump_Start, const uint8&, MappingId);
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FCsAIPawn_OnBTTask_Jump_Finish, const uint8&, MappingId);
// RotateToFaceBBEntry
DECLARE_DYNAMIC_MULTICAST_DELEGATE_ThreeParams(FCsAIPawn_OnBTTask_RotateToFaceBBEntry_Start, const uint8&, MappingId, const float&, AngleDelta, const float&, RotationRate);
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FCsAIPawn_OnBTTask_RotateToFaceBBEntry_Finish, const uint8&, MappingId);
// LookAtAndRotateToFace
DECLARE_DYNAMIC_MULTICAST_DELEGATE_ThreeParams(FCsAIPawn_OnBTTask_LookAtAndRotateToFace_Start, const uint8&, MappingId, const float&, AngleDelta, const float&, RotationRate);
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FCsAIPawn_OnBTTask_LookAtAndRotateToFace_Finish, const uint8&, MappingId);
// LookAt
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(FCsAIPawn_OnBTTask_LookAtLocation_Start, const uint8&, MappingId, const FVector&, Location);
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(FCsAIPawn_OnBTTask_LookAtActor_Start, const uint8&, MappingId, AActor*, Actor);
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FCsAIPawn_OnBTTask_LookAt_Aborted, const uint8&, MappingId);
// AimAt
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(FCsAIPawn_OnBTTask_AimAtLocation_Start, const uint8&, MappingId, const FVector&, Location);
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(FCsAIPawn_OnBTTask_AimAtActor_Start, const uint8&, MappingId, AActor*, Actor);
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FCsAIPawn_OnBTTask_AimAt_Aborted, const uint8&, MappingId);
// Shoot
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FCsAIPawn_OnBTTask_Shoot_Start, const uint8&, MappingId);
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FCsAIPawn_OnBTTask_Shoot_Stop, const uint8&, MappingId);
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FCsAIPawn_OnBTTask_Shoot_Aborted, const uint8&, MappingId);
...
{
	extern CSCOREDEPRECATED_API const FECsPawnRoutine StartShootForCount_Internal;
	extern CSCOREDEPRECATED_API const FECsPawnRoutine StartShootForDuration_Internal;
	extern CSCOREDEPRECATED_API const FECsPawnRoutine SyncCurrentViewFromBone_Internal;
}
...
struct CSCOREDEPRECATED_API FCsAIPawnCache : public FCsPooledObjectCache
{
	GENERATED_USTRUCT_BODY()

	UPROPERTY(BlueprintReadWrite)
	TWeakObjectPtr<ACsAIPawn> Pawn;
...
USTRUCT(BlueprintType)
struct CSCOREDEPRECATED_API FCsAIPawnJumpEventInfo
{
	GENERATED_USTRUCT_BODY()
	...
	UPROPERTY(BlueprintReadWrite, meta = (ClampMin = "0.0", UIMin = "0.0"))
	float Time;
	UPROPERTY(BlueprintReadWrite, meta = (ClampMin = "0.0", UIMin = "0.0"))
	float Height;
	UPROPERTY(BlueprintReadWrite, meta = (ClampMin = "0.0", UIMin = "0.0"))
...
UCLASS()
class CSCOREDEPRECATED_API ACsAIPawn : public ACsPawn
{
...
public:
	...
	FCsAIPawn_OnBTTask_Jump_Start OnBTTask_Jump_Start_ScriptEvent;
...
#if WITH_EDITORONLY_DATA
	UPROPERTY(BlueprintAssignable, Category = "Behavior Tree")
	FCsAIPawn_OnBTTask_Jump_Finish OnBTTask_Jump_Finish_ScriptEvent;
#endif // #if WITH_EDITORONLY_DATA
...
#if WITH_EDITORONLY_DATA
	UPROPERTY(BlueprintAssignable, Category = "Behavior Tree")
	FCsAIPawn_OnBTTask_RotateToFaceBBEntry_Start OnBTTask_RotateToFaceBBEntry_Start_ScriptEvent;
#endif // #if WITH_EDITORONLY_DATA
		// Finish
...
#if WITH_EDITORONLY_DATA
	UPROPERTY(BlueprintAssignable, Category = "Behavior Tree")
	FCsAIPawn_OnBTTask_RotateToFaceBBEntry_Finish OnBTTask_RotateToFaceBBEntry_Finish_ScriptEvent;
#endif // #if WITH_EDITORONLY_DATA
...
#if WITH_EDITORONLY_DATA
	UPROPERTY(BlueprintAssignable, Category = "Behavior Tree")
	FCsAIPawn_OnBTTask_LookAtAndRotateToFace_Start OnBTTask_LookAtAndRotateToFace_Start_ScriptEvent;
#endif // #if WITH_EDITORONLY_DATA
		// Finish
...
#if WITH_EDITORONLY_DATA
	UPROPERTY(BlueprintAssignable, Category = "Behavior Tree")
	FCsAIPawn_OnBTTask_LookAtAndRotateToFace_Finish OnBTTask_LookAtAndRotateToFace_Finish_ScriptEvent;
#endif // #if WITH_EDITORONLY_DATA
...
#if WITH_EDITORONLY_DATA
	UPROPERTY(BlueprintAssignable, Category = "Behavior Tree")
	FCsAIPawn_OnBTTask_LookAtLocation_Start OnBTTask_LookAtLocation_Start_ScriptEvent;
#endif // #if WITH_EDITORONLY_DATA
		// Actor Start
...
#if WITH_EDITORONLY_DATA
	UPROPERTY(BlueprintAssignable, Category = "Behavior Tree")
	FCsAIPawn_OnBTTask_LookAtActor_Start OnBTTask_LookAtActor_Start_ScriptEvent;
#endif // #if WITH_EDITORONLY_DATA
		// Abort
...
#if WITH_EDITORONLY_DATA
	UPROPERTY(BlueprintAssignable, Category = "Behavior Tree")
	FCsAIPawn_OnBTTask_LookAt_Aborted OnBTTask_LookAt_Aborted_ScriptEvent;
#endif // #if WITH_EDITORONLY_DATA
...
#if WITH_EDITORONLY_DATA
	UPROPERTY(BlueprintAssignable, Category = "Behavior Tree")
	FCsAIPawn_OnBTTask_AimAtLocation_Start OnBTTask_AimAtLocation_Start_ScriptEvent;
#endif // #if WITH_EDITORONLY_DATA
		// Actor Start
...
#if WITH_EDITORONLY_DATA
	UPROPERTY(BlueprintAssignable, Category = "Behavior Tree")
	FCsAIPawn_OnBTTask_AimAtActor_Start OnBTTask_AimAtActor_Start_ScriptEvent;
#endif // #if WITH_EDITORONLY_DATA
		// Abort
...
#if WITH_EDITORONLY_DATA
	UPROPERTY(BlueprintAssignable, Category = "Behavior Tree")
	FCsAIPawn_OnBTTask_AimAt_Aborted OnBTTask_AimAt_Aborted_ScriptEvent;
#endif // #if WITH_EDITORONLY_DATA
...
#if WITH_EDITORONLY_DATA
	UPROPERTY(BlueprintAssignable, Category = "Behavior Tree")
	FCsAIPawn_OnBTTask_Shoot_Start OnBTTask_Shoot_Start_ScriptEvent;
#endif // #if WITH_EDITORONLY_DATA
		// Stop
...
#if WITH_EDITORONLY_DATA
	UPROPERTY(BlueprintAssignable, Category = "Behavior Tree")
	FCsAIPawn_OnBTTask_Shoot_Stop OnBTTask_Shoot_Stop_ScriptEvent;
#endif // #if WITH_EDITORONLY_DATA
		// Abort
...
#if WITH_EDITORONLY_DATA
	UPROPERTY(BlueprintAssignable, Category = "Behavior Tree")
	FCsAIPawn_OnBTTask_Shoot_Aborted OnBTTask_Shoot_Aborted_ScriptEvent;
#endif // #if WITH_EDITORONLY_DATA
