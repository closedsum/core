...
UCsLibrary_Load_DEPRECATED::UCsLibrary_Load_DEPRECATED(const FObjectInitializer& ObjectInitializer)
...
ECsLoadFlags UCsLibrary_Load_DEPRECATED::ViewTypeToLoadFlags(const ECsViewType& ViewType, const bool& IsLow /*=false*/)
{
...
FString UCsLibrary_Load_DEPRECATED::ToString_FInt32Interval(const FInt32Interval &Interval)
{
	return FString::Printf(TEXT("Min=%d Max=%d"), Interval.Min, Interval.Max);
}

bool UCsLibrary_Load_DEPRECATED::InitFromString_FInt32Interval(const FString& InSourceString, FInt32Interval &OutInterval)
{
...
FString UCsLibrary_Load_DEPRECATED::ToString_FFloatInterval(const FFloatInterval &Interval)
{
	return FString::Printf(TEXT("Min=%f Max=%f"), Interval.Min, Interval.Max);
}

bool UCsLibrary_Load_DEPRECATED::InitFromString_FFloatInterval(const FString& InSourceString, FFloatInterval &OutInterval)
{
...
void UCsLibrary_Load_DEPRECATED::JsonWriter(TSharedRef<TJsonWriter<TCHAR>> &InJsonWriter, const FString& MemberName, const FName &Member)
{
	InJsonWriter->WriteValue(MemberName, Member.ToString());
}

void UCsLibrary_Load_DEPRECATED::JsonWriter(TSharedRef<TJsonWriter<TCHAR>> &InJsonWriter, const FString& MemberName, TArray<FName> &Member, const FString &ElementName)
{
...
void UCsLibrary_Load_DEPRECATED::JsonWriter_ArrayElement(TSharedRef<TJsonWriter<TCHAR>> &InJsonWriter, const FString& MemberName, const FName &Member)
{
...
void UCsLibrary_Load_DEPRECATED::WriteTSoftObjectPtrToJson_AnimBlueprint(TSharedRef<TJsonWriter<TCHAR>> &InJsonWriter, const FString& MemberName, TSoftObjectPtr<UAnimBlueprint> &Member)
{
...
void UCsLibrary_Load_DEPRECATED::WriteSoftObjectPropertyToJson_AnimBlueprint(TSharedRef<TJsonWriter<TCHAR>> &InJsonWriter, USoftObjectProperty* &SoftObjectProperty, void* InObject, const FString& MemberName)
{
...
void UCsLibrary_Load_DEPRECATED::WriteTSoftObjectPtrToJson_Blueprint(TSharedRef<TJsonWriter<TCHAR>> &InJsonWriter, const FString& MemberName, TSoftObjectPtr<UBlueprint> &Member)
{
	if (Member.IsValid() && Member.Get())
	{
...
void UCsLibrary_Load_DEPRECATED::WriteSoftObjectPropertyToJson_Blueprint(TSharedRef<TJsonWriter<TCHAR>> &InJsonWriter, USoftObjectProperty* &SoftObjectProperty, void* InObject, const FString& MemberName)
{
...
void UCsLibrary_Load_DEPRECATED::WriteMemberIntegralArrayPropertyToJson_uint64(TSharedRef<class TJsonWriter<TCHAR>> &InJsonWriter, UArrayProperty* &ArrayProperty, void* InObject, const FString& MemberName)
{
...
void UCsLibrary_Load_DEPRECATED::WriteMemberStructPropertyToJson_Transform(TSharedRef<TJsonWriter<TCHAR>> &InJsonWriter, UStructProperty* &StructProperty, void* InObject, const FString& MemberName)
{
...
void UCsLibrary_Load_DEPRECATED::WriteMemberArrayStructPropertyToJson_Transform(TSharedRef<TJsonWriter<TCHAR>> &InJsonWriter, UArrayProperty* &ArrayProperty, void* InObject, const FString& MemberName)
{
...
void UCsLibrary_Load_DEPRECATED::WriteMemberStructPropertyToJson_FCsData_ShortCode(TSharedRef<class TJsonWriter<TCHAR>> &InJsonWriter, UStructProperty* &StructProperty, void* InObject, const FString& MemberName)
{
	InJsonWriter->WriteObjectStart(MemberName);
		...
		// Type
		InJsonWriter->WriteValue(TEXT("Type"), EMCsDataType::Get()[Member->Type].Name);
		// ShortCode
...
bool UCsLibrary_Load_DEPRECATED::WriteStructToJson_Internal_Helper(TCsWriteStructToJson_Internal Internal, UProperty* Property, TSharedRef<class TJsonWriter<TCHAR>> &InJsonWriter, void* InStruct, UScriptStruct* const &InScriptStruct)
{
	if (Internal)
...
bool UCsLibrary_Load_DEPRECATED::WriteObjectToJson_Internal_Helper(TCsWriteObjectToJson_Internal Internal, UProperty* Property, TSharedRef<class TJsonWriter<TCHAR>> &InJsonWriter, void* InObject, UClass* const &InClass)
{
	if (Internal)
...
void UCsLibrary_Load_DEPRECATED::WriteStructToJson(TSharedRef<TJsonWriter<TCHAR>> &InJsonWriter, void* InStruct, UScriptStruct* const &InScriptStruct, TCsWriteStructToJson_Internal Internal /*=nullptr*/)
{
...
void UCsLibrary_Load_DEPRECATED::WriteStructToJson(TSharedRef<TJsonWriter<TCHAR>> &InJsonWriter, void* InStruct, UScriptStruct* const &InScriptStruct, const TArray<FCsCategoryMemberAssociation> &CategoryMemberAssociations, TCsWriteStructToJson_Internal Internal /*=nullptr*/)
{
...
void UCsLibrary_Load_DEPRECATED::WriteObjectToJson(TSharedRef<TJsonWriter<TCHAR>> &InJsonWriter, void* InObject, UClass* const &InClass, const TArray<FCsCategoryMemberAssociation> &CategoryMemberAssociations, TCsWriteObjectToJson_Internal Internal)
{
	const FString NoCategory = NCsCached::Str::Empty;
	FString Category		 = NoCategory;
	FString LastCategory	 = NoCategory;
...
void UCsLibrary_Load_DEPRECATED::WriteToSoftObjectPropertyFromJson_AnimBlueprint(TSharedPtr<FJsonObject> &JsonObject, USoftObjectProperty* &SoftObjectProperty, void* InObject, const FString& MemberName)
{
	if (TSoftObjectPtr<UAnimBlueprint>* Member = SoftObjectProperty->ContainerPtrToValuePtr<TSoftObjectPtr<UAnimBlueprint>>(InObject))
	{
...
void UCsLibrary_Load_DEPRECATED::WriteToSoftObjectPropertyFromJson_Blueprint(TSharedPtr<FJsonObject> &JsonObject, USoftObjectProperty* &SoftObjectProperty, void* InObject, const FString& MemberName)
{
	if (TSoftObjectPtr<UBlueprint>* Member = SoftObjectProperty->ContainerPtrToValuePtr<TSoftObjectPtr<UBlueprint>>(InObject))
	{
		FString AssetName = JsonObject->GetStringField(MemberName);
...
void UCsLibrary_Load_DEPRECATED::WriteToMemberStructPropertyFromJson_Transform(TSharedPtr<FJsonObject> &JsonObject, UStructProperty* &StructProperty, void* InObject, const FString& MemberName)
{
	if (FTransform* Member = StructProperty->ContainerPtrToValuePtr<FTransform>(InObject))
	{
...
void UCsLibrary_Load_DEPRECATED::WriteToMemberArrayStructPropertyFromJson_Transform(TSharedPtr<FJsonObject> &JsonObject, UArrayProperty* &ArrayProperty, void* InObject, const FString& MemberName)
{
	TArray<FTransform>* Member = ArrayProperty->ContainerPtrToValuePtr<TArray<FTransform>>(InObject);
...
void UCsLibrary_Load_DEPRECATED::WriteToMemberArrayStructPropertyFromJson_Name(TSharedPtr<FJsonObject> &JsonObject, UArrayProperty* &ArrayProperty, void* InObject, const FString& MemberName)
{
...
void UCsLibrary_Load_DEPRECATED::WriteToMemberArrayStructPropertyFromJson_uint64(TSharedPtr<FJsonObject> &JsonObject, UArrayProperty* &ArrayProperty, void* InObject, const FString& MemberName)
{
	TArray<uint64>* Member = ArrayProperty->ContainerPtrToValuePtr<TArray<uint64>>(InObject);
...
void UCsLibrary_Load_DEPRECATED::WriteToMemberStructPropertyFromJson_FCsData_ShortCode(TSharedPtr<class FJsonObject> &JsonObject, UStructProperty* &StructProperty, void* InObject, const FString& MemberName)
{
	FCsData_ShortCode* Member = StructProperty->ContainerPtrToValuePtr<FCsData_ShortCode>(InObject);

	TSharedPtr<FJsonObject> Object = JsonObject->GetObjectField(MemberName);
	const FString& DataTypeName    = Object->GetStringField(TEXT("Type"));
	// Type
	Member->Type = EMCsDataType::Get().GetEnum(DataTypeName).Value;
	// ShortCode
	Member->ShortCode = FName(*(Object->GetStringField(TEXT("ShortCode"))));
}

bool UCsLibrary_Load_DEPRECATED::ReadStructFromJson_Internal_Helper(TCsReadStructFromJson_Internal Internal, UProperty* Property, TSharedPtr<class FJsonObject> &JsonObject, void* InStruct, UScriptStruct* const &InScriptStruct)
{
	if (Internal)
...
bool UCsLibrary_Load_DEPRECATED::ReadObjectFromJson_Internal_Helper(TCsReadObjectFromJson_Internal Internal, UProperty* Property, TSharedPtr<class FJsonObject> &JsonObject, void* InObject, UClass* const &InClass)
{
	if (Internal)
...
void UCsLibrary_Load_DEPRECATED::ReadStructFromJson(TSharedPtr<FJsonObject> &JsonObject, void* InStruct, UScriptStruct* const &InScriptStruct, TCsReadStructFromJson_Internal Internal /*=nullptr*/)
{
	for (TFieldIterator<UProperty> It(InScriptStruct); It; ++It)
	{
		UProperty* Property = Cast<UProperty>(*It);
		...
		if (UStructProperty* StructProperty = Cast<UStructProperty>(*It))
		{
			...
			// EnumStruct
			{
				...
				// FECsDataCollectionType
				if (StructProperty->Struct == FECsDataCollectionType::StaticStruct())
				{ WriteToMemberEnumStructPropertyFromJson<FECsDataCollectionType, EMCsDataCollectionType>(JsonObject, StructProperty, InStruct, MemberName); continue; }
				// FECsInputAction
				if (StructProperty->Struct == FECsInputAction::StaticStruct())
...
void UCsLibrary_Load_DEPRECATED::ReadStructFromJson(TSharedPtr<FJsonObject> &JsonParsed, void* InStruct, UScriptStruct* const &InScriptStruct, const TArray<FCsCategoryMemberAssociation> &CategoryMemberAssociations, TCsReadStructFromJson_Internal Internal /*=nullptr*/)
{
	const FString NoCategory = NCsCached::Str::Empty;
	FString Category		 = NoCategory;
	int32 CategoryIndex		 = 0;
...
void UCsLibrary_Load_DEPRECATED::ReadObjectFromJson(TSharedPtr<FJsonObject> &JsonParsed, void* InObject, UClass* const &InClass, const TArray<FCsCategoryMemberAssociation> &CategoryMemberAssociations, TCsReadObjectFromJson_Internal Internal /*=nullptr*/)
{
	const FString NoCategory = NCsCached::Str::Empty;
	FString Category		 = NoCategory;
	int32 CategoryIndex		 = 0;
...
void UCsLibrary_Load_DEPRECATED::GetSoftObjectPaths(const void* StructValue, UStruct* const& Struct, TArray<FSoftObjectPath>& OutObjectPaths)
{
...
void UCsLibrary_Load_DEPRECATED::GetSoftObjectPaths(const void* StructValue, UStruct* const& Struct, TMap<FName, FSoftObjectPath>& OutObjectPathMap)
{
...
void UCsLibrary_Load_DEPRECATED::GetSoftObjectPaths(ULevel* Level, TMap<FName, FSoftObjectPath>& OutObjectPathMap)
{
...
bool UCsLibrary_Load_DEPRECATED::GetSoftObjectPaths_SoftObjectPath(UProperty* Property, const void* StructValue, const FString& OuterName, FCsLibraryLoad_GetSoftObjectPaths& Result)
{
...
bool UCsLibrary_Load_DEPRECATED::GetSoftObjectPaths_Array_SoftObjectPath(UArrayProperty* ArrayProperty, const void* StructValue, const FString& OuterName, FCsLibraryLoad_GetSoftObjectPaths& Result)
{
	FString StructName = TEXT("");
	bool DoRecursion = false;
...
void UCsLibrary_Load_DEPRECATED::GetSoftObjectPaths(const void* StructValue, UStruct* const& Struct, const FString& OuterName, FCsLibraryLoad_GetSoftObjectPaths& Result)
{
...
void UCsLibrary_Load_DEPRECATED::GetAssetReferenceFromSoftObjectProperty_AnimMontage(USoftObjectProperty* &SoftObjectProperty, void* InObject, UScriptStruct* const &InClass, const ECsLoadFlags& LoadFlags, TArray<FCsStringAssetReference> &OutAssetReferences, const int32 &LoadCodes /*=ECS_LOAD_CODE_CALCULATE_RESOURCE_SIZES*/)
{
...
void UCsLibrary_Load_DEPRECATED::GetAssetReferenceFromSoftObjectProperty_AnimMontage(USoftObjectProperty* &SoftObjectProperty, void* InObject, UClass* const &InClass, const ECsLoadFlags& LoadFlags, TArray<FCsStringAssetReference> &OutAssetReferences, const int32 &LoadCodes /*=ECS_LOAD_CODE_CALCULATE_RESOURCE_SIZES*/)
{
	const FString MemberName = SoftObjectProperty->GetName();
...
void UCsLibrary_Load_DEPRECATED::GetAssetReferenceFromSoftObjectProperty_AnimSequence(USoftObjectProperty* &SoftObjectProperty, void* InObject, UScriptStruct* const &InClass, const ECsLoadFlags& LoadFlags, TArray<FCsStringAssetReference> &OutAssetReferences, const int32 &LoadCodes /*=ECS_LOAD_CODE_CALCULATE_RESOURCE_SIZES*/)
{
	const FString MemberName = SoftObjectProperty->GetName();
...
void UCsLibrary_Load_DEPRECATED::GetAssetReferenceFromSoftObjectProperty_AnimSequence(USoftObjectProperty* &SoftObjectProperty, void* InObject, UClass* const &InClass, const ECsLoadFlags& LoadFlags, TArray<FCsStringAssetReference> &OutAssetReferences, const int32 &LoadCodes /*=ECS_LOAD_CODE_CALCULATE_RESOURCE_SIZES*/)
{
	const FString MemberName = SoftObjectProperty->GetName();
...
void UCsLibrary_Load_DEPRECATED::GetAssetReferenceFromSoftObjectProperty_MaterialInstanceConstant(USoftObjectProperty* &SoftObjectProperty, void* InObject, UClass* const &InClass, const ECsLoadFlags& LoadFlags, TArray<FCsStringAssetReference> &OutAssetReferences, const int32 &LoadCodes /*=ECS_LOAD_CODE_CALCULATE_RESOURCE_SIZES*/)
{
	const FString MemberName = SoftObjectProperty->GetName();
...
void UCsLibrary_Load_DEPRECATED::GetAssetReferenceFromSoftObjectProperty_Blueprint(USoftObjectProperty* &SoftObjectProperty, void* InObject, UScriptStruct* const &InClass, const ECsLoadFlags& LoadFlags, TArray<FCsStringAssetReference> &OutAssetReferences, const int32 &LoadCodes /*=ECS_LOAD_CODE_CALCULATE_RESOURCE_SIZES*/)
{
	const FString MemberName = SoftObjectProperty->GetName();
...
void UCsLibrary_Load_DEPRECATED::GetAssetReferenceFromSoftObjectProperty_Blueprint(USoftObjectProperty* &SoftObjectProperty, void* InObject, UClass* const &InClass, const ECsLoadFlags& LoadFlags, TArray<FCsStringAssetReference> &OutAssetReferences, const int32 &LoadCodes /*=ECS_LOAD_CODE_CALCULATE_RESOURCE_SIZES*/)
{
	const FString MemberName = SoftObjectProperty->GetName();
...
void UCsLibrary_Load_DEPRECATED::GetAssetReferenceFromArraySoftObjectProperty_AnimMontage(UArrayProperty* &ArraySoftObjectProperty, void* InObject, UScriptStruct* const &InClass, const ECsLoadFlags& LoadFlags, TArray<FCsStringAssetReference> &OutAssetReferences, const int32 &LoadCodes /*=ECS_LOAD_CODE_CALCULATE_RESOURCE_SIZES*/)
{
...
void UCsLibrary_Load_DEPRECATED::GetAssetReferenceFromArraySoftObjectProperty_AnimSequence(UArrayProperty* &ArraySoftObjectProperty, void* InObject, UScriptStruct* const &InClass, const ECsLoadFlags& LoadFlags, TArray<FCsStringAssetReference> &OutAssetReferences, const int32 &LoadCodes /*=ECS_LOAD_CODE_CALCULATE_RESOURCE_SIZES*/)
{
	const FString MemberName = ArraySoftObjectProperty->GetName();
...
void UCsLibrary_Load_DEPRECATED::GetAssetReferenceFromArraySoftObjectProperty_MaterialInstanceConstant(UArrayProperty* &ArraySoftObjectProperty, void* InObject, UScriptStruct* const &InClass, const ECsLoadFlags& LoadFlags, TArray<FCsStringAssetReference> &OutAssetReferences, const int32 &LoadCodes /*=ECS_LOAD_CODE_CALCULATE_RESOURCE_SIZES*/)
{
	const FString MemberName = ArraySoftObjectProperty->GetName();
...
void UCsLibrary_Load_DEPRECATED::GetAssetReferenceFromArraySoftObjectProperty_Blueprint(UArrayProperty* &ArraySoftObjectProperty, void* InObject, UScriptStruct* const &InClass, const ECsLoadFlags& LoadFlags, TArray<FCsStringAssetReference> &OutAssetReferences, const int32 &LoadCodes /*=ECS_LOAD_CODE_CALCULATE_RESOURCE_SIZES*/)
{
	const FString MemberName = ArraySoftObjectProperty->GetName();
...
void UCsLibrary_Load_DEPRECATED::GetAssetReferenceFromArraySoftObjectProperty_Blueprint(UArrayProperty* &ArraySoftObjectProperty, void* InObject, UClass* const &InClass, const ECsLoadFlags& LoadFlags, TArray<FCsStringAssetReference> &OutAssetReferences, const int32 &LoadCodes /*=ECS_LOAD_CODE_CALCULATE_RESOURCE_SIZES*/)
{
	const FString MemberName = ArraySoftObjectProperty->GetName();
...
void UCsLibrary_Load_DEPRECATED::GetAssetReferencesFromStruct(void* InStruct, UScriptStruct* const &InScriptStruct, const ECsLoadFlags& LoadFlags, TArray<FCsStringAssetReference> &OutAssetReferences, TCsGetAssetReferencesFromStruct_Internal Internal /*=nullptr*/, const int32 &LoadCodes /*=ECsLoadCodes::CalculateResourceSizes*/)
{
	for (TFieldIterator<UProperty> It(InScriptStruct); It; ++It)
	{
		UProperty* Property = Cast<UProperty>(*It);
...
void UCsLibrary_Load_DEPRECATED::GetAssetReferencesFromObject(void* InObject, UClass* const &InClass, const ECsLoadFlags& LoadFlags, TArray<FCsStringAssetReference> &OutAssetReferences, TCsGetAssetReferencesFromObject_Internal Internal /*=nullptr*/, const int32 &LoadCodes /*=ECsLoadCodes::CalculateResourceSizes*/)
{
	for (TFieldIterator<UProperty> It(InClass); It; ++It)
	{
		UProperty* Property = Cast<UProperty>(*It);
...
void UCsLibrary_Load_DEPRECATED::GetDataTables(const void* StructValue, UStruct* const& Struct, TMap<FName, UDataTable*>& OutDataTableMap)
{
	// Iterate through Properties
	for (TPropertyValueIterator<UProperty> It(Struct, StructValue); It; ++It)
	{
...
void UCsLibrary_Load_DEPRECATED::GetDataTables(ULevel* Level, TMap<FName, UDataTable*>& OutDataTableMap)
{
	for (AActor* Actor : Level->Actors)
	{
		if (!Actor)
...
void UCsLibrary_Load_DEPRECATED::LoadTSoftObjectPtr_AnimBlueprint(const FString& MemberName, TSoftObjectPtr<UAnimBlueprint> AssetPtr, UAnimBlueprintGeneratedClass* &Internal)
{
	...
	{
		UE_LOG(LogLoad, Warning, TEXT("UCsCUCsLibrary_Loadommon::LoadTSoftObjectPtr_AnimBlueprint (%s): Possibly trying to load Anim Blueprint and it is already loaded"), *MemberName);
		return;
	}
	...
	else
	{
		...
		if (!Internal)
		{
			UE_LOG(LogLoad, Warning, TEXT("UCsLibrary_Load::LoadTSoftObjectPtr_AnimBlueprint (%s): Failed to load Anim Blueprint at %s"), *MemberName, *AssetDescription);
		}
	}
}
...
void UCsLibrary_Load_DEPRECATED::LoadSoftObjectProperty_AnimBlueprint(USoftObjectProperty* &SoftObjectProperty, const FString &ObjectName, void* InObject, UClass* const &InClass, const FString& MemberName, const ECsLoadFlags& LoadFlags)
{
	if (TSoftObjectPtr<UAnimBlueprint>* Member = SoftObjectProperty->ContainerPtrToValuePtr<TSoftObjectPtr<UAnimBlueprint>>(InObject))
	{
...
void UCsLibrary_Load_DEPRECATED::LoadSoftObjectProperty_AnimBlueprint(USoftObjectProperty* &SoftObjectProperty, const FString &ObjectName, void* InObject, UScriptStruct* const &InClass, const FString& MemberName, const ECsLoadFlags& LoadFlags)
{
	if (TSoftObjectPtr<UAnimBlueprint>* Member = SoftObjectProperty->ContainerPtrToValuePtr<TSoftObjectPtr<UAnimBlueprint>>(InObject))
	{
		if (!CanLoad(InObject, InClass, MemberName, LoadFlags, 0))
...
void UCsLibrary_Load_DEPRECATED::LoadTSoftObjectPtr_Blueprint(const FString& MemberName, TSoftObjectPtr<UBlueprint> AssetPtr, UBlueprintGeneratedClass* &Internal)
{
	const FString& AssetName = AssetPtr.ToString();
	...
	{
		//UE_LOG(LogLoad, Warning, TEXT("UCsLibrary_Load::LoadTSoftObjectPtr_Blueprint (%s): Possibly trying to load Blueprint and it is already loaded"), *MemberName);
		return;
	}
	...
	else
	{
		...
		if (!Internal)
		{
			UE_LOG(LogLoad, Warning, TEXT("UCsLibrary_Load::LoadTSoftObjectPtr_Blueprint (%s): Failed to load Blueprint at %s"), *MemberName, *AssetDescription);
		}
	}
}
...
void UCsLibrary_Load_DEPRECATED::LoadTArrayTSoftObjectPtr_Blueprint(const FString& MemberName, TArray<TSoftObjectPtr<UBlueprint>> &ArrayAssetPtr, TArray<UBlueprintGeneratedClass*> &ArrayInternal)
{
	...
	for (int32 I = 0; I < Count; ++I)
	{
		...
		if (AssetName != NCsCached::Str::Empty)
		{
			...
			if (!Data)
			{
				UE_LOG(LogLoad, Warning, TEXT("UCsLibrary_Load::LoadTArrayTSoftObjectPtr_Blueprint (%s[%d]): Failed to load Blueprint at %s"), *MemberName, I, *AssetDescription);
			}
			ArrayInternal.Add(Data);
		}
		else
...
void UCsLibrary_Load_DEPRECATED::LoadFCsAnimSequence(const FString& MemberName, FCsAnimSequence* Anim, const ECsLoadFlags& LoadFlags)
{
	LoadFCsStruct<FCsAnimSequence>(MemberName, Anim, LoadFlags);
}

void UCsLibrary_Load_DEPRECATED::LoadFCsAnimSequence(const FString& MemberName, FCsAnimSequence* Anim)
{
	LoadFCsAnimSequence(MemberName, Anim, ECsLoadFlags::Game);
}

void UCsLibrary_Load_DEPRECATED::LoadFCsFpvAnimSequence(const FString& MemberName, FCsFpvAnimSequence* Anim, const ECsLoadFlags& LoadFlags)
{
	LoadFCsStruct<FCsFpvAnimSequence>(MemberName, Anim, LoadFlags);
}

void UCsLibrary_Load_DEPRECATED::LoadFCsFpvAnimSequence(const FString& MemberName, FCsFpvAnimSequence* Anim, const ECsViewType& ViewType)
{
...
void UCsLibrary_Load_DEPRECATED::LoadFCsAnimMontage(const FString& MemberName, FCsAnimMontage* Anim, const ECsLoadFlags& LoadFlags)
{
	LoadFCsStruct<FCsAnimMontage>(MemberName, Anim, LoadFlags);
}

void UCsLibrary_Load_DEPRECATED::LoadFCsAnimMontage(const FString& MemberName, FCsAnimMontage* Anim)
{
	LoadFCsAnimMontage(MemberName, Anim, ECsLoadFlags::Game);
}

void UCsLibrary_Load_DEPRECATED::LoadFCsFpvAnimMontage(const FString& MemberName, FCsFpvAnimMontage* Anim, const ECsLoadFlags& LoadFlags)
{
	LoadFCsStruct<FCsFpvAnimMontage>(MemberName, Anim, LoadFlags);
}

void UCsLibrary_Load_DEPRECATED::LoadFCsFpvAnimMontage(const FString& MemberName, FCsFpvAnimMontage* Anim, const ECsViewType& ViewType)
{
	ECsLoadFlags LoadFlags = ECsLoadFlags::Game;
...
void UCsLibrary_Load_DEPRECATED::LoadFCsBlendSpace1D(const FString& MemberName, FCsBlendSpace1D* Blend, const ECsLoadFlags& LoadFlags)
{
	LoadFCsStruct<FCsBlendSpace1D>(MemberName, Blend, LoadFlags);
}

void UCsLibrary_Load_DEPRECATED::LoadFCsBlendSpace1D(const FString& MemberName, FCsBlendSpace1D* Blend)
{
	LoadFCsBlendSpace1D(MemberName, Blend, ECsLoadFlags::Game);
}

void UCsLibrary_Load_DEPRECATED::LoadFCsFpvBlendSpace1D(const FString& MemberName, FCsFpvBlendSpace1D* Blend , const ECsLoadFlags& LoadFlags)
{
	LoadFCsStruct<FCsFpvBlendSpace1D>(MemberName, Blend, LoadFlags);
}

void UCsLibrary_Load_DEPRECATED::LoadFCsFpvBlendSpace1D(const FString& MemberName, FCsFpvBlendSpace1D* Blend, const ECsViewType& ViewType)
{
	ECsLoadFlags LoadFlags = ECsLoadFlags::Game;
...
void UCsLibrary_Load_DEPRECATED::LoadFCsBlendSpace(const FString& MemberName, FCsBlendSpace* Blend, const ECsLoadFlags& LoadFlags)
{
	LoadFCsStruct<FCsBlendSpace>(MemberName, Blend, LoadFlags);
}

void UCsLibrary_Load_DEPRECATED::LoadFCsBlendSpace(const FString& MemberName, FCsBlendSpace* Blend)
{
	LoadFCsBlendSpace(MemberName, Blend, ECsLoadFlags::Game);
}

void UCsLibrary_Load_DEPRECATED::LoadFCsFpvBlendSpace(const FString& MemberName, FCsFpvBlendSpace* Blend, const ECsLoadFlags& LoadFlags)
{
	LoadFCsStruct<FCsFpvBlendSpace>(MemberName, Blend, LoadFlags);
}

void UCsLibrary_Load_DEPRECATED::LoadFCsFpvBlendSpace(const FString& MemberName, FCsFpvBlendSpace* Blend, const ECsViewType& ViewType)
{
	ECsLoadFlags LoadFlags = ECsLoadFlags::Game;
...
void UCsLibrary_Load_DEPRECATED::LoadFCsAimOffset(const FString& MemberName, FCsAimOffset* Blend, const ECsLoadFlags& LoadFlags)
{
	LoadFCsStruct<FCsAimOffset>(MemberName, Blend, LoadFlags);
}

void UCsLibrary_Load_DEPRECATED::LoadFCsAimOffset(const FString& MemberName, FCsAimOffset* Blend)
{
	LoadFCsAimOffset(MemberName, Blend, ECsLoadFlags::Game);
}

void UCsLibrary_Load_DEPRECATED::LoadFCsFpvAimOffset(const FString& MemberName, FCsFpvAimOffset* Blend, const ECsLoadFlags& LoadFlags)
{
	LoadFCsStruct<FCsFpvAimOffset>(MemberName, Blend, LoadFlags);
}

void UCsLibrary_Load_DEPRECATED::LoadFCsFpvAimOffset(const FString& MemberName, FCsFpvAimOffset* Blend, const ECsViewType& ViewType)
{
	ECsLoadFlags LoadFlags = ECsLoadFlags::Game;
...
bool UCsLibrary_Load_DEPRECATED::CanLoad(void* InObject, UScriptStruct* const &InClass, const FString& MemberName, const ECsLoadFlags& LoadFlags, const int32 &LoadCodes)
{
...
bool UCsLibrary_Load_DEPRECATED::CanLoad(void* InObject, UClass* const &InClass, const FString& MemberName, const ECsLoadFlags& LoadFlags, const int32 &LoadCodes)
{
								// MemberName + TEXT("_LoadFlags")
	const FString FlagMemberName = MemberName + ECsLoadCached::Str::_LoadFlags;
...
bool UCsLibrary_Load_DEPRECATED::CanLoad(void* StructValue, UStruct* const& Struct, const FString& MemberName, const ECsLoadFlags& LoadFlags, const int32& LoadCodes)
{
								// MemberName + TEXT("_LoadFlags")
	const FString FlagMemberName = MemberName + ECsLoadCached::Str::_LoadFlags;
...
void UCsLibrary_Load_DEPRECATED::LoadSoftObjectProperty_Blueprint(USoftObjectProperty* &SoftObjectProperty, const FString &ObjectName, void* InObject, UClass* const &InClass, const FString& MemberName, const ECsLoadFlags& LoadFlags)
{
	if (TSoftObjectPtr<UBlueprint>* Member = SoftObjectProperty->ContainerPtrToValuePtr<TSoftObjectPtr<UBlueprint>>(InObject))
	{
										// MemberName = TEXT("_Internal")
...
void UCsLibrary_Load_DEPRECATED::LoadSoftObjectProperty_Blueprint(USoftObjectProperty* &SoftObjectProperty, const FString &ObjectName, void* InObject, UScriptStruct* const &InClass, const FString& MemberName, const ECsLoadFlags& LoadFlags)
{
	if (TSoftObjectPtr<UBlueprint>* Member = SoftObjectProperty->ContainerPtrToValuePtr<TSoftObjectPtr<UBlueprint>>(InObject))
	{
		if (!CanLoad(InObject, InClass, MemberName, LoadFlags, 0))
...
void UCsLibrary_Load_DEPRECATED::LoadArraySoftObjectProperty_Blueprint(UArrayProperty* &ArrayProperty, const FString &ObjectName, void* InObject, UClass* const &InClass, const FString& MemberName, const ECsLoadFlags& LoadFlags)
{
...
void UCsLibrary_Load_DEPRECATED::LoadArraySoftObjectProperty_Blueprint(UArrayProperty* &ArrayProperty, const FString &ObjectName, void* InObject, UScriptStruct* const &InClass, const FString& MemberName, const ECsLoadFlags& LoadFlags)
{
	if (TArray<TSoftObjectPtr<UBlueprint>>* Member = ArrayProperty->ContainerPtrToValuePtr<TArray<TSoftObjectPtr<UBlueprint>>>(InObject))
	{
		if (!CanLoad(InObject, InClass, MemberName, LoadFlags, 0))
...
void UCsLibrary_Load_DEPRECATED::LoadStructWithTSoftObjectPtrs(const FString &ObjectName, void* InStruct, UScriptStruct* const &InScriptStruct, const ECsLoadFlags& LoadFlags, TCsLoadStructWithTSoftObjectPtrs_Internal Internal /*=nullptr*/)
{
	for (TFieldIterator<UProperty> It(InScriptStruct); It; ++It)
	{
		UProperty* Property = Cast<UProperty>(*It);
...
void UCsLibrary_Load_DEPRECATED::LoadObjectWithTSoftObjectPtrs(const FString &ObjectName, void* InObject, UClass* const &InClass, const ECsLoadFlags& LoadFlags, TCsLoadObjectWithTSoftObjectPtrs_Internal Internal /*=nullptr*/)
{
	for (TFieldIterator<UProperty> It(InClass); It; ++It)
	{
		UProperty* Property = Cast<UProperty>(*It);
...
void UCsLibrary_Load_DEPRECATED::LoadSoftClassProperty(USoftClassProperty*& SoftClassProperty, void* StructValue, UStruct* const& Struct, const FString& MemberName, const ECsLoadFlags& LoadFlags)
{
...
void UCsLibrary_Load_DEPRECATED::LoadArraySoftClassProperty(UArrayProperty*& ArrayProperty, void* StructValue, UStruct* const& Struct, const FString& MemberName, const ECsLoadFlags& LoadFlags)
{
	if (!CanLoad(StructValue, Struct, MemberName, LoadFlags, 0))
		return;
...
void UCsLibrary_Load_DEPRECATED::LoadSoftObjectProperty(USoftObjectProperty*& SoftObjectProperty, void* StructValue, UStruct* const& Struct, const FString& MemberName, const ECsLoadFlags& LoadFlags)
{
...
void UCsLibrary_Load_DEPRECATED::LoadArraySoftObjectProperty(UArrayProperty*& ArrayProperty, void* StructValue, UStruct* const& Struct, const FString& MemberName, const ECsLoadFlags& LoadFlags)
{
	if (!CanLoad(StructValue, Struct, MemberName, LoadFlags, 0))
		return;
...
void UCsLibrary_Load_DEPRECATED::LoadArrayStructProperty(UArrayProperty*& ArrayProperty, void* StructValue)
{
	FScriptArrayHelper_InContainer Helper(ArrayProperty, StructValue);
...
bool UCsLibrary_Load_DEPRECATED::CanLoad(void* StructValue, UStruct* const& Struct, const FString& MemberName, const int32& LoadFlags, const int32& LoadCodes)
{
								// MemberName + TEXT("_LoadFlags")
	const FString FlagMemberName = MemberName + ECsLoadCached::Str::_LoadFlags;
...
void UCsLibrary_Load_DEPRECATED::LoadSoftClassProperty(USoftClassProperty*& SoftClassProperty, void* StructValue, UStruct* const& Struct, const FString& MemberName, const int32& LoadFlags, const int32& LoadCodes)
{
...
void UCsLibrary_Load_DEPRECATED::LoadArraySoftClassProperty(UArrayProperty*& ArrayProperty, void* StructValue, UStruct* const& Struct, const FString& MemberName, const int32& LoadFlags, const int32& LoadCodes)
{
	if (!CanLoad(StructValue, Struct, MemberName, LoadFlags, 0))
		return;
...
void UCsLibrary_Load_DEPRECATED::LoadSoftObjectProperty(USoftObjectProperty*& SoftObjectProperty, void* StructValue, UStruct* const& Struct, const FString& MemberName, const int32& LoadFlags, const int32& LoadCodes)
{
...
void UCsLibrary_Load_DEPRECATED::LoadArraySoftObjectProperty(UArrayProperty*& ArrayProperty, void* StructValue, UStruct* const& Struct, const FString& MemberName, const int32& LoadFlags, const int32& LoadCodes)
{
	if (!CanLoad(StructValue, Struct, MemberName, LoadFlags, 0))
		return;
...
void UCsLibrary_Load_DEPRECATED::LoadArrayObjectProperty(UArrayProperty*& ArrayProperty, void* StructValue, const int32& LoadFlags, const int32& LoadCodes)
{
	FScriptArrayHelper_InContainer Helper(ArrayProperty, StructValue);
...
void UCsLibrary_Load_DEPRECATED::LoadArrayStructProperty(UArrayProperty*& ArrayProperty, void* StructValue, const int32& LoadFlags, const int32& LoadCodes)
{
	FScriptArrayHelper_InContainer Helper(ArrayProperty, StructValue);
...
void UCsLibrary_Load_DEPRECATED::LoadStruct(void* StructValue, UStruct* const& Struct, const int32& LoadFlags, const int32& LoadCodes)
{
	for (TFieldIterator<UProperty> It(Struct); It; ++It)
	{
		UProperty* Property = Cast<UProperty>(*It);
...
void UCsLibrary_Load_DEPRECATED::LoadDataTable(UDataTable* DataTable, const int32& LoadFlags, const int32& LoadCodes)
{
...
void UCsLibrary_Load_DEPRECATED::UnLoadStructWithTSoftObjectPtrs(void* InStruct, UScriptStruct* const &InScriptStruct)
{
	for (TFieldIterator<UProperty> It(InScriptStruct); It; ++It)
	{
		UProperty* Property = Cast<UProperty>(*It);
...
void UCsLibrary_Load_DEPRECATED::UnLoadObjectWithTSoftObjectPtrs(void* InObject, UClass* const &InClass)
{
	for (TFieldIterator<UProperty> It(InClass); It; ++It)
	{
		UProperty* Property = Cast<UProperty>(*It);
...
void UCsLibrary_Load_DEPRECATED::UnloadSoftClassProperty(USoftClassProperty*& SoftClassProperty, void* StructValue, UStruct* const& Struct, const FString& MemberName, const ECsLoadFlags& LoadFlags)
{
	if (FSoftObjectPtr* Member = SoftClassProperty->GetPropertyValuePtr(StructValue))
	{
		if (!Member->IsValid())
		...
		//if (!CanUnload(StructValue, Struct, MemberName, LoadFlags, 0))
		//	return;
...
void UCsLibrary_Load_DEPRECATED::UnloadSoftClassProperty(USoftClassProperty* SoftClassProperty, void* StructValue, UStruct* const& Struct, const FString& MemberName, const int32& UnloadCodes)
{
	if (FSoftObjectPtr* Member = SoftClassProperty->GetPropertyValuePtr_InContainer(StructValue))
	{
		if (!Member->ToSoftObjectPath().IsValid())
...
void UCsLibrary_Load_DEPRECATED::UnloadArraySoftClassProperty(UArrayProperty* ArrayProperty, void* StructValue, UStruct* const& Struct, const FString& MemberName, const int32& UnloadCodes)
{
	// Check if an "Internal" member exists (i.e. MemberName + _Internal)
...
void UCsLibrary_Load_DEPRECATED::UnloadSoftObjectProperty(USoftObjectProperty* SoftObjectProperty, void* StructValue, UStruct* const& Struct, const FString& MemberName, const int32& UnloadCodes)
{
	if (FSoftObjectPtr* Member = SoftObjectProperty->GetPropertyValuePtr_InContainer(StructValue))
	{
		if (!Member->ToSoftObjectPath().IsValid())
...
void UCsLibrary_Load_DEPRECATED::UnloadArraySoftObjectProperty(UArrayProperty* ArrayProperty, void* StructValue, UStruct* const& Struct, const FString& MemberName, const int32& UnloadCodes)
{
	// Check if an "Internal" member exists (i.e. MemberName + _Internal)
...
void UCsLibrary_Load_DEPRECATED::UnloadArrayObjectProperty(UArrayProperty* ArrayProperty, void* StructValue, const int32& UnloadCodes)
{
	FScriptArrayHelper_InContainer Helper(ArrayProperty, StructValue);
...
void UCsLibrary_Load_DEPRECATED::UnloadArrayStructProperty(UArrayProperty* ArrayProperty, void* StructValue, const int32& UnloadCodes)
{
	FScriptArrayHelper_InContainer Helper(ArrayProperty, StructValue);
...
void UCsLibrary_Load_DEPRECATED::UnloadStruct(void* StructValue, UStruct* const& Struct, const int32& UnloadCodes)
{
	for (TFieldIterator<UProperty> It(Struct); It; ++It)
	{
		UProperty* Property = Cast<UProperty>(*It);
...
void UCsLibrary_Load_DEPRECATED::UnloadDataTable(UDataTable* DataTable, const int32& UnloadCodes)
{
	const UScriptStruct* ScriptStruct = DataTable->GetRowStruct();
	UScriptStruct* Temp				  = const_cast<UScriptStruct*>(ScriptStruct);
	UStruct* const Struct			  = Temp;
...
void UCsLibrary_Load_DEPRECATED::GetReferencesReport_ClassProperty(UClassProperty* ClassProperty, const void* StructValue, UStruct* const& Struct, const FString& OuterName, FCsLibraryLoad_GetReferencesReport& OutReport)
{
...
void UCsLibrary_Load_DEPRECATED::GetReferencesReport_ObjectProperty(UObjectProperty* ObjectProperty, const void* StructValue, UStruct* const& Struct, const FString& OuterName, FCsLibraryLoad_GetReferencesReport& OutReport)
{
...
void UCsLibrary_Load_DEPRECATED::GetReferencesReport_SoftClassProperty(USoftClassProperty* SoftClassProperty, const void* StructValue, UStruct* const& Struct, const FString& OuterName, FCsLibraryLoad_GetReferencesReport& OutReport)
{
...
void UCsLibrary_Load_DEPRECATED::GetReferencesReport_SoftObjectProperty(USoftObjectProperty* SoftObjectProperty, const void* StructValue, UStruct* const& Struct, const FString& OuterName, FCsLibraryLoad_GetReferencesReport& OutReport)
{
...
void UCsLibrary_Load_DEPRECATED::GetReferencesReport(const void* StructValue, UStruct* const& Struct, const FString& OuterName, FCsLibraryLoad_GetReferencesReport& OutReport)
{
	for (TFieldIterator<UProperty> It(Struct); It; ++It)
	{
		UProperty* Property = Cast<UProperty>(*It);
...
bool UCsLibrary_Load_DEPRECATED::IsLoadedStructWithTSoftObjectPtrs(const FString &ObjectName, void* InStruct, UScriptStruct* const &InScriptStruct)
{
	bool Pass = true;
...
bool UCsLibrary_Load_DEPRECATED::IsLoadedObjectWithTSoftObjectPtrs(const FString &ObjectName, void* InObject, UClass* const &InClass)
{
	bool Pass = true;
...
void UCsLibrary_Load_DEPRECATED::IsLoaded_LogMessages(const FString &DataName, TArray<FString>& OutMessages)
{
...
ECsLoadAsyncOrder UCsLibrary_Load_DEPRECATED::GetLoadAsyncOrder()
{
...
void UCsLibrary_Load_DEPRECATED::CheckEnumLoadFlags(int32* LoadFlags, const FString &ObjectName, const FString& MemberName)
{
...
void UCsLibrary_Load_DEPRECATED::CheckStructWithEnum(const FString &ObjectName, void* InStruct, UScriptStruct* const &InScriptStruct, TCsCheckStructWithEnum_Internal Internal /*=nullptr*/)
{
}

void UCsLibrary_Load_DEPRECATED::CheckObjectWithEnum(const FString &ObjectName, void* InObject, UClass* const &InClass, TCsCheckObjectWithEnum_Internal Internal /*=nullptr*/)
{
	for (TFieldIterator<UProperty> It(InClass); It; ++It)
	{
		UProperty* Property = Cast<UProperty>(*It);
...
void UCsLibrary_Load_DEPRECATED::GetCategoryMemberAssociations(void* InStruct, UScriptStruct* const &InScriptStruct, TArray<FCsCategoryMemberAssociation> &OutCategoryMemberAssociations)
{
...
void UCsLibrary_Load_DEPRECATED::GetCategoryMemberAssociations(void* InObject, UClass* const &InClass, TArray<FCsCategoryMemberAssociation> &OutCategoryMemberAssociations)
{
	OutCategoryMemberAssociations.Reset();
...
bool UCsLibrary_Load_DEPRECATED::SetObjectMember(void* InObject, UClass* const &InClass, const FString& MemberName, void* MemberValue)
{
	for (TFieldIterator<UProperty> It(InClass); It; ++It)
	{
		UProperty* Property = Cast<UProperty>(*It);
...
bool UCsLibrary_Load_DEPRECATED::SetStructMember(void* InStruct, UScriptStruct* const &InScriptStruct, const FString& MemberName, void* MemberValue)
{
	for (TFieldIterator<UProperty> It(InScriptStruct); It; ++It)
	{
		UProperty* Property = Cast<UProperty>(*It);
...
bool UCsLibrary_Load_DEPRECATED::SetObjectMember(void* InObject, UClass* const &InClass, const uint16 &MemberIndex, void* MemberValue)
{
	uint16 Index = 0;
...
bool UCsLibrary_Load_DEPRECATED::SetStructMember(void* InStruct, UScriptStruct* const &InScriptStruct, const uint16 &MemberIndex, void* MemberValue)
{
	uint16 Index = 0;
...
void UCsLibrary_Load_DEPRECATED::SetObjectMembers(void* FromObject, void* ToObject, UClass* const &InClass, const TArray<FString>* MemberNames)
{
	if (!MemberNames)
		return;
...
void* UCsLibrary_Load_DEPRECATED::GetStructMemberEX(UProperty* Property, void* InStruct, UScriptStruct* const &InScriptStruct, const FString& MemberName)
{
	const FString PropertyName = Property->GetName();
...
UScriptStruct* UCsLibrary_Load_DEPRECATED::GetScriptStructMember(void* InStruct, UScriptStruct* const &InScriptStruct, const FString& MemberName, TCsGetScriptStructMember_Internal Internal /*=nullptr*/)
{
	for (TFieldIterator<UProperty> It(InScriptStruct); It; ++It)
	{
		UProperty* Property = Cast<UProperty>(*It);
...
/*
TEnumAsByte<EMemberType::Type> UCsLibrary_Load::GetObjectMemberType(UClass* const &InClass, const FString& MemberName)
{
	for (TFieldIterator<UProperty> It(InClass); It; ++It)
	{
		UProperty* Property = Cast<UProperty>(*It);
...
TEnumAsByte<EMemberType::Type> UCsLibrary_Load::GetStructMemberType(UScriptStruct* const &InScriptStruct, const FString& MemberName)
{
	for (TFieldIterator<UProperty> It(InScriptStruct); It; ++It)
	{
		UProperty* Property = Cast<UProperty>(*It);
...
*/
uint16 UCsLibrary_Load_DEPRECATED::GetObjectMemberIndex(UClass* const &InClass, const FString& MemberName)
{
	uint16 Index = 0;
...
void UCsLibrary_Load_DEPRECATED::GetObjectMembers(void* InObject, UClass* const &InClass, const TArray<FString>* MemberNames, TArray<void*> &OutMemberValues)
{
	if (!MemberNames)
		return;
