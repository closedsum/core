...
struct CSTIME_API EMCsManagerTimeScaledDeltaTimeApplication : public TCsEnumMap<ECsManagerTimeScaledDeltaTimeApplication>
{
...
namespace NCsManagerTimeScaledDeltaTimeApplication
{
	namespace Ref
	{
		...
		extern CSTIME_API const Type Set;
		extern CSTIME_API const Type Reset;
		extern CSTIME_API const Type ECsManagerTimeScaledDeltaTimeApplication_MAX;
	}
}
	...
	namespace NManager
	{
		namespace NDeltaTime
		{
			namespace NScaled
			{
				...
				struct CSTIME_API EMApplication : public TCsEnumMap<EApplication>
				{
				...
				namespace NApplication
				{
					namespace Ref
					{
						...
						extern CSTIME_API const Type Set;
						extern CSTIME_API const Type Reset;
						extern CSTIME_API const Type EApplication_MAX;
					}
				}
			}
		}
