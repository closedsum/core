...
#define SkeletalMeshManagerLibrary NCsSkeletalMeshActor::NManager::FLibrary
// Pool
#pragma region
...
UObject* UCsScriptLibrary_Manager_SkeletalMeshActor::FindObject(const FString& Context, UObject* WorldContextObject, const FECsSkeletalMeshActor& Type, const int32& Index)
{
	...
	void(*Log)(const FString&) = &NCsSkeletalMesh::FLog::Warning;
...
#undef SkeletalMeshManagerLibrary