...
class CSINPUT_API UCsCoordinator_GameEvent : public UObject
{
...
protected:
	...
	UFUNCTION(BlueprintImplementableEvent, Category = "CsInput|Coordinators|Game Event|Start Play", meta = (DisplayName = "Start Play"))
...
protected:
	...
	UFUNCTION(BlueprintImplementableEvent, Category = "CsInput|Coordinators|Game Event|Update", meta = (DisplayName = "Update"))
...
public:
	...
	UFUNCTION(BlueprintPure, Category = "CsInput|Coordinators|Game Event")
...
#undef OnProccessEventGameInfoEventType
	...
	UPROPERTY(BlueprintAssignable, Category = "CsInput|Coordinators|Game Event")
