...
namespace NCsProcessRoutine
{
	namespace Ref
	{
		CSPLATFORMPROCESS_API const Type StartRead_Internal = EMCsProcessRoutine::Get().Add(Type::StartRead_Internal, TEXT("StartRead_Internal"));
		CSPLATFORMPROCESS_API const Type ECsProcessRoutine_MAX = EMCsProcessRoutine::Get().Add(Type::ECsProcessRoutine_MAX, TEXT("ECsProcessRoutine_MAX"), TEXT("MAX"));
	}
}
...
namespace NCsProcessMonitorOutputEventPurpose
{
	namespace Ref
	{
		CSPLATFORMPROCESS_API const Type FireOnce = EMCsProcessMonitorOutputEventPurpose::Get().Add(Type::FireOnce, TEXT("FireOnce"), TEXT("Fire Once"));
		CSPLATFORMPROCESS_API const Type Loop = EMCsProcessMonitorOutputEventPurpose::Get().Add(Type::Loop, TEXT("Loop"));
		CSPLATFORMPROCESS_API const Type ECsProcessMonitorOutputEventPurpose_MAX = EMCsProcessMonitorOutputEventPurpose::Get().Add(Type::ECsProcessMonitorOutputEventPurpose_MAX, TEXT("ECsProcessMonitorOutputEventPurpose_MAX"), TEXT("MAX"));
	}
}
...
namespace NCsProcessPriorityModifier
{
	namespace Ref
	{
		CSPLATFORMPROCESS_API const Type Idle = EMCsProcessPriorityModifier::Get().Add(Type::Idle, TEXT("Idle"));
		CSPLATFORMPROCESS_API const Type Low = EMCsProcessPriorityModifier::Get().Add(Type::Low, TEXT("Low"));
		CSPLATFORMPROCESS_API const Type Normal = EMCsProcessPriorityModifier::Get().Add(Type::Normal, TEXT("Normal"));
		CSPLATFORMPROCESS_API const Type High = EMCsProcessPriorityModifier::Get().Add(Type::High, TEXT("High"));
		CSPLATFORMPROCESS_API const Type Higher = EMCsProcessPriorityModifier::Get().Add(Type::Higher, TEXT("Higher"));
		CSPLATFORMPROCESS_API const Type ECsProcessPriorityModifier_MAX = EMCsProcessPriorityModifier::Get().Add(Type::ECsProcessPriorityModifier_MAX, TEXT("ECsProcessPriorityModifier_MAX"), TEXT("MAX"));
	}

	namespace Val
	{
		CSPLATFORMPROCESS_API const int32 Idle = -2;
		CSPLATFORMPROCESS_API const int32 Low = -1;
		CSPLATFORMPROCESS_API const int32 Normal = 0;
		CSPLATFORMPROCESS_API const int32 High = 1;
		CSPLATFORMPROCESS_API const int32 Higher = 2;
	}
}
