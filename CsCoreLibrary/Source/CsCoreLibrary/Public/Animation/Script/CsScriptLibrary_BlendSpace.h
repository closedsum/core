...
UCLASS()
class CSCORELIBRARY_API UCsScriptLibrary_BlendSpace : public UObject
{ 
...
public:
	...
	* return			BlendSpace
	*/
	UFUNCTION(BlueprintCallable, Category = "CsCoreLibrary|Library|Anim|Blend Space", meta = (AutoCreateRefTerm = "Context,Path"))
...
public:
	...
	UFUNCTION(BlueprintCallable, Category = "CsCoreLibrary|Library|Anim|Blend Space", meta = (DisplayName = "Unload (FCsBlendSpace1D)", CompactNodeTitle = "Unload"))
	static void FCsBlendSpace1D_Unload(UPARAM(ref) FCsBlendSpace1D& Blend)
	{
		Blend.Unload();
	}

	UFUNCTION(BlueprintCallable, Category = "CsCoreLibrary|Library|Anim|Blend Space", meta = (DisplayName = "Unload (FCsBlendSpace)", CompactNodeTitle = "Unload"))
	static void FCsBlendSpace_Unload(UPARAM(ref) FCsBlendSpace& Blend)
	{
		Blend.Unload();
	}

	UFUNCTION(BlueprintCallable, Category = "CsCoreLibrary|Library|Anim|Blend Space", meta = (DisplayName = "Unload (FCsAimOffset)", CompactNodeTitle = "Unload"))
...
#pragma region
	...
	* return			BlendSpace.
	*/
	UFUNCTION(BlueprintPure, Category = "CsCoreLibrary|Library|Anim|Blend Space", meta = (AutoCreateRefTerm = "Context,Path"))
