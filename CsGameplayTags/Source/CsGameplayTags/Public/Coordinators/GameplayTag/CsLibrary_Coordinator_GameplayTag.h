	...
	namespace NCoordinator
	{
		namespace NLibrary
		{
			...
			public:
				...
				static OnProcessGameplayTagEventEventType& GetChecked_OnProcessGameplayTagEvent_Event(const FString& Context, const UObject* ContextObject, const FECsGameplayTagCoordinatorGroup& Group);

				static FCsCoordinatorGameplayTag_OnProcessGameplayTagEvent& GetChecked_OnProcessGameplayTagEvent_ScriptEvent(const FString& Context, const UObject* ContextObject);
...
using CsGameplayTagCoordinatorLibrary = NCsGameplayTag::NCoordinator::NLibrary::FLibrary;