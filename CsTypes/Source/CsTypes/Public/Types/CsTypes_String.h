...
struct CSTYPES_API EMCsStringEscapeType : public TCsEnumMap<ECsStringEscapeType>
{
protected:
...
namespace NCsStringEscapeType
{
	namespace Ref
	{
		...
		extern CSTYPES_API const Type Int;
		extern CSTYPES_API const Type Float;
		extern CSTYPES_API const Type String;
		extern CSTYPES_API const Type CR;
		extern CSTYPES_API const Type LF;
		extern CSTYPES_API const Type EOL;
		extern CSTYPES_API const Type ECsStringEscapeType_MAX;
	}
}

namespace NCsStringEscapeCharacter
{
	extern CSTYPES_API const FString Int;
	extern CSTYPES_API const FString Float;
	extern CSTYPES_API const FString String;
	extern CSTYPES_API const FString CR;
	extern CSTYPES_API const FString LF;
	extern CSTYPES_API const FString EOL;
}
...
struct CSTYPES_API EMCsStringCompare : public TCsEnumMap<ECsStringCompare>
{
...
namespace NCsStringCompare
{
	...
	namespace Ref
	{
		extern CSTYPES_API const Type Equals;
		extern CSTYPES_API const Type StartsWith;
		extern CSTYPES_API const Type EndsWith;
		extern CSTYPES_API const Type Contains;
		extern CSTYPES_API const Type ECsStringCompare_MAX;
	}
...
struct CSTYPES_API EMCsStringWordRule : public TCsEnumMap<ECsStringWordRule>
{
protected:
	EMCsStringWordRule() {}
...
namespace NCsStringWordRule
{
	namespace Ref
	{
		...
		extern CSTYPES_API const Type MatchCase;
		extern CSTYPES_API const Type Lower;
		extern CSTYPES_API const Type ECsStringWordRule_MAX;
	}
}


USTRUCT(BlueprintType)
struct CSTYPES_API FCsStringWordInfo
{
	GENERATED_USTRUCT_BODY()

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "CsCoreLibrary|String")
	FString Value;
...
USTRUCT(BlueprintType)
struct CSTYPES_API FCsStringWord
{
	GENERATED_USTRUCT_BODY()
	...
	void ProcessInput(const FString &Input)
	{
		...
		{
			if (Ands[I].IsEmpty() || Ands[I].IsContainedBy(Input))
			{
				++And;
			}
		}
		...
		for (int32 I = 0; I < OrCount; ++I)
		{
			Or |= (Ors[I].IsEmpty() || Ors[I].IsContainedBy(Input));
...
USTRUCT(BlueprintType)
struct CSTYPES_API FCsStringPhrase
{
	GENERATED_USTRUCT_BODY()
...
USTRUCT(BlueprintType)
struct CSTYPES_API FCsStringSentence
{
	GENERATED_USTRUCT_BODY()
...
USTRUCT(BlueprintType)
struct CSTYPES_API FCsStringParagraph
{
	GENERATED_USTRUCT_BODY()
	...
	UPROPERTY(BlueprintAssignable, Category = "CsCoreLibrary|String")
...
{
	CSTYPES_API FCsStringSentence CreateOneWordSentence(const FString &Word, const ECsStringWordRule &Rule);
	CSTYPES_API FCsStringParagraph CreateOneWordParagraph(const FString &Word, const ECsStringWordRule &Rule);
}

#pragma endregion Word / Phrase / Sentence / Paragraph

struct CSTYPES_API FCsStringHelper
{
public:
