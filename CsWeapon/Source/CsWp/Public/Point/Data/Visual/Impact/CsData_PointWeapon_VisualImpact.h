...
#include "CsData_PointWeapon_VisualImpact.generated.h"
			...
			namespace NVisual
			{
				namespace NImpact
				{
					...
					*/
					...
					#define ImpactVisualInfoType NCsWeapon::NPoint::NImpact::NVisual::FInfo
...
class CSWP_API UCsData_PointWeapon_VisualImpact : public UCsGetInterfaceMap
{
...
/**
*/
class CSWP_API ICsData_PointWeapon_VisualImpact : public ICsGetInterfaceMap
{
