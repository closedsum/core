...
#include "CsPointSequenceWeapon.generated.h"

UINTERFACE(BlueprintType)
class CSWP_API UCsPointSequenceWeapon : public UInterface
{
...
/**
*/
class CSWP_API ICsPointSequenceWeapon
{
...
struct CSWP_API FCsPointSequenceWeapon : public TCsInterfaceObject<ICsPointSequenceWeapon>
{
private:

	typedef TCsInterfaceObject<ICsPointSequenceWeapon> Super;

#define DataType NCsWeapon::NData::IData

public:

	static const FCsPointSequenceWeapon Empty;
...
public:
	...
	*  The Weapon implements a script interface of type: ICsPointSequenceWeapon.
	*
	* @param Object		An object of type: ICsPointSequenceWeapon.
	*/
...
public:
	...
	virtual ~FCsPointSequenceWeapon() {}

	FORCEINLINE bool operator==(const FCsPointSequenceWeapon& B) const
	{
...
public:
	...
	virtual void SetInterface(ICsPointSequenceWeapon* InInterface) override;
