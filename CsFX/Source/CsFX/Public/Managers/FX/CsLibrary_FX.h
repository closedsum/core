...
namespace NCsFX
{
	...
	*/
	...
	public:
		...
		*/
		static UNiagaraSystem* SafeLoad(const FString& Context, const FSoftObjectPath& Path, CS_FN_PARAM_DEFAULT_LOG_LEVEL);
		...
		* return			NiagaraSystem.
		*/
		static UNiagaraSystem* SafeLoad(const FString& Context, const FString& Path, CS_FN_PARAM_DEFAULT_LOG_LEVEL);
	...
	public:
		...
		* return			Whether or note the Name is a valid User Parameter.
		*/
		static bool IsValidUserVariableName(const FString& Context, const FName& Name, CS_FN_PARAM_DEFAULT_LOG_LEVEL);
		...
		* return			Whether the exposed variable with name: Name exists or not.
		*/
		static bool SafeHasVariableName(const FString& Context, UNiagaraSystem* System, const FName& Name, const ParameterValueType& ValueType, CS_FN_PARAM_DEFAULT_LOG_LEVEL);
		...
		* return			Whether the exposed variable: Parameter exists or not.
		*/
		static bool SafeHasParameter(const FString& Context, UNiagaraSystem* System, const ParameterType* Parameter, CS_FN_PARAM_DEFAULT_LOG_LEVEL);
		...
		* return			Data Interface.
		*/
		static UNiagaraDataInterfaceSkeletalMesh* GetSafeDataInterface(const FString& Context, UNiagaraComponent* Component, const SkeletalMeshParameterType* Parameter, CS_FN_PARAM_DEFAULT_LOG_LEVEL);
		...
		* return
		*/
		static void SetSafeParameter(const FString& Context, UNiagaraComponent* Component, const SkeletalMeshParameterType* Parameter, CS_FN_PARAM_DEFAULT_LOG_LEVEL);
	...
	public:
		...
		static FNiagaraVariable* GetSafeExposedVariable(const FString& Context, UNiagaraSystem* System, const FName& Name, CS_FN_PARAM_DEFAULT_LOG_LEVEL);

		static bool SafeIsExposedVariableInt(const FString& Context, UNiagaraSystem* System, const FName& Name, CS_FN_PARAM_DEFAULT_LOG_LEVEL);

		static bool SetSafeExposedVariableInt(const FString& Context, UNiagaraSystem* System, const FName& Name, const int32& Value, CS_FN_PARAM_DEFAULT_LOG_LEVEL);

	#if WITH_EDITOR
		static bool SafeExposedParameters_PostGenericEditChange(const FString& Context, UNiagaraSystem* System, CS_FN_PARAM_DEFAULT_LOG_LEVEL);
	...
	public:
		...
		*/
		static FCsRoutineHandle SafeSpawn(const FString& Context, UObject* WorldContext, ParamsResourceType* Params, CS_FN_PARAM_DEFAULT_LOG_LEVEL);
		...
		* return
		*/
		static FCsRoutineHandle SafeSpawn_GameState_OnceWithDelay(const FString& Context, UObject* WorldContext, const FCsFX& FX, const float& Delay, CS_FN_PARAM_DEFAULT_LOG_LEVEL);
	...
	public:
		...
		static FNiagaraSystemInstance* GetSafeSystemInstance(const FString& Context, UNiagaraComponent* Component, CS_FN_PARAM_DEFAULT_LOG_LEVEL);

		static bool SafeHasSystemInstance(const FString& Context, const UNiagaraComponent* Component, CS_FN_PARAM_DEFAULT_LOG_LEVEL);
		...
		static TSharedPtr<FNiagaraSystemSimulation, ESPMode::ThreadSafe> GetSafeSystemSimulation(const FString& Context, UNiagaraComponent* Component, CS_FN_PARAM_DEFAULT_LOG_LEVEL);
