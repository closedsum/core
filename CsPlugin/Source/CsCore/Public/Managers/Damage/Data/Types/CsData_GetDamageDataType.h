...
namespace NCsData
{
	...
	*/
	struct CSCORE_API IGetDamageDataType : public ICsGetInterfaceMap
	{
	public:
...
class CSCORE_API UCsData_GetDamageDataType : public UCsGetInterfaceMap
{
...
* Interface to describe getting the type of Damage Data.
*/
class CSCORE_API ICsData_GetDamageDataType : public ICsGetInterfaceMap
{
