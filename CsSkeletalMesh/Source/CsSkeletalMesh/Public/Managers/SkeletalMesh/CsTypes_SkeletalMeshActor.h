...
struct CSSKELETALMESH_API FECsSkeletalMeshActor : public FECsEnum_uint8
{
...
struct CSSKELETALMESH_API EMCsSkeletalMeshActor : public TCsEnumStructMap<FECsSkeletalMeshActor, uint8>
{
...
{
	typedef EMCsSkeletalMeshActor EnumMapType;
	...
	CSSKELETALMESH_API void FromEnumSettings(const FString& Context);

	CSSKELETALMESH_API void PopulateEnumMapFromSettings(const FString& Context, UObject* ContextRoot);

	CSSKELETALMESH_API const FECsSkeletalMeshActor& GetDefault();
}
...
USTRUCT(BlueprintType)
struct CSSKELETALMESH_API FECsSkeletalMeshActorClass : public FECsEnum_uint8
{
	GENERATED_USTRUCT_BODY()
...
struct CSSKELETALMESH_API EMCsSkeletalMeshActorClass : public TCsEnumStructMap<FECsSkeletalMeshActorClass, uint8>
{
...
struct CSSKELETALMESH_API EMCsSkeletalMeshActorDeallocateMethod final : public TCsEnumMap<ECsSkeletalMeshActorDeallocateMethod>
{
...
namespace NCsSkeletalMeshActorDeallocateMethod
{
	...
	namespace Ref
	{
		extern CSSKELETALMESH_API const Type LifeTime;
		extern CSSKELETALMESH_API const Type Complete;
		extern CSSKELETALMESH_API const Type ECsSkeletalMeshActorDeallocateMethod_MAX;
	}

	extern CSSKELETALMESH_API const uint8 MAX;
}
...
*/
USTRUCT(BlueprintType)
struct CSSKELETALMESH_API FCsSkeletalMeshActorPooledInfo
{
	GENERATED_USTRUCT_BODY()
...
struct CSSKELETALMESH_API EMCsSkeletalMeshPayloadChange : public TCsEnumFlagMap<ECsSkeletalMeshPayloadChange>
{
...
namespace NCsSkeletalMeshPayloadChange
{
	...
	namespace Ref
	{
		extern CSSKELETALMESH_API const Type SkeletalMesh;
		extern CSSKELETALMESH_API const Type Materials;
		extern CSSKELETALMESH_API const Type KeepRelativeTransform;
		extern CSSKELETALMESH_API const Type KeepWorldTransform;
		extern CSSKELETALMESH_API const Type SnapToTargetNotIncludingScale;
		extern CSSKELETALMESH_API const Type SnapToTargetIncludingScale;
		extern CSSKELETALMESH_API const Type Transform;
		extern CSSKELETALMESH_API const Type AnimInstance;
	}

	extern CSSKELETALMESH_API const int32 None;
	extern CSSKELETALMESH_API const int32 All;
}
...
namespace NCsSkeletalMeshActor
{
	namespace NPayload
	{
		...
		namespace NChange
		{
			...
			struct CSSKELETALMESH_API FCounter
			{
			protected:
				FCounter() :
					Preserved(0),
