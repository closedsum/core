...
struct CSTHREAD_API EMCsThreadPriority : public TCsEnumMap<ECsThreadPriority>
{
...
namespace NCsThreadPriority
{
	...
	namespace Ref
	{
		extern CSTHREAD_API const Type TPri_Normal;
		extern CSTHREAD_API const Type TPri_AboveNormal;
		extern CSTHREAD_API const Type TPri_BelowNormal;
		extern CSTHREAD_API const Type TPri_Highest;
		extern CSTHREAD_API const Type TPri_Lowest;
		extern CSTHREAD_API const Type TPri_SlightlyBelowNormal;
		extern CSTHREAD_API const Type TPri_TimeCritical;
		extern CSTHREAD_API const Type ECsThreadPriority_MAX;
	}
...
struct CSTHREAD_API FCsRunnableHandle
{
