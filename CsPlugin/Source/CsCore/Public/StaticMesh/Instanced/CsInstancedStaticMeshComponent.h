	...
	namespace NInstanced
	{
		namespace NInstance
		{
			...
			#undef DataType
				...
				FORCEINLINE FVertexBufferRHIRef GetInstanceOriginBuffer() { return InstanceOriginBuffer.VertexBufferRHI; }
				FORCEINLINE FVertexBufferRHIRef GetInstanceTransformBuffer() { return InstanceTransformBuffer.VertexBufferRHI; }
				FORCEINLINE FVertexBufferRHIRef GetInstanceLightmapBuffer() { return InstanceLightmapBuffer.VertexBufferRHI; }
				FORCEINLINE FVertexBufferRHIRef GetInstanceCustomDataBuffer() { return InstanceCustomDataBuffer.VertexBufferRHI; }
