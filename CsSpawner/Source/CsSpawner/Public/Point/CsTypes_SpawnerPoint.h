...
struct CSSPAWNER_API EMCsSpawnerPointCount : public TCsEnumMap<ECsSpawnerPointCount>
{
...
namespace NCsSpawnerPointCount
{
	...
	namespace Ref
	{
		extern CSSPAWNER_API const Type None;
		extern CSSPAWNER_API const Type TotalCount;
		extern CSSPAWNER_API const Type CountPerSpawn;
		extern CSSPAWNER_API const Type ECsSpawnerPointCount_MAX;
	}
...
namespace NCsSpawner
{
	namespace NPoint
	{
		...
		*/
		...
		struct CSSPAWNER_API EMCount : public TCsEnumMap<ECount>
		{
		...
		namespace NCount
		{
			namespace Ref
			{
				...
				extern CSSPAWNER_API const Type TotalCount;
				extern CSSPAWNER_API const Type CountPerSpawn;
				extern CSSPAWNER_API const Type ECount_MAX;
			}
		}
	}
}
...
struct CSSPAWNER_API EMCsSpawnerPointOrder : public TCsEnumMap<ECsSpawnerPointOrder>
{
...
namespace NCsSpawnerPointOrder
{
	...
	namespace Ref
	{
		extern CSSPAWNER_API const Type Random;
		extern CSSPAWNER_API const Type RandomShuffle;
		extern CSSPAWNER_API const Type FirstToLast;
		extern CSSPAWNER_API const Type Custom;
		extern CSSPAWNER_API const Type ECsSpawnerPointOrder_MAX;
	}
...
namespace NCsSpawner
{
	namespace NPoint
	{
		...
		*/
		...
		struct CSSPAWNER_API EMOrder : public TCsEnumMap<EOrder>
		{
		...
		namespace NOrder
		{
			namespace Ref
			{
				...
				extern CSSPAWNER_API const Type FirstToLast;
				extern CSSPAWNER_API const Type Custom;
				extern CSSPAWNER_API const Type EOrder_MAX;
			}
