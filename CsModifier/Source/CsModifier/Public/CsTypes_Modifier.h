...
struct CSMODIFIER_API EMCsNumericValueModifierApplication : public TCsEnumMap<ECsNumericValueModifierApplication>
{
...
namespace NCsNumericValueModifierApplication
{
	...
	namespace Ref
	{
		extern CSMODIFIER_API const Type Multiply;
		extern CSMODIFIER_API const Type Add;
		extern CSMODIFIER_API const Type Replace;
		extern CSMODIFIER_API const Type ReplaceOnlyIfGreater;
		extern CSMODIFIER_API const Type PercentAddFirst;
		extern CSMODIFIER_API const Type PercentAddLast;
		extern CSMODIFIER_API const Type PercentSubtractFirst;
		extern CSMODIFIER_API const Type PercentSubtractLast;
		extern CSMODIFIER_API const Type ECsNumericValueModifierApplication_MAX;
	}
}
	...
	namespace NValue
	{
		namespace NNumeric
		{
			...
			*/
			...
			struct CSMODIFIER_API EMApplication : public TCsEnumMap<EApplication>
			{
			...
			namespace NApplication
			{
				namespace Ref
				{
					...
					extern CSMODIFIER_API const Type PercentSubtractFirst;
					extern CSMODIFIER_API const Type PercentSubtractLast;
					extern CSMODIFIER_API const Type EApplication_MAX;
				}
...
struct CSMODIFIER_API EMCsNumericValueCreateModifier : public TCsEnumMap<ECsNumericValueCreateModifier>
{
...
namespace NCsNumericValueCreateModifier
{
	...
	namespace Ref
	{
		extern CSMODIFIER_API const Type Current;
		extern CSMODIFIER_API const Type CurrentAndMultiplyBy;
		extern CSMODIFIER_API const Type CurrentAndAddTo;
		extern CSMODIFIER_API const Type ECsNumericValueCreateModifier_MAX;
	}
}
...
namespace NCsModifier
{
	namespace NValue
	{
		namespace NNumeric
		{
			...
			struct CSMODIFIER_API EMCreate : public TCsEnumMap<ECreate>
			{
			...
			namespace NCreate
			{
				namespace Ref
				{
					...
					extern CSMODIFIER_API const Type CurrentAndMultiplyBy;
					extern CSMODIFIER_API const Type CurrentAndAddTo;
					extern CSMODIFIER_API const Type ECreate_MAX;
				}
