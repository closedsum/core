...
struct CSINPUT_API FCsResource_Input : public TCsResourceContainer<FCsInput>
{
	~FCsResource_Input(){}
};

struct CSINPUT_API FCsManager_Input : public NCsResource::NManager::NValue::TFixed<FCsInput, FCsResource_Input, 0>
{
	~FCsManager_Input(){}
};
...
namespace NCsManagerInput
{
	namespace NCached
	{
		namespace Str
		{
			extern CSINPUT_API const FString SetCurrentInputActionMap;
			extern CSINPUT_API const FString ClearCurrentInputActionMap;
		}
	}
	...
	namespace NCurrentMode
	{
		namespace NCached
		{
			namespace Str
			{
				extern CSINPUT_API const FString SetValue;
				extern CSINPUT_API const FString ClearValue;
			}
		}
	}
}
...
class CSINPUT_API UCsManager_Input_Default : public UActorComponent,
