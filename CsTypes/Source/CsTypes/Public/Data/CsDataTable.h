...
struct CSTYPES_API FCsDataTable
{
	GENERATED_USTRUCT_BODY()

public:

	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "CsTypes|Data Table")
	TSoftObjectPtr<UDataTable> Data;

	UPROPERTY(BlueprintReadOnly, Category = "CsTypes|Data Table")
	int32 Data_LoadFlags;

	UPROPERTY(Transient, BlueprintReadOnly, Category = "CsTypes|Data Table")
	...
	*/
	...
	UDataTable* GetSafe(const FString& Context, void(*Log)(const FString&) = &NCsTypes::FLog::Warning) const
	{
