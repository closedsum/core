...
namespace NCsSpawnerFrequency
{
	namespace Ref
	{
		...
		CSSPAWNER_API CS_ADD_TO_ENUM_MAP(Count);
		CSSPAWNER_API CS_ADD_TO_ENUM_MAP(TimeCount);
		CSSPAWNER_API CS_ADD_TO_ENUM_MAP(TimeInterval);
		CSSPAWNER_API CS_ADD_TO_ENUM_MAP(Infinite);
		CSSPAWNER_API CS_ADD_TO_ENUM_MAP(InfiniteFillToCount);
		CSSPAWNER_API CS_ADD_TO_ENUM_MAP_CUSTOM(ECsSpawnerFrequency_MAX, "MAX");
	}

	CSSPAWNER_API const uint8 MAX = (uint8)Type::ECsSpawnerFrequency_MAX;
}
...
namespace NCsSpawner
{
	namespace NFrequency
	{
		namespace Ref
		{
			...
			CSSPAWNER_API CS_ADD_TO_ENUM_MAP(Infinite);
			CSSPAWNER_API CS_ADD_TO_ENUM_MAP(InfiniteFillToCount);
			CSSPAWNER_API CS_ADD_TO_ENUM_MAP_CUSTOM(EFrequency_MAX, "MAX");
		}

		CSSPAWNER_API const uint8 MAX = (uint8)EFrequency::EFrequency_MAX;
	}
}
...
namespace NCsSpawnerPoint
{
	namespace Ref
	{
		...
		CSSPAWNER_API CS_ADD_TO_ENUM_MAP(Self);
		CSSPAWNER_API CS_ADD_TO_ENUM_MAP(Transform);
		CSSPAWNER_API CS_ADD_TO_ENUM_MAP(Actor);
		CSSPAWNER_API CS_ADD_TO_ENUM_MAP(Custom);
		CSSPAWNER_API CS_ADD_TO_ENUM_MAP_CUSTOM(ECsSpawnerPoint_MAX, "MAX");
	}

	CSSPAWNER_API const uint8 MAX = (uint8)Type::ECsSpawnerPoint_MAX;
}
...
namespace NCsSpawner
{
	namespace NPoint
	{
		namespace Ref
		{
			...
			CSSPAWNER_API CS_ADD_TO_ENUM_MAP(Actor);
			CSSPAWNER_API CS_ADD_TO_ENUM_MAP(Custom);
			CSSPAWNER_API CS_ADD_TO_ENUM_MAP_CUSTOM(EPoint_MAX, "MAX");
		}
	}
}
...
namespace NCsSpawnerShape
{
	namespace Ref
	{
		...
		CSSPAWNER_API CS_ADD_TO_ENUM_MAP(Circle);
		CSSPAWNER_API CS_ADD_TO_ENUM_MAP(Rectangle);
		CSSPAWNER_API CS_ADD_TO_ENUM_MAP(Sphere);
		CSSPAWNER_API CS_ADD_TO_ENUM_MAP(Box);
		CSSPAWNER_API CS_ADD_TO_ENUM_MAP(Custom);
		CSSPAWNER_API CS_ADD_TO_ENUM_MAP_CUSTOM(ECsSpawnerShape_MAX, "MAX");
	}

	CSSPAWNER_API const uint8 MAX = (uint8)Type::ECsSpawnerShape_MAX;
}
...
namespace NCsSpawner
{
	namespace NShape
	{
		namespace Ref
		{
			...
			CSSPAWNER_API CS_ADD_TO_ENUM_MAP(Box);
			CSSPAWNER_API CS_ADD_TO_ENUM_MAP(Custom);
			CSSPAWNER_API CS_ADD_TO_ENUM_MAP_CUSTOM(EShape_MAX, "MAX");
		}
	}
}
...
namespace NCsSpawnerShapeCenter
{
	namespace Ref
	{
		...
		CSSPAWNER_API CS_ADD_TO_ENUM_MAP(Actor);
		CSSPAWNER_API CS_ADD_TO_ENUM_MAP(Custom);
		CSSPAWNER_API CS_ADD_TO_ENUM_MAP_CUSTOM(ECsSpawnerShapeCenter_MAX, "MAX");
	}

	CSSPAWNER_API const uint8 MAX = (uint8)Type::ECsSpawnerShapeCenter_MAX;
}
	...
	namespace NShape
	{
		namespace NCenter
		{
			namespace Ref
			{
				...
				CSSPAWNER_API CS_ADD_TO_ENUM_MAP(Actor);
				CSSPAWNER_API CS_ADD_TO_ENUM_MAP(Custom);
				CSSPAWNER_API CS_ADD_TO_ENUM_MAP_CUSTOM(ECenter_MAX, "MAX");
			}
		}
	}
}
...
namespace NCsSpawnerDistribution
{
	namespace Ref
	{
		...
		CSSPAWNER_API CS_ADD_TO_ENUM_MAP(Uniform);
		CSSPAWNER_API CS_ADD_TO_ENUM_MAP_CUSTOM(ECsSpawnerDistribution_MAX, "MAX");
	}

	CSSPAWNER_API const uint8 MAX = (uint8)Type::ECsSpawnerDistribution_MAX;
}
...
namespace NCsSpawner
{
	namespace NDistribution
	{
		namespace Ref
		{
			...
			CSSPAWNER_API CS_ADD_TO_ENUM_MAP(Uniform);
			CSSPAWNER_API CS_ADD_TO_ENUM_MAP_CUSTOM(EDistribution_MAX, "MAX");
		}
	}
}
