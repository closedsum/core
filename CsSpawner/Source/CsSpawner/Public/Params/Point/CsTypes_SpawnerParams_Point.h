...
struct CSSPAWNER_API EMCsSpawnerPointSelection : public TCsEnumMap<ECsSpawnerPointSelection>
{
...
namespace NCsSpawnerPointSelection
{
	...
	namespace Ref
	{
		extern CSSPAWNER_API const Type Index;
		extern CSSPAWNER_API const Type FirstToLast;
		extern CSSPAWNER_API const Type LastToFirst;
		extern CSSPAWNER_API const Type Random;
		extern CSSPAWNER_API const Type ECsSpawnerPointSelection_MAX;
	}
}
...
namespace NCsSpawner
{
	namespace NPoint
	{
		...
		*/
		...
		struct CSSPAWNER_API EMSelection : public TCsEnumMap<ESelection>
		{
		...
		namespace NSelection
		{
			namespace Ref
			{
				...
				extern CSSPAWNER_API const Type LastToFirst;
				extern CSSPAWNER_API const Type Random;
				extern CSSPAWNER_API const Type ESelection_MAX;
			}
		}
	}
}
