...
UCLASS()
class CSFX_API UCsScriptLibrary_FX : public UObject
{ 
...
public:
	...
	UFUNCTION(BlueprintPure, Category = "CsFX|Library|FX", meta = (AutoCreateRefTerm = "Name"))
	static FECsFX Get(const FString& Name);

	UFUNCTION(BlueprintPure, Category = "CsFX|Library|FX", meta = (AutoCreateRefTerm = "Index"))
	static FECsFX GetByIndex(const int32& Index);

	UFUNCTION(BlueprintPure, Category = "CsFX|Library|FX", meta = (AutoCreateRefTerm = "Enum"))
	static FString ToString(const FECsFX& Enum);

	UFUNCTION(BlueprintPure, Category = "CsFX|Library|FX")
	...
	UFUNCTION(BlueprintPure, meta = (DisplayName = "Equal (FX)", CompactNodeTitle = "==", ScriptMethod = "Equals", Keywords = "== equal"), Category = "CsFX|Library|FX")
...
public:
	...
	* return
	*/
	UFUNCTION(BlueprintCallable, Category = "CsFX|Library|FX", meta = (AutoCreateRefTerm = "Context,Path"))
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "CsFX|Library|FX", meta = (WorldContext = "WorldContextObject", AutoCreateRefTerm = "Context,Params"))
	...
	* return					Handle to spawn coroutine.
	*/
	UFUNCTION(BlueprintCallable, Category = "CsFX|Library|FX", meta = (WorldContext = "WorldContextObject", AutoCreateRefTerm = "Context,FX,Delay"))
	...
	UFUNCTION(BlueprintCallable, Category = "CsFX|Library|FX", meta = (AutoCreateRefTerm = "Context,Param,Index"))
