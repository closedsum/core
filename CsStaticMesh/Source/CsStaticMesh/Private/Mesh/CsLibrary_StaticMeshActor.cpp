	...
	namespace NActor
	{
		namespace NPooled
		{
			...
			FCsStaticMeshActorPooled* FLibrary::AttachChecked(const FString& Context, const FCsStaticMeshAttachment& Attachment, const UObject* WorldContext, USceneComponent* Parent)
			{
				...
				PayloadType* Payload		 = CsStaticMeshManagerLibrary::AllocatePayloadChecked(Context, WorldContext, DefaultType);
				...
				const FCsStaticMeshActorPooled* Object = CsStaticMeshManagerLibrary::SpawnChecked(Context, WorldContext, DefaultType, Payload);
