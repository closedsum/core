...
struct CSCORE_API EMCsInputSystem : public TCsEnumMap<ECsInputSystem>
{
...
namespace NCsInputSystem
{
	...
	namespace Ref
	{
		...
		extern CSCORE_API const Type Enhanced;
		extern CSCORE_API const Type ECsInputSystem_MAX;
	}
}
