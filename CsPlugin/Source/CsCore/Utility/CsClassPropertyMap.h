...
public:
	...
	const TMap<FName, TWeakObjectPtr<UProperty>>& GetMap(const FName& ClassName);
};
...
public:
	...
	virtual void CreateMaps_Byte(void* Object, UByteProperty* ByteProperty, const FName& PropertyName);
	virtual void CreateMaps_Enum(void* Object, UEnumProperty* EnumProperty, const FName& PropertyName);
	virtual void CreateMaps_Object(void* Object, UObjectProperty* ObjectProperty, const FName& PropertyName);
