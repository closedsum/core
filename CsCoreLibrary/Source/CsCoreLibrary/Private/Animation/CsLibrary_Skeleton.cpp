...
namespace NCsSkeleton
{
	...
	bool FLibrary::IsValid(const FString& Context, USkeletalMesh* Mesh, UAnimationAsset* Anim, LogLevel)
	{
		// Check Mesh is Valid
		CS_IS_PTR_NULL(Mesh)
		// Check Anim is Valid
	...
	bool FLibrary::IsValid(const FString& Context, USkeletalMesh* Mesh, UClass* AnimClass, LogLevel)
	{
		// Check Mesh is Valid
		CS_IS_PTR_NULL(Mesh)
		// Check AnimClass is Valid
	...
	bool FLibrary::IsValid(const FString& Context, UClass* AnimClass, UAnimationAsset* Anim, LogLevel)
	{
		// Check AnimClass is Valid
		CS_IS_PTR_NULL(AnimClass)
		// Check Anim is Valid
