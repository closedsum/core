...
namespace NCsEasingType
{
	namespace Ref
	{
		...
		CSCORE_API CS_ADD_TO_ENUM_MAP(QuadIn);
		CSCORE_API CS_ADD_TO_ENUM_MAP(QuadOut);
		CSCORE_API CS_ADD_TO_ENUM_MAP(QuadInOut);
		...
		CSCORE_API CS_ADD_TO_ENUM_MAP(BackIn);
		CSCORE_API CS_ADD_TO_ENUM_MAP(BackOut);
		CSCORE_API CS_ADD_TO_ENUM_MAP(BackInOut);
		CSCORE_API CS_ADD_TO_ENUM_MAP(ElasticIn);
		CSCORE_API CS_ADD_TO_ENUM_MAP(ElasticOut);
		CSCORE_API CS_ADD_TO_ENUM_MAP(ElasticInOut);
