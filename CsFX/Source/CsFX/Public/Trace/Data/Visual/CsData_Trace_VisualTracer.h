	...
	namespace NData
	{
		namespace NVisual
		{
			namespace NTracer
			{
				...
				*/
				struct CSFX_API ITracer : public ICsGetInterfaceMap
				{
				public:
...
class CSFX_API UCsData_Trace_VisualTracer: public UCsGetInterfaceMap
{
...
* Interface that describes anything visual related to a Tracer for a Trace.
*/
class CSFX_API ICsData_Trace_VisualTracer : public ICsGetInterfaceMap
{
