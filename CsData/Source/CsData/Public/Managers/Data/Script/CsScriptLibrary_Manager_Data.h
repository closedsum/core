...
UCLASS()
class CSDATA_API UCsScriptLibrary_Manager_Data : public UObject
{
...
public:
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "CsData|Library|Manager|Data", meta = (WorldContext = "WorldContextObject", AutoCreateRefTerm = "Context,EntryName"))
	...
	* return					Data as UObject.
	*/
	UFUNCTION(BlueprintCallable, Category = "CsData|Library|Manager|Data", meta = (WorldContext = "WorldContextObject", AutoCreateRefTerm = "Context,Path"))
...
public:
	...
	* return					Script Data as UObject.
	*/
	UFUNCTION(BlueprintCallable, Category = "CsData|Library|Manager|Data", meta = (DisplayName = "Get Script Data as Object (Checked)", WorldContext = "WorldContextObject", AutoCreateRefTerm = "Context,EntryName"))
	...
	* return					Script Data as UObject.
	*/
	UFUNCTION(BlueprintCallable, Category = "CsData|Library|Manager|Data", meta = (DisplayName = "Get Script Data Object by Path (Checked)", WorldContext = "WorldContextObject", AutoCreateRefTerm = "Context,Path"))
...
public:
	...
	* return					DataTable
	*/
	UFUNCTION(BlueprintCallable, Category = "CsData|Library|Manager|Data", meta = (WorldContext = "WorldContextObject", AutoCreateRefTerm = "Context"))
...
public:
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "CsData|Library|Manager|Data", meta = (WorldContext = "WorldContextObject"))
