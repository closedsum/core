...
struct CSINPUT_API EMCsInputValueRule : public TCsEnumMap<ECsInputValueRule>
{
...
namespace NCsInputValueRule
{
	...
	namespace Ref
	{
		extern CSINPUT_API const Type None;
		extern CSINPUT_API const Type Equal;
		extern CSINPUT_API const Type NotEqual;
		extern CSINPUT_API const Type Greater;
		extern CSINPUT_API const Type GreaterOrEqual;
		extern CSINPUT_API const Type Less;
		extern CSINPUT_API const Type LessOrEqual;
		extern CSINPUT_API const Type ECsInputValueRule_MAX;
	}
}
...
struct CSINPUT_API EMCsInputLocationRule : public TCsEnumMap<ECsInputLocationRule>
{
...
namespace NCsInputLocationRule
{
	...
	namespace Ref
	{
		...
		extern CSINPUT_API const Type Equal;
		extern CSINPUT_API const Type NotEqual;
		extern CSINPUT_API const Type ECsInputLocationRule_MAX;
	}
}
...
struct CSINPUT_API EMCsInputRotationRule : public TCsEnumMap<ECsInputRotationRule>
{
...
namespace NCsInputRotationRule
{
	...
	namespace Ref
	{
		...
		extern CSINPUT_API const Type Equal;
		extern CSINPUT_API const Type NotEqual;
		extern CSINPUT_API const Type ECsInputRotationRule_MAX;
	}
}
...
struct CSINPUT_API FCsInputCompareValue
{
	GENERATED_USTRUCT_BODY()

public:

	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "CsInput|Input|Definition")
...
struct CSINPUT_API EMCsInputCompletedValueReturnType : public TCsEnumMap<ECsInputCompletedValueReturnType>
{
...
namespace NCsInputCompletedValueReturnType
{
	...
	namespace Ref
	{
		extern CSINPUT_API const Type PassThrough;
		extern CSINPUT_API const Type Defined;
		extern CSINPUT_API const Type Average;
		extern CSINPUT_API const Type ECsInputCompletedValueReturnType_MAX;
	}
}
...
*/
USTRUCT(BlueprintType)
struct CSINPUT_API FCsInputCompletedValue
{
	GENERATED_USTRUCT_BODY()

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "CsInput|Input|Definition")
	ECsInputValue ValueType;
...
*/
USTRUCT(BlueprintType)
struct CSINPUT_API FCsInputDescription
{
	GENERATED_USTRUCT_BODY()

public:

	UPROPERTY(BlueprintReadOnly, Category = "CsInput|Input|Definition")
	bool bPass;
...
*/
USTRUCT(BlueprintType)
struct CSINPUT_API FCsInputWord
{
	GENERATED_USTRUCT_BODY()
	...
	UPROPERTY(BlueprintReadWrite, Category = "CsInput|Input|Definition")
...
*/
USTRUCT(BlueprintType)
struct CSINPUT_API FCsInputPhrase
{
	GENERATED_USTRUCT_BODY()
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "CsInput|Input|Definition", meta = (ScriptName = "m_bInterval", InlineEditConditionToggle))
	bool bInterval;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "CsInput|Input|Definition", meta = (ScriptName = "m_Interval", editcondition = "bInterval", ClampMin = "0.0", UIMin = "0.0"))
	float Interval;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "CsInput|Input|Definition", meta = (ScriptName = "m_bFrames", InlineEditConditionToggle))
	bool bFrames;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "CsInput|Input|Definition", meta = (ScriptName = "m_Frames", editcondition = "bFrames", ClampMin = "0", UIMin = "0"))
	int32 Frames;
...
*/
USTRUCT(BlueprintType)
struct CSINPUT_API FCsInputSentence
{
	GENERATED_USTRUCT_BODY()
...
public:
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "CsInput|Input|Definition", meta = (ClampMin = "0.0", UIMin = "0.0"))
	float Cooldown;
