...
struct CSCORE_API FCsLevel_Streaming_LoadParams
{
	GENERATED_USTRUCT_BODY()

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "CsCore|Level")
...
USTRUCT(BlueprintType)
struct CSCORE_API FCsLevel_Streaming_LoadWithPathParams
{
	GENERATED_USTRUCT_BODY()
...
USTRUCT(BlueprintType)
struct CSCORE_API FCsLevel_Streaming_UnloadParams
{
	GENERATED_USTRUCT_BODY()
...
USTRUCT(BlueprintType)
struct CSCORE_API FCsLevel_Streaming_UnloadWithPathParams
{
	GENERATED_USTRUCT_BODY()
