...
#include "GraphEditor/CsPlatformProcessGraphPanelPinFactory.h"
...
TSharedPtr<SGraphPin> FCsPlatformProcessPanelGraphPinFactory::CreatePin(UEdGraphPin* InPin) const
{
