...
namespace NCsPlayerStateBaseOnBoardState
{
	namespace Ref
	{
		CSCOREDEPRECATED_API const Type WaitingForGameState = EMCsPlayerStateBaseOnBoardState::Get().Add(Type::WaitingForGameState, TEXT("WaitingForGameState"), TEXT("Waiting for GameState"));
		CSCOREDEPRECATED_API const Type WaitingForFinishLoadingCommonData = EMCsPlayerStateBaseOnBoardState::Get().Add(Type::WaitingForFinishLoadingCommonData, TEXT("WaitingForFinishLoadingCommonData"), TEXT("Waiting for Finish Loading Common Data"));
		CSCOREDEPRECATED_API const Type WaitingForLocalPlayerState = EMCsPlayerStateBaseOnBoardState::Get().Add(Type::WaitingForLocalPlayerState, TEXT("WaitingForLocalPlayerState"), TEXT("Waiting for Local PlayerState"));
		// Client
		CSCOREDEPRECATED_API const Type RequestLocalUniqueMappingId = EMCsPlayerStateBaseOnBoardState::Get().Add(Type::RequestLocalUniqueMappingId, TEXT("RequestLocalUniqueMappingId"), TEXT("Request Local UniqueMappingId"));
		CSCOREDEPRECATED_API const Type WaitingForLocalUniqueMappingId = EMCsPlayerStateBaseOnBoardState::Get().Add(Type::WaitingForLocalUniqueMappingId, TEXT("WaitingForLocalUniqueMappingId"), TEXT("Waiting for Local UniqueMappingId"));
		CSCOREDEPRECATED_API const Type RecievedLocalUniqueMappingId = EMCsPlayerStateBaseOnBoardState::Get().Add(Type::RecievedLocalUniqueMappingId, TEXT("RecievedLocalUniqueMappingId"), TEXT("Recieved Local UniqueMappingId"));
		// Requesting Player State on Client
		CSCOREDEPRECATED_API const Type RequestUniqueMappingId = EMCsPlayerStateBaseOnBoardState::Get().Add(Type::RequestUniqueMappingId, TEXT("RequestUniqueMappingId"), TEXT("Request UniqueMappingId"));
		CSCOREDEPRECATED_API const Type WaitingForUniqueMappingId = EMCsPlayerStateBaseOnBoardState::Get().Add(Type::WaitingForUniqueMappingId, TEXT("WaitingForUniqueMappingId"), TEXT("Waiting for UniqueMappingId"));
		CSCOREDEPRECATED_API const Type RecievedUniqueMappingId = EMCsPlayerStateBaseOnBoardState::Get().Add(Type::RecievedUniqueMappingId, TEXT("RecievedUniqueMappingId"), TEXT("Recieved UniqueMappingId"));
		// Player
		CSCOREDEPRECATED_API const Type RequestPlayerData = EMCsPlayerStateBaseOnBoardState::Get().Add(Type::RequestPlayerData, TEXT("RequestPlayerData"), TEXT("Request Player Data"));
		CSCOREDEPRECATED_API const Type WaitingForPlayerData = EMCsPlayerStateBaseOnBoardState::Get().Add(Type::WaitingForPlayerData, TEXT("WaitingForPlayerData"), TEXT("Waiting for Player Data"));
		CSCOREDEPRECATED_API const Type ReceivedPlayerData = EMCsPlayerStateBaseOnBoardState::Get().Add(Type::ReceivedPlayerData, TEXT("ReceivedPlayerData"), TEXT("Received Player Data"));
		// AI
		CSCOREDEPRECATED_API const Type RequestAIData = EMCsPlayerStateBaseOnBoardState::Get().Add(Type::RequestAIData, TEXT("RequestAIData"), TEXT("Request AI Data"));
		CSCOREDEPRECATED_API const Type WaitingForAIData = EMCsPlayerStateBaseOnBoardState::Get().Add(Type::WaitingForAIData, TEXT("WaitingForAIData"), TEXT("Waiting for AI Data"));
		CSCOREDEPRECATED_API const Type ReceivedAIData = EMCsPlayerStateBaseOnBoardState::Get().Add(Type::ReceivedAIData, TEXT("ReceivedAIData"), TEXT("Received AI Data"));
		// Loading
		CSCOREDEPRECATED_API const Type BeginLoadingPlayerData = EMCsPlayerStateBaseOnBoardState::Get().Add(Type::BeginLoadingPlayerData, TEXT("BeginLoadingPlayerData"), TEXT("Begin Loading Player Data"));
		CSCOREDEPRECATED_API const Type WaitingForFinishLoadingPlayerData = EMCsPlayerStateBaseOnBoardState::Get().Add(Type::WaitingForFinishLoadingPlayerData, TEXT("WaitingForFinishLoadingPlayerData"), TEXT("Waiting for Finish Loading Player Data"));
		CSCOREDEPRECATED_API const Type FinishedLoadingPlayerData = EMCsPlayerStateBaseOnBoardState::Get().Add(Type::FinishedLoadingPlayerData, TEXT("FinishedLoadingPlayerData"), TEXT("Finished Loading Player Data"));
		CSCOREDEPRECATED_API const Type SetAssetReferencesPlayerData = EMCsPlayerStateBaseOnBoardState::Get().Add(Type::SetAssetReferencesPlayerData, TEXT("SetAssetReferencesPlayerData"), TEXT("Set Asset Referencess Player Data"));
		CSCOREDEPRECATED_API const Type WaitingForSetAssetReferencesPlayerData = EMCsPlayerStateBaseOnBoardState::Get().Add(Type::WaitingForSetAssetReferencesPlayerData, TEXT("WaitingForSetAssetReferencesPlayerData"), TEXT("Waiting for Set Asset Referencess Player Data"));
		CSCOREDEPRECATED_API const Type FinishedSetAssetReferencesPlayerData = EMCsPlayerStateBaseOnBoardState::Get().Add(Type::FinishedSetAssetReferencesPlayerData, TEXT("FinishedSetAssetReferencesPlayerData"), TEXT("Finished Set Asset Referencess Player Data"));
		// Setup
		CSCOREDEPRECATED_API const Type BeginApplyingPlayerData = EMCsPlayerStateBaseOnBoardState::Get().Add(Type::BeginApplyingPlayerData, TEXT("BeginApplyingPlayerData"), TEXT("Begin Applying Player Data"));
		CSCOREDEPRECATED_API const Type WaitingForFinishApplyingPlayerData = EMCsPlayerStateBaseOnBoardState::Get().Add(Type::WaitingForFinishApplyingPlayerData, TEXT("WaitingForFinishApplyingPlayerData"), TEXT("Waiting for Finish Applying Player Data"));
		CSCOREDEPRECATED_API const Type FinishedApplyingPlayerData = EMCsPlayerStateBaseOnBoardState::Get().Add(Type::FinishedApplyingPlayerData, TEXT("FinishedApplyingPlayerData"), TEXT("Finished Applying Player Data"));
		// Handshaking
		CSCOREDEPRECATED_API const Type SendOnBoardCompleted = EMCsPlayerStateBaseOnBoardState::Get().Add(Type::SendOnBoardCompleted, TEXT("SendOnBoardCompleted"), TEXT("Send OnBoard Completed"));
		CSCOREDEPRECATED_API const Type WaitingForOnBoardCompleted = EMCsPlayerStateBaseOnBoardState::Get().Add(Type::WaitingForOnBoardCompleted, TEXT("WaitingForOnBoardCompleted"), TEXT("Waiting for OnBoard Completed"));
		CSCOREDEPRECATED_API const Type Completed = EMCsPlayerStateBaseOnBoardState::Get().Add(Type::Completed, TEXT("Completed"));
		CSCOREDEPRECATED_API const Type ECsPlayerStateBaseOnBoardState_MAX = EMCsPlayerStateBaseOnBoardState::Get().Add(Type::ECsPlayerStateBaseOnBoardState_MAX, TEXT("ECsPlayerStateBaseOnBoardState_MAX"), TEXT("MAX"));
	}
}
...
{
	CSCOREDEPRECATED_API const FECsPlayerStateBaseRoutine OnBoard_Internal = EMCsPlayerStateBaseRoutine::Get().Create(TEXT("OnBoard_Internal"));
	CSCOREDEPRECATED_API const FECsPlayerStateBaseRoutine RequestUniqueMappingId_AI_Internal = EMCsPlayerStateBaseRoutine::Get().Create(TEXT("RequestUniqueMappingId_AI_Internal"));
}
...
const FECsUpdateGroup& Group = NCsUpdateGroup::GameState;
	...
	Payload->SetName(NCsPlayerStateBaseCached::Str::OnBoard_Internal);
	Payload->SetFName(NCsPlayerStateBaseCached::Name::OnBoard_Internal);
...
void ACsPlayerStateBase::RequestUniqueMappingId_AI(ACsPlayerStateBase* RequestingPlayerState)
{
	...
	Payload->SetName(NCsPlayerStateBaseCached::Str::RequestUniqueMappingId_AI_Internal);
	Payload->SetFName(NCsPlayerStateBaseCached::Name::RequestUniqueMappingId_AI_Internal);
