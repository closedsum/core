...
#include "CsSpinBox_int32.generated.h"
...
public:
	...
	UFUNCTION(BlueprintCallable, Category = "Behavior")
	void SetMinValue(const int32 &NewValue);
	...
	UFUNCTION(BlueprintCallable, Category = "Behavior")
	void SetMaxValue(const int32 &NewValue);
	...
	UFUNCTION(BlueprintCallable, Category = "Behavior")
	void SetMinSliderValue(const int32 &NewValue);
	...
	UFUNCTION(BlueprintCallable, Category = "Behavior")
	void SetMaxSliderValue(const int32 &NewValue);
