...
struct CSINPUT_API FCsInputActionMapping
{
...
USTRUCT(BlueprintType)
struct CSINPUT_API FCsInputActionMappings
{
	GENERATED_USTRUCT_BODY()
...
USTRUCT(BlueprintType)
struct CSINPUT_API FCsInputProfile
{
	GENERATED_USTRUCT_BODY()
	...
	UPROPERTY(VisibleDefaultsOnly, Category = "CsInput|Input")
