...
UCLASS()
class CSCORELIBRARY_API UCsScriptLibrary_AnimSequence : public UObject
{ 
...
public:
	...
	* return			AnimSequence
	*/
	UFUNCTION(BlueprintCallable, Category = "CsCoreLibrary|Library|AnimSequence", meta = (AutoCreateRefTerm = "Context,Path"))
...
public:
	...
	UFUNCTION(BlueprintCallable, Category = "CsCoreLibrary|Library|AnimSequence", meta = (DisplayName = "Unload (FCsAnimSequence)", CompactNodeTitle = "Unload"))
	static void FCsAnimSequence_Unload(UPARAM(ref) FCsAnimSequence& Anim)
	{
		Anim.Unload();
	}

	UFUNCTION(BlueprintCallable, Category = "CsCoreLibrary|Library|AnimSequence", meta = (DisplayName = "Unload (FCsAnimSequenceInfo)", CompactNodeTitle = "Unload"))
	static void FCsAnimSequenceInfo_Unload(UPARAM(ref) FCsAnimSequenceInfo& Anim)
	{
		Anim.Unload();
	}

	UFUNCTION(BlueprintCallable, Category = "CsCoreLibrary|Library|AnimSequence", meta = (DisplayName = "Unload (TArray<FCsAnimSequence>)", CompactNodeTitle = "Unload"))
...
public:
	...
	* return			AnimSequence
	*/
	UFUNCTION(BlueprintPure, Category = "CsCoreLibrary|Library|AnimSequence", meta = (AutoCreateRefTerm = "Context,Path"))
...
public:
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "CsCoreLibrary|Library|AnimSequence", meta = (AutoCreateRefTerm = "Context,PropertyName"))
