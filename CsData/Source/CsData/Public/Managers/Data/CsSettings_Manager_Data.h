...
struct CSDATA_API FCsSettings_Manager_Data
{
	GENERATED_USTRUCT_BODY()

public:

	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "CsData|Managers|Data", meta = (ClampMin = "4", UIMin = "4"))
	...
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "CsData|Managers|Data")
...
USTRUCT(BlueprintType)
struct CSDATA_API FCsSettings_Manager_Data_UnitTest
{
	GENERATED_USTRUCT_BODY()
