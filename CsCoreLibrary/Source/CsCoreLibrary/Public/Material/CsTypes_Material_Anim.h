...
struct CSCORELIBRARY_API FCsMaterialAnimParameterVector
{
...
USTRUCT(BlueprintType)
struct CSCORELIBRARY_API FCsMaterialAnimParameterScalar
{
	GENERATED_USTRUCT_BODY()
...
namespace NCsMaterial
{
	namespace NAnim
	{
		namespace NParameter
		{
			...
			struct CSCORELIBRARY_API TValueType
			{
			private:
			...
			struct CSCORELIBRARY_API FVectorType final : TValueType<FLinearColor>
			{
			private:
			...
			struct CSCORELIBRARY_API FScalarType final : TValueType<float>
			{
			private:
...
USTRUCT(BlueprintType)
struct CSCORELIBRARY_API FCsMaterialAnimFrame
{
	GENERATED_USTRUCT_BODY()
...
#undef FrameType
	...
	bool IsValidChecked(const FString& Context) const;
	bool IsValid(const FString& Context, void(*Log)(const FString&) = &NCsCore::NLibrary::FLog::Warning) const;
	bool IsValid(const FString& Context, UMaterialInstanceDynamic* MID, void(*Log)(const FString&) = &NCsCore::NLibrary::FLog::Warning) const;
	bool IsValid(const FString& Context, const TArray<UMaterialInstanceDynamic*>& MIDs, void(*Log)(const FString&) = &NCsCore::NLibrary::FLog::Warning) const;
	bool IsValid(const FString& Context, const TArray<TWeakObjectPtr<UMaterialInstanceDynamic>>& MIDs, void(*Log)(const FString&) = &NCsCore::NLibrary::FLog::Warning) const;
};
...
namespace NCsMaterial
{
	namespace NAnim
	{
		struct CSCORELIBRARY_API FFrame final
		{
...
USTRUCT(BlueprintType)
struct CSCORELIBRARY_API FCsMaterialAnim
{
	GENERATED_USTRUCT_BODY()
...
namespace NCsMaterial
{
	namespace NAnim
	{
		struct CSCORELIBRARY_API FAnim final
		{
		...
		public:
			...
			{
				if (Frames.IsEmpty() ||
					(!Frames.IsEmpty() && FrameCount >= Frames.Num()))
				{
					Frames.AddDefaulted();
				}
...
USTRUCT(BlueprintType)
struct CSCORELIBRARY_API FCsMaterialAnim_Params
{
	GENERATED_USTRUCT_BODY()
...
namespace NCsMaterial
{
	namespace NAnim
	{
		namespace NParams
		{
			struct CSCORELIBRARY_API FParams final
			{
			#define AnimType NCsMaterial::NAnim::FAnim
