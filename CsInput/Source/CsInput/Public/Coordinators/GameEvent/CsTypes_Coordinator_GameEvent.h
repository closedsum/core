...
struct CSINPUT_API FECsGameEventCoordinatorGroup : public FECsEnum_uint8
{
...
struct CSINPUT_API EMCsGameEventCoordinatorGroup : public TCsEnumStructMap<FECsGameEventCoordinatorGroup, uint8>
{
