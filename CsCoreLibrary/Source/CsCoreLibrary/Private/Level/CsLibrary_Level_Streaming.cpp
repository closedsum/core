...
namespace NCsLevel
{
	namespace NStreaming
	{
		namespace NLocal
		{
			...
			bool FLibrary::SafeIs(const FString& Context, const UObject* WorldContext, const TSoftObjectPtr<UWorld>& Level, LogLevel)
			{
			...
			FName FLibrary::GetSafeName(const FString& Context, const TSoftObjectPtr<UWorld>& Level, bool& OutSuccess, LogLevel)
			{
				OutSuccess = false;
			...
			FString FLibrary::SafeMakeSafeLevelName(const FString& Context, const UObject* WorldContext, const FName& LevelName, bool& OutSuccess, LogLevel)
			{
				OutSuccess = false;
			...
			FString FLibrary::GetSafeSearchPackageName(const FString& Context, const UObject* WorldContext, const FName& LevelName, bool& OutSuccess, LogLevel)
			{
				// Search for the level object by name.
			...
			ULevelStreaming* FLibrary::SafeFindAndCacheObject(const FString& Context, const UObject* WorldContext, const FName& LevelName, LogLevel)
			{
				// Search for the level object by name.
			...
			void FLibrary::LoadChecked(const FString& Context, const UObject* WorldContext, const LoadParamsType& Params)
			{
				...
				UE_LOG(LogCsCoreLibrary, Log, TEXT("ActivateLevel %s %i %i %i"),
			...
			bool FLibrary::SafeLoad(const FString& Context, const UObject* WorldContext, const LoadParamsType& Params, LogLevel)
			{
				CS_IS_VALID(Params)
			...
			bool FLibrary::SafeUnload(const FString& Context, const UObject* WorldContext, const UnloadParamsType& Params, LogLevel)
			{
				CS_IS_VALID(Params)
