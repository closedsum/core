...
struct CSINPUT_API FECsGameEvent : public FECsEnum_uint8
{
...
struct CSINPUT_API EMCsGameEvent : public TCsEnumStructMap<FECsGameEvent, uint8>
{
...
namespace NCsGameEvent
{
	...
	extern CSINPUT_API const Type Default__MouseLeftButtonPressed__;
	extern CSINPUT_API const Type Default__MouseLeftButtonReleased__;
	extern CSINPUT_API const Type Default__MouseRightButtonPressed__;
	extern CSINPUT_API const Type Default__MouseRightButtonReleased__;
