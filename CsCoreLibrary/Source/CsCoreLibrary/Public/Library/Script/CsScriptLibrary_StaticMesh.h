...
UCLASS()
class CSCORELIBRARY_API UCsScriptLibrary_StaticMesh : public UObject
{ 
...
public:
	...
	* return			StaticMesh
	*/
	UFUNCTION(BlueprintCallable, Category = "CsCoreLibrary|Library|StaticMesh", meta = (AutoCreateRefTerm = "Context,Path"))
...
public:
	...
	UFUNCTION(BlueprintCallable, Category = "CsCoreLibrary|Library|StaticMesh", meta = (DisplayName = "Unload (FCsStaticMesh)", CompactNodeTitle = "Unload"))
	static void FCsStaticMesh_Unload(UPARAM(ref) FCsStaticMesh& Mesh)
	{
		Mesh.Unload();
	}

	UFUNCTION(BlueprintCallable, Category = "CsCoreLibrary|Library|StaticMesh", meta = (DisplayName = "Unload (TArray<FCsStaticMesh>)", CompactNodeTitle = "Unload"))
