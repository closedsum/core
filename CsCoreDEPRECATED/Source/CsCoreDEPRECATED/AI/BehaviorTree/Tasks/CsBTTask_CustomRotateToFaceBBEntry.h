...
struct CSCOREDEPRECATED_API FCsBTTask_CustomRotateToFaceBBEntryMemory
{
...
UCLASS(config = Game)
class CSCOREDEPRECATED_API UCsBTTask_CustomRotateToFaceBBEntry : public UBTTask_BlackboardBase
{
