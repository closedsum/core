...
//struct FCsNDIArrayImplHelperBase
//{
...
//
//template<typename TArrayType>
//struct FCsNDIArrayImplHelper : public FCsNDIArrayImplHelperBase<TArrayType>
//{
//};
//
//struct CSCORE_API FCsNiagaraDataInterfaceProxyArrayRWImpl : public FNiagaraDataInterfaceProxy
//{
//	FRWBuffer		Buffer;
//	int32			NumElements = 0;
//
//	~FCsNiagaraDataInterfaceProxyArrayRWImpl()
//	{
...
//};
//
//struct CSCORE_API FCsNiagaraDataInterfaceArrayRWImplHelper
//{
...
//};
//
//struct CSCORE_API FCsNiagaraDataInterfaceParametersCS_ArrayRWImpl : public FNiagaraDataInterfaceParametersCS
//{
//	DECLARE_TYPE_LAYOUT(FCsNiagaraDataInterfaceParametersCS_ArrayRWImpl, NonVirtual);
//public:
//	void Bind(const FNiagaraDataInterfaceGPUParamInfo& ParameterInfo, const class FShaderParameterMap& ParameterMap)
//	{
//		BufferParam.Bind(ParameterMap, *FCsNiagaraDataInterfaceArrayRWImplHelper::GetBufferName(ParameterInfo.DataInterfaceHLSLSymbol));
//		BufferSizeParam.Bind(ParameterMap, *FCsNiagaraDataInterfaceArrayRWImplHelper::GetBufferSizeName(ParameterInfo.DataInterfaceHLSLSymbol));
//	}
//
...
//struct FCsNiagaraDataInterfaceArrayRWImpl : public INiagaraDataInterfaceArrayImpl
//{
...
//
//	FCsNiagaraDataInterfaceArrayRWImpl(UNiagaraDataInterfaceArray* InOwner, TArray<TArrayType>& InData)
//		: Owner(InOwner)
//		, Data(InData)
//	{
//	}
...
//			Sig.Name = FCsNiagaraDataInterfaceArrayRWImplHelper::Function_LengthName;
//			#if WITH_EDITORONLY_DATA
...
//			Sig.bSupportsCPU = FCsNDIArrayImplHelper<TArrayType>::bSupportsCPU;
//			Sig.bSupportsGPU = FCsNDIArrayImplHelper<TArrayType>::bSupportsGPU;
...
//		{
//			FNiagaraFunctionSignature& Sig = OutFunctions.AddDefaulted_GetRef();
//			Sig.Name = FCsNiagaraDataInterfaceArrayRWImplHelper::Function_IsValidIndexName;
//			#if WITH_EDITORONLY_DATA
...
//		{
//			FNiagaraFunctionSignature& Sig = OutFunctions.AddDefaulted_GetRef();
//			Sig.Name = FCsNiagaraDataInterfaceArrayRWImplHelper::Function_LastIndexName;
//#if WITH_EDITORONLY_DATA
...
//		{
//			FNiagaraFunctionSignature& Sig = OutFunctions.AddDefaulted_GetRef();
//			Sig.Name = FCsNiagaraDataInterfaceArrayRWImplHelper::Function_GetName;
//			#if WITH_EDITORONLY_DATA
...
//			Sig.Inputs.Add(FNiagaraVariable(FNiagaraTypeDefinition(TObjectType::StaticClass()), TEXT("Array interface")));
//			Sig.Inputs.Add(FNiagaraVariable(FNiagaraTypeDefinition::GetIntDef(), TEXT("Index")));
//			Sig.Outputs.Add(FNiagaraVariable(FCsNDIArrayImplHelper<TArrayType>::GetTypeDefinition(), TEXT("Value")));
//		}
//
//		// Mutable functions
//		{
//			FNiagaraFunctionSignature& Sig = OutFunctions.AddDefaulted_GetRef();
//			Sig.Name = FCsNiagaraDataInterfaceArrayRWImplHelper::Function_ClearName;
//			#if WITH_EDITORONLY_DATA
...
//		{
//			FNiagaraFunctionSignature& Sig = OutFunctions.AddDefaulted_GetRef();
//			Sig.Name = FCsNiagaraDataInterfaceArrayRWImplHelper::Function_ResizeName;
//			#if WITH_EDITORONLY_DATA
...
//		{
//			FNiagaraFunctionSignature& Sig = OutFunctions.AddDefaulted_GetRef();
//			Sig.Name = FCsNiagaraDataInterfaceArrayRWImplHelper::Function_SetArrayElemName;
//			#if WITH_EDITORONLY_DATA
...
//			Sig.Inputs.Add(FNiagaraVariable(FNiagaraTypeDefinition(TObjectType::StaticClass()), TEXT("Array interface")));
//			Sig.Inputs.Add(FNiagaraVariable(FNiagaraTypeDefinition::GetIntDef(), TEXT("Index")));
//			Sig.Inputs.Add(FNiagaraVariable(FCsNDIArrayImplHelper<TArrayType>::GetTypeDefinition(), TEXT("Value")));
//		}
//
//		{
//			FNiagaraFunctionSignature& Sig = OutFunctions.AddDefaulted_GetRef();
//			Sig.Name = FCsNiagaraDataInterfaceArrayRWImplHelper::Function_AddName;
//			#if WITH_EDITORONLY_DATA
...
//		{
//			FNiagaraFunctionSignature& Sig = OutFunctions.AddDefaulted_GetRef();
//			Sig.Name = FCsNiagaraDataInterfaceArrayRWImplHelper::Function_RemoveLastElemName;
//#if WITH_EDITORONLY_DATA
...
//	}
//
//	template<typename T = FCsNDIArrayImplHelper<TArrayType>>
...
//	{
//		// Immutable functions
//		if (BindingInfo.Name == FCsNiagaraDataInterfaceArrayRWImplHelper::Function_LengthName)
//		{
...
//		}
//		else if (BindingInfo.Name == FCsNiagaraDataInterfaceArrayRWImplHelper::Function_IsValidIndexName)
//		{
//			check(BindingInfo.GetNumInputs() == 1 && BindingInfo.GetNumOutputs() == 1);
//			OutFunc = FVMExternalFunction::CreateLambda([this](FVectorVMContext& Context) { this->IsValidIndex(Context); });
//		}
//		else if (BindingInfo.Name == FCsNiagaraDataInterfaceArrayRWImplHelper::Function_LastIndexName)
//		{
//			check(BindingInfo.GetNumInputs() == 0 && BindingInfo.GetNumOutputs() == 1);
//			OutFunc = FVMExternalFunction::CreateLambda([this](FVectorVMContext& Context) { this->GetLastIndex(Context); });
//		}
//		else if (BindingInfo.Name == FCsNiagaraDataInterfaceArrayRWImplHelper::Function_GetName)
//		{
...
//		}
//		// Mutable functions
//		else if (BindingInfo.Name == FCsNiagaraDataInterfaceArrayRWImplHelper::Function_ClearName)
//		{
...
//		}
//		else if (BindingInfo.Name == FCsNiagaraDataInterfaceArrayRWImplHelper::Function_ResizeName)
//		{
...
//		}
//		else if (BindingInfo.Name == FCsNiagaraDataInterfaceArrayRWImplHelper::Function_SetArrayElemName)
//		{
//			OutFunc = FVMExternalFunction::CreateLambda([this](FVectorVMContext& Context) { this->SetValue(Context); });
//		}
//		else if (BindingInfo.Name == FCsNiagaraDataInterfaceArrayRWImplHelper::Function_AddName)
//		{
...
//		}
//		else if (BindingInfo.Name == FCsNiagaraDataInterfaceArrayRWImplHelper::Function_RemoveLastElemName)
//		{
//			// Note: Outputs is variable based upon type
...
//	{
//		OutHLSL.Appendf(TEXT("Buffer<%s> %s;\n"), FCsNDIArrayImplHelper<TArrayType>::HLSLBufferTypeName, *FCsNiagaraDataInterfaceArrayRWImplHelper::GetBufferName(ParamInfo.DataInterfaceHLSLSymbol));
//		OutHLSL.Appendf(TEXT("int2 %s;\n"), *FCsNiagaraDataInterfaceArrayRWImplHelper::GetBufferSizeName(ParamInfo.DataInterfaceHLSLSymbol));
//	}
//
//	template<typename T = FCsNDIArrayImplHelper<TArrayType>>
//	typename TEnableIf<!T::bSupportsGPU>::Type GetParameterDefinitionHLSL_Internal(const FNiagaraDataInterfaceGPUParamInfo& ParamInfo, FString& OutHLSL) const
...
//	{
//		// Immutable functions
//		if (FunctionInfo.DefinitionName == FCsNiagaraDataInterfaceArrayRWImplHelper::Function_LengthName)
//		{
//			OutHLSL.Appendf(TEXT("void %s(out int OutValue) { OutValue = %s[0]; }\n"), *FunctionInfo.InstanceName, *FCsNiagaraDataInterfaceArrayRWImplHelper::GetBufferSizeName(ParamInfo.DataInterfaceHLSLSymbol));
//			return true;
//		}
//		else if (FunctionInfo.DefinitionName == FCsNiagaraDataInterfaceArrayRWImplHelper::Function_IsValidIndexName)
//		{
//			OutHLSL.Appendf(TEXT("void %s(in int Index, out bool bValid) { bValid = Index >=0 && Index < %s[0]; }\n"), *FunctionInfo.InstanceName, *FCsNiagaraDataInterfaceArrayRWImplHelper::GetBufferSizeName(ParamInfo.DataInterfaceHLSLSymbol));
//			return true;
//		}
//		else if (FunctionInfo.DefinitionName == FCsNiagaraDataInterfaceArrayRWImplHelper::Function_LastIndexName)
//		{
//			OutHLSL.Appendf(TEXT("void %s(out int OutValue) { OutValue = %s[0] - 1; }\n"), *FunctionInfo.InstanceName, *FCsNiagaraDataInterfaceArrayRWImplHelper::GetBufferSizeName(ParamInfo.DataInterfaceHLSLSymbol));
//			return true;
//		}
//		else if (FunctionInfo.DefinitionName == FCsNiagaraDataInterfaceArrayRWImplHelper::Function_GetName)
//		{
//			OutHLSL.Appendf(TEXT("void %s(int Index, out %s OutValue) { int ClampedIndex = clamp(Index, 0, %s[1]); "), *FunctionInfo.InstanceName, FCsNDIArrayImplHelper<TArrayType>::HLSLValueTypeName, *FCsNiagaraDataInterfaceArrayRWImplHelper::GetBufferSizeName(ParamInfo.DataInterfaceHLSLSymbol));
//			T::GPUGetFetchHLSL(OutHLSL, *FCsNiagaraDataInterfaceArrayRWImplHelper::GetBufferName(ParamInfo.DataInterfaceHLSLSymbol));
//			OutHLSL.Append(TEXT(" }\n"));
//			return true;
//		}
//		// Mutable functions
...
//	{
//		return FCsNiagaraDataInterfaceArrayRWImplHelper::UpgradeFunctionCall(FunctionSignature);
//	}
//#endif
//
//	virtual bool CopyToInternal(INiagaraDataInterfaceArrayImpl* InDestination) const override
//	{
//		auto Destination = static_cast<FCsNiagaraDataInterfaceArrayRWImpl<TArrayType, TObjectType>*>(InDestination);
//		{
...
//	{
//		auto Other = static_cast<const FCsNiagaraDataInterfaceArrayRWImpl<TArrayType, TObjectType>*>(InOther);
...
//		(
//			[RT_Proxy=static_cast<FCsNiagaraDataInterfaceProxyArrayRWImpl*>(Proxy), RT_Array=TArray<TArrayType>(Data)](FRHICommandListImmediate& RHICmdList)
//			{
...
//
//					RT_Proxy->Buffer.Initialize(BufferStride, BufferNumElements, FCsNDIArrayImplHelper<TArrayType>::PixelFormat, BUF_Static, TEXT("NiagaraArrayFloat"));
...
//					check((sizeof(TArrayType) % BufferStride) == 0);
//
//					const TArrayType DefaultValue = FCsNDIArrayImplHelper<TArrayType>::GetDefaultValue();
//
//					RT_Proxy->Buffer.Initialize(BufferStride, BufferNumElements, FCsNDIArrayImplHelper<TArrayType>::PixelFormat, BUF_Static, TEXT("NiagaraArrayFloat"));
//					void* GPUMemory = RHICmdList.LockVertexBuffer(RT_Proxy->Buffer.Buffer, 0, BufferSize, RLM_WriteOnly);
...
//	{
//		if (FCsNDIArrayImplHelper<TArrayType>::bSupportsGPU)
//		{
//			return new FCsNiagaraDataInterfaceParametersCS_ArrayRWImpl();
//		}
//		return nullptr;
//	}
//
...
//		if (FCsNDIArrayImplHelper<TArrayType>::bSupportsGPU)
//		{
//			return &StaticGetTypeLayoutDesc<FCsNiagaraDataInterfaceParametersCS_ArrayRWImpl>();
//		}
//		return nullptr;
//	}
//
...
//	{
//		check(FCsNDIArrayImplHelper<TArrayType>::bSupportsGPU);
//		static_cast<FCsNiagaraDataInterfaceParametersCS_ArrayRWImpl*>(Base)->Bind(ParameterInfo, ParameterMap);
//	}
//
...
//		FCsNiagaraDataInterfaceProxyArrayRWImpl* DataInterface = static_cast<FCsNiagaraDataInterfaceProxyArrayRWImpl*>(Context.DataInterface);
//		check(DataInterface->Buffer.NumBytes > 0);
//		static_cast<const FCsNiagaraDataInterfaceParametersCS_ArrayRWImpl*>(Base)->SetBuffer(RHICmdList, ComputeShaderRHI, DataInterface->Buffer.SRV, DataInterface->NumElements);
//	}
//
...
//		check(FCsNDIArrayImplHelper<TArrayType>::bSupportsGPU);
//		// Nothing to Unset
//		//static_cast<const FCsNiagaraDataInterfaceParametersCS_ArrayRWImpl*>(Base)->Unset(RHICmdList, Context);
//	}
//
...
//	{
//		FNDIInputParam<int32> IndexParam(Context);
//		FNDIOutputParam<typename FCsNDIArrayImplHelper<TArrayType>::TVMArrayType> OutValue(Context);
//
//		FRWScopeLock ReadLock(Owner->ArrayRWGuard, SLT_ReadOnly);
//		const int32 Num = Data.Num() - 1;
//		if (Num >= 0)
...
//		//-TODO: This dirties the GPU data
//		FNDIInputParam<int32> IndexParam(Context);
//		FNDIInputParam<typename FCsNDIArrayImplHelper<TArrayType>::TVMArrayType> InValue(Context);
//
//		FRWScopeLock WriteLock(Owner->ArrayRWGuard, SLT_Write);
//		for (int32 i = 0; i < Context.NumInstances; ++i)
//		{
