...
struct CSTYPES_API FECsCVarLog : public FECsEnum_uint32
{
...
struct CSTYPES_API EMCsCVarLog final : public TCsEnumStructMap<FECsCVarLog, uint32>
{
...
struct CSTYPES_API FCsCVarLogMap : public ICsCVarMap
{
protected:
	FCsCVarLogMap() :
		Map(),
...
USTRUCT(BlueprintType)
struct CSTYPES_API FECsCVarToggle : public FECsEnum_uint32
{
	GENERATED_USTRUCT_BODY()
...
struct CSTYPES_API EMCsCVarToggle final : public TCsEnumStructMap<FECsCVarToggle, uint32>
{
...
struct CSTYPES_API FCsCVarToggleMap : public ICsCVarMap
{
protected:
	FCsCVarToggleMap() :
		Map(),
...
USTRUCT(BlueprintType)
struct CSTYPES_API FECsCVarDraw : public FECsEnum_uint32
{
	GENERATED_USTRUCT_BODY()
...
struct CSTYPES_API EMCsCVarDraw final : public TCsEnumStructMap<FECsCVarDraw, uint32>
{
...
struct CSTYPES_API FCsCVarDrawMap : ICsCVarMap
{
protected:
	FCsCVarDrawMap() :
		Map(),
...
USTRUCT(BlueprintType)
struct CSTYPES_API FECsScopedGroup : public FECsEnum_uint32
{
	GENERATED_USTRUCT_BODY()
...
struct CSTYPES_API EMCsScopedGroup final : public TCsEnumStructMap<FECsScopedGroup, uint32>
{
...
struct CSTYPES_API FCsScopedGroupMap : public ICsCVarMap
{
protected:
	FCsScopedGroupMap() :
		Map(),
