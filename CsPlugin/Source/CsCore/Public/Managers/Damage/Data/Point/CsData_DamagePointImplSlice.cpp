...
SliceType* FCsData_DamagePointImplSlice::SafeConstruct(const FString& Context, const UObject* WorldContext, const FString& Name, void(*Log)(const FString&) /*=&FCsLog::Warning*/)
{
...
SliceType* FCsData_DamagePointImplSlice::SafeConstructAsValue(const FString& Context, const UObject* WorldContext, const FString& Name, void(*Log)(const FString&) /*=&FCsLog::Warning*/) const
{
	SliceType* Slice = SafeConstruct_Internal(Context, WorldContext, Name, Log);
...
SliceType* FCsData_DamagePointImplSlice::SafeConstruct_Internal(const FString& Context, const UObject* WorldContext, const FString& Name, void(*Log)(const FString&) /*=&FCsLog::Warning*/) const
{
...
bool FCsData_DamagePointImplSlice::IsValid(const FString& Context, void(*Log)(const FString&) /*=&FCsLog::Warning*/) const
{
