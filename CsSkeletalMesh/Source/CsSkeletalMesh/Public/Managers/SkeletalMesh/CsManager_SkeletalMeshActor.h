...
#define PayloadType NCsSkeletalMeshActor::NPayload::IPayload
	...
	class CSSKELETALMESH_API FManager : public ManagerMapType<ICsSkeletalMeshActor, FCsSkeletalMeshActorPooled, PayloadType, FECsSkeletalMeshActor>
	{
	private:
...
UCLASS()
class CSSKELETALMESH_API UCsManager_SkeletalMeshActor : public UObject
{
