...
class CSEDITORDEPRECATED_API SCsGraphPin_ECsCharacterAnimBlueprint : public SCsGraphPin_EnumStruct
{
public:
	SLATE_BEGIN_ARGS(SCsGraphPin_ECsCharacterAnimBlueprint) {}
	SLATE_END_ARGS()
