...
UCLASS()
class CSINPUT_API UCsScriptLibrary_GameEvent : public UObject
{ 
	GENERATED_UCLASS_BODY() 

public:

	UFUNCTION(BlueprintCallable, Category = "CsInput|Library|Input", meta = (AutoCreateRefTerm = "Context"))
	...
	UFUNCTION(BlueprintPure, meta = (DisplayName = "Equal (GameEvent)", CompactNodeTitle = "==", ScriptMethod = "Equals", Keywords = "== equal"), Category = "CsInput|Library|Input")
	static bool EqualEqual(const FECsGameEvent& A, const FECsGameEvent& B);

	UFUNCTION(BlueprintPure, meta = (DisplayName = "NotEqual (GameEvent)", CompactNodeTitle = "!=", ScriptMethod = "NotEquals", Keywords = "!= notequal"), Category = "CsInput|Library|Input")
