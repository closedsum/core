...
UCLASS()
class CSCORELIBRARY_API UCsScriptLibrary_Viewport : public UObject
{ 
...
public:
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "CsCoreLibrary|Library|Viewport", meta = (WorldContext = "WorldContextObject", AutoCreateRefTerm = "Context,ScreenPosition"))
	...
	*/
	UFUNCTION(BlueprintPure, Category = "CsCoreLibrary|Library|Viewport", meta = (WorldContext = "WorldContextObject", AutoCreateRefTerm = "Context"))
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "CsCoreLibrary|Library|Viewport", meta = (WorldContext = "WorldContextObject", AutoCreateRefTerm = "Context,ScreenPosition,Plane"))
