...
struct CSTYPES_API FCsSkeletalMesh
{
	GENERATED_USTRUCT_BODY()

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "CsTypes|Skeletal Mesh")
	TSoftObjectPtr<USkeletalMesh> Mesh;

	UPROPERTY(BlueprintReadWrite, Category = "CsTypes|Skeletal Mesh", meta = (Bitmask, BitmaskEnum = "/Script/CsTypes.ECsLoadFlags"))
	int32 Mesh_LoadFlags;

	UPROPERTY(Transient, BlueprintReadWrite, Category = "CsTypes|Skeletal Mesh")
...
public:
	...
	*/
	...
	USkeletalMesh* GetSafe(const FString& Context, void(*Log)(const FString&) = &NCsTypes::FLog::Warning) const
	{
