...
class CSBLOCKCHAINEDITOR_API SCsGraphPin_ECsBlockchainContractFunction : public SCsGraphPin_EnumStruct
{
public:
	SLATE_BEGIN_ARGS(SCsGraphPin_ECsBlockchainContractFunction) {}
	SLATE_END_ARGS()
