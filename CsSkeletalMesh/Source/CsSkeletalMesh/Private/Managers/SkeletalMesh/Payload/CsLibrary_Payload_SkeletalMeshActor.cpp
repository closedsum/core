...
namespace NCsSkeletalMeshActor
{
	namespace NPayload
	{
		...
		void FLibrary::SetSafe(const FString& Context, PayloadImplType* Payload, const ShotType& Shot, LogLevel)
		{
		...
		void FLibrary::SetSafe(const FString& Context, PayloadImplType* Payload, const PooledPayloadType* PooledPayload, const ShotType& Shot, LogLevel)
		{
			CS_IS_PTR_NULL_CHECKED(Payload)
