...
#include "Spawner/Modifier/Copy/CsSpawnerModifier_Copy.h"
...
struct CSCORE_API FCsSpawnerModifier_Int
{
...
namespace NCsSpawner
{
	...
	#define CopyType NCsSpawner::NModifier::NCopy::ICopy
		...
		struct CSCORE_API FInt : public ModifierType,
...
*/
USTRUCT(BlueprintType)
struct CSCORE_API FCsSpawnerModifier_Float
{
	GENERATED_USTRUCT_BODY()
...
namespace NCsSpawner
{
	...
	#define CopyType NCsSpawner::NModifier::NCopy::ICopy
		...
		struct CSCORE_API FFloat : public ModifierType,
...
*/
USTRUCT(BlueprintType)
struct CSCORE_API FCsSpawnerModifier_Toggle
{
	GENERATED_USTRUCT_BODY()
...
namespace NCsSpawner
{
	...
	#define CopyType NCsSpawner::NModifier::NCopy::ICopy
		...
		struct CSCORE_API FToggle : public ModifierType,
...
USTRUCT(BlueprintType)
struct CSCORE_API FCsSpawnerModifierInfo
{
	GENERATED_USTRUCT_BODY()
