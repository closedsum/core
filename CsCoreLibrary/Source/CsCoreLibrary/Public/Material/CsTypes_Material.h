...
struct CSCORELIBRARY_API FCsMaterialInterface
{
	GENERATED_USTRUCT_BODY()

	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "CsCoreLibrary|Material")
	TSoftObjectPtr<UMaterialInterface> Material;

	UPROPERTY(BlueprintReadOnly, Category = "CsCoreLibrary|Material", meta = (Bitmask, BitmaskEnum = "/Script/CsTypes.ECsLoadFlags"))
	int32 Material_LoadFlags;

	UPROPERTY(Transient, BlueprintReadOnly, Category = "CsCoreLibrary|Material")
...
public:
	...
	* return			Material
	*/
	UMaterialInterface* GetSafe(const FString& Context, void(*Log)(const FString&) = &NCsCore::NLibrary::FLog::Warning) const
	{
	...
	*/
	...
	FORCEINLINE bool IsValid(const FString& Context, void(*Log)(const FString&) = &NCsCore::NLibrary::FLog::Warning) const
	{
	...
	FORCEINLINE bool IsTopValid(const FString& Context, void(*Log)(const FString&) = &NCsCore::NLibrary::FLog::Warning) const
	{
		if (!Material.ToSoftObjectPath().IsValid())
		{
			if (Log)
	...
	UMaterialInterface* SafeLoad(const FString& Context, void(*Log)(const FString&) = &NCsCore::NLibrary::FLog::Warning);

	FORCEINLINE UMaterialInterface* SafeLoad(const FString& Context, bool& OutSuccess, void(*Log)(const FString&) = &NCsCore::NLibrary::FLog::Warning)
	{
...
USTRUCT(BlueprintType)
struct CSCORELIBRARY_API FCsMaterialInstance
{
	GENERATED_USTRUCT_BODY()
	...
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "CsCoreLibrary|Material", meta = (Bitmask, BitmaskEnum = "/Script/CsTypes.ECsLoadFlags"))
	int32 Material_LoadFlags;
...
public:
	...
	* return			Material
	*/
	UMaterialInstance* GetSafe(const FString& Context, void(*Log)(const FString&) = &NCsCore::NLibrary::FLog::Warning) const
	{
		if (!Material.ToSoftObjectPath().IsValid())
		{
			if (Log)
...
USTRUCT(BlueprintType)
struct CSCORELIBRARY_API FCsMaterialInstanceConstant
{
	GENERATED_USTRUCT_BODY()
...
public:
	...
	* return			Material
	*/
	UMaterialInstanceConstant* GetSafe(const FString& Context, void(*Log)(const FString&) = &NCsCore::NLibrary::FLog::Warning) const
	{
		if (!Material.ToSoftObjectPath().IsValid())
		{
			if (Log)
...
*/
USTRUCT(BlueprintType)
struct CSCORELIBRARY_API FCsTArrayMaterialInterface
{
	GENERATED_USTRUCT_BODY()

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "CsCoreLibrary|Material")
	TArray<TSoftObjectPtr<UMaterialInterface>> Materials;

	UPROPERTY(BlueprintReadWrite, Category = "CsCoreLibrary|Material", meta = (Bitmask, BitmaskEnum = "/Script/CsTypes.ECsLoadFlags"))
	int32 Materials_LoadFlags;

	UPROPERTY(Transient, BlueprintReadWrite, Category = "CsCoreLibrary|Material")
...
public:
	...
	*/
	...
	{ 
		checkf(!Materials.IsEmpty(), TEXT("%s: No Materials set."), *Context);
	...
	*/
	...
	{
		checkf(!Materials.IsEmpty(), TEXT("FCsTArrayMaterialInterface::GetChecked: No Materials set."));
	...
	* return			Materials
	*/
	const TArray<UMaterialInterface*>* GetSafe(const FString& Context, void(*Log)(const FString&) = &NCsCore::NLibrary::FLog::Warning) const
	{
	...
	* return			Materials
	*/
	UMaterialInterface* GetSafeAt(const FString& Context, const int32& Index, void(*Log)(const FString&) = &NCsCore::NLibrary::FLog::Warning) const
	{
		if (Index < 0)
		{
			if (Log)
	...
	bool IsTopValid(const FString& Context, void(*Log)(const FString&) = &NCsCore::NLibrary::FLog::Warning) const
	{
		if (Materials.IsEmpty())
		{
			if (Log)
...
USTRUCT(BlueprintType)
struct CSCORELIBRARY_API FCsTArrayMaterialInstanceConstant
{
	GENERATED_USTRUCT_BODY()
...
public:
	...
	*/
	...
	{
		checkf(!Materials.IsEmpty(), TEXT("FCsTArrayMaterialInstanceConstant::GetChecked: No Materials set."));
	...
	* return			Materials
	*/
	const TArray<UMaterialInstanceConstant*>* GetSafe(const FString& Context, void(*Log)(const FString&) = &NCsCore::NLibrary::FLog::Warning) const
	{
		if (Materials.IsEmpty())
		{
			if (Log)
	...
	* return			Materials
	*/
	UMaterialInstanceConstant* GetSafeAt(const FString& Context, const int32& Index, void(*Log)(const FString&) = &NCsCore::NLibrary::FLog::Warning) const
	{
		if (Index < 0)
		{
			if (Log)
...
USTRUCT(BlueprintType)
struct CSCORELIBRARY_API FCsFpsTArrayMaterialInstanceConstant
{
	GENERATED_USTRUCT_BODY()

	UPROPERTY(EditAnywhere, Category = "CsCoreLibrary|Material")
	...
	UPROPERTY(EditAnywhere, Category = "CsCoreLibrary|Material", meta = (Bitmask, BitmaskEnum = "/Script/CsTypes.ECsLoadFlags"))
...
*/
USTRUCT(BlueprintType)
struct CSCORELIBRARY_API FCsMaterialParameterFloat
{
	GENERATED_USTRUCT_BODY()
...
#undef ParamsType
	...
	bool IsValid(const FString& Context, UMaterialInterface* Material, void(*Log)(const FString&) = &NCsCore::NLibrary::FLog::Warning) const;

	void SetChecked(const FString& Context, UMaterialInstanceDynamic* MID) const;
	bool SetSafe(const FString& Context, UMaterialInstanceDynamic* MID, void(*Log)(const FString&) = &NCsCore::NLibrary::FLog::Warning) const;
};
...
namespace NCsMaterial
{
	namespace NParameter
	{
		namespace NFloat
		{
			...
			* Describes a Material Float Parameters (Scalar as float).
			*/
			struct CSCORELIBRARY_API FValue final
			{
			private:
...
*/
USTRUCT(BlueprintType)
struct CSCORELIBRARY_API FCsMaterialParameterFloatRange
{
	GENERATED_USTRUCT_BODY()
...
namespace NCsMaterial
{
	namespace NParameter
	{
		namespace NFloat
		{
			...
			* a Min and Max value.
			*/
			struct CSCORELIBRARY_API FRange final
			{
			private:
...
*/
USTRUCT(BlueprintType)
struct CSCORELIBRARY_API FCsMaterialParameterColor
{
	GENERATED_USTRUCT_BODY()
...
*/
USTRUCT(BlueprintType)
struct CSCORELIBRARY_API FCsMaterialParameterColorRange
{
	GENERATED_USTRUCT_BODY()
...
*/
USTRUCT(BlueprintType)
struct CSCORELIBRARY_API FCsMaterialInterface_WithParameters
{
	GENERATED_USTRUCT_BODY()
...
#undef MaterialType
	...
	bool SetSafe(const FString& Context, UPrimitiveComponent* Component, const int32& Index, UMaterialInstanceDynamic*& OutMID, void(*Log)(const FString&) = &NCsCore::NLibrary::FLog::Warning) const;
...
namespace NCsMaterial
{
	namespace NInterface
	{
		...
		*/
		struct CSCORELIBRARY_API FWithParameters final
		{
		...
		public:
			...
			bool SetSafe(const FString& Context, UPrimitiveComponent* Component, const int32& Index, void(*Log)(const FString&) = &NCsCore::NLibrary::FLog::Warning) const;
...
*/
USTRUCT(BlueprintType)
struct CSCORELIBRARY_API FCsMaterialInterface_WithRangeParameters
{
	GENERATED_USTRUCT_BODY()
...
namespace NCsMaterial
{
	namespace NInterface
	{
		...
		*  random values within the defined ranges.
		*/
		struct CSCORELIBRARY_API FWithRangeParameters final
		{
...
USTRUCT(BlueprintType)
struct CSCORELIBRARY_API FCsMaterialParameterCollection
{
	GENERATED_USTRUCT_BODY()
...
public:
	...
	* return			Material Parameter Collection
	*/
	UMaterialParameterCollection* GetSafe(const FString& Context, void(*Log)(const FString&) = &NCsCore::NLibrary::FLog::Warning) const
	{
