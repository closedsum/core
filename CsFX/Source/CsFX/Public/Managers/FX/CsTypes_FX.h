...
struct CSFX_API EMCsFX final : public TCsEnumStructMap<FECsFX, uint8>
{
...
namespace NCsFX
{
	...
	CSFX_API void PopulateEnumMapFromSettings(const FString& Context, UObject* ContextRoot);
}
...
*/
USTRUCT(BlueprintType)
struct CSFX_API FCsParticleSystem
{
	GENERATED_USTRUCT_BODY()
...
struct CSFX_API EMCsFXPriority final : public TCsEnumMap<ECsFXPriority>
{
...
namespace NCsFXPriority
{
	...
	namespace Ref
	{
		extern CSFX_API const Type Low;
		extern CSFX_API const Type Medium;
		extern CSFX_API const Type High;
		extern CSFX_API const Type ECsFXPriority_MAX;
	}
...
struct CSFX_API EMCsFXDeallocateMethod final : public TCsEnumMap<ECsFXDeallocateMethod>
{
...
namespace NCsFXDeallocateMethod
{
	...
	namespace Ref
	{
		...
		extern CSFX_API const Type ECsFXDeallocateMethod_MAX;
	}
...
namespace NCsFX
{
	...
	struct CSFX_API EMDeallocateMethod final : public TCsEnumMap<EDeallocateMethod>
	{
...
*/
USTRUCT(BlueprintType)
struct CSFX_API FCsNiagaraSystem
{
	GENERATED_USTRUCT_BODY()
...
public:
	...
	* return			System
	*/
	UNiagaraSystem* GetSafe(const FString& Context, void(*Log)(const FString&) = &NCsFX::FLog::Warning) const
	{
...
*/
USTRUCT(BlueprintType)
struct CSFX_API FCsNiagaraParameterCollection
{
	GENERATED_USTRUCT_BODY()
...
public:
	...
	* return			Collection
	*/
	UNiagaraParameterCollection* GetSafe(const FString& Context, void(*Log)(const FString&) = &NCsFX::FLog::Warning) const
	{
...
struct CSFX_API EMCsFXAttachPoint final : public TCsEnumMap<ECsFXAttachPoint>
{
...
namespace NCsFXAttachPoint
{
	...
	namespace Ref
	{
		...
		extern CSFX_API const Type Bone;
		extern CSFX_API const Type Socket;
		extern CSFX_API const Type ECsFXAttachPoint_MAX;
	}
...
struct CSFX_API EMCsFXOrientationRule : public TCsEnumMap<ECsFXOrientationRule>
{
...
namespace NCsFXOrientationRule
{
	...
	{
		extern CSFX_API const Type None;
		extern CSFX_API const Type Parent;
		extern CSFX_API const Type Movement;
		extern CSFX_API const Type Custom;
		extern CSFX_API const Type ECsFXOrientationRule_MAX;
	}
}
...
*/
USTRUCT(BlueprintType)
struct CSFX_API FCsFXOrientationRules
{
	GENERATED_USTRUCT_BODY()
...
struct CSFX_API EMCsFXParameterValue final : public TCsEnumMap<ECsFXParameterValue>
{
...
namespace NCsFXParameterValue
{
	...
	namespace Ref
	{
		...
		extern CSFX_API const Type ECsFXParameterValue_MAX;
	}
...
USTRUCT(BlueprintType)
struct CSFX_API FCsFXParameterInt
{
	GENERATED_USTRUCT_BODY()
...
USTRUCT(BlueprintType)
struct CSFX_API FCsFXParameterFloat
{
	GENERATED_USTRUCT_BODY()
...
*/
USTRUCT(BlueprintType)
struct CSFX_API FCsFXParameterVector
{
	GENERATED_USTRUCT_BODY()
...
USTRUCT(BlueprintType)
struct CSFX_API FCsFX_Parameter_Scaled_Int
{
	GENERATED_USTRUCT_BODY()
...
USTRUCT(BlueprintType)
struct CSFX_API FCsFX_Parameter_Scaled_Float
{
	GENERATED_USTRUCT_BODY()
...
USTRUCT(BlueprintType)
struct CSFX_API FCsFX_Parameter_Scaled_Vector
{
	GENERATED_USTRUCT_BODY()
...
USTRUCT(BlueprintType)
struct CSFX_API FCsFX_Parameters_Scaled
{
	GENERATED_USTRUCT_BODY()
...
struct CSFX_API EMCsFXParameterDataInterfaceSkeletalMeshMethod final : public TCsEnumMap<ECsFXParameterDataInterfaceSkeletalMeshMethod>
{
...
namespace NCsFXParameterDataInterfaceSkeletalMeshMethod
{
	...
	namespace Ref
	{
		...
		extern CSFX_API const Type ECsFXParameterDataInterfaceSkeletalMeshMethod_MAX;
	}
}
...
*/
USTRUCT(BlueprintType)
struct CSFX_API FCsFX_Parameters_DataInterface_SkeletalMesh
{
	GENERATED_USTRUCT_BODY()
...
USTRUCT(BlueprintType)
struct CSFX_API FCsFX_Parameters_DataInterface
{
	GENERATED_USTRUCT_BODY()
...
struct CSFX_API EMCsFXPayloadChange : public TCsEnumFlagMap<ECsFXPayloadChange>
{
...
namespace NCsFXPayloadChange
{
	...
	namespace Ref
	{
		extern CSFX_API const Type FXSystem;
		extern CSFX_API const Type KeepRelativeTransform;
		extern CSFX_API const Type KeepWorldTransform;
		extern CSFX_API const Type SnapToTargetNotIncludingScale;
		extern CSFX_API const Type SnapToTargetIncludingScale;
		extern CSFX_API const Type Transform;
		extern CSFX_API const Type Parameter;
	}

	extern CSFX_API const int32 None;
	extern CSFX_API const int32 All;
}
