...
struct CSTYPES_API EMCsAnimPlayRate : public TCsEnumMap<ECsAnimPlayRate>
{
...
namespace NCsAnimPlayRate
{
	...
	namespace Ref
	{
		extern CSTYPES_API const Type PR_0_001;
		extern CSTYPES_API const Type PR_0_01;
		extern CSTYPES_API const Type PR_0_1;
		extern CSTYPES_API const Type PR_1;
		extern CSTYPES_API const Type PR_10;
		extern CSTYPES_API const Type PR_100;
		extern CSTYPES_API const Type PR_15Fps;
		extern CSTYPES_API const Type PR_24Fps;
		extern CSTYPES_API const Type PR_25Fps;
		extern CSTYPES_API const Type PR_29_97Fps;
		extern CSTYPES_API const Type PR_30Fps;
		extern CSTYPES_API const Type PR_48Fps;
		extern CSTYPES_API const Type PR_50Fps;
		extern CSTYPES_API const Type PR_59_94Fps;
		extern CSTYPES_API const Type PR_60Fps;
		extern CSTYPES_API const Type PR_120Fps;
		extern CSTYPES_API const Type PR_CustomDeltaTime;
		extern CSTYPES_API const Type PR_CustomTotalTime;
		extern CSTYPES_API const Type PR_CustomDeltaTimeAndTotalTime;
		extern CSTYPES_API const Type PR_CustomDeltaTimePerFrame;
		extern CSTYPES_API const Type PR_Custom;
		extern CSTYPES_API const Type ECsAnimPlayRate_MAX;
	}
...
namespace NCsAnim
{
	...
	*/
	...
	struct CSTYPES_API EMPlayRate : public TCsEnumMap<EPlayRate>
	{
	...
	namespace NPlayRate
	{
		...
		namespace Ref
		{
			...
			extern CSTYPES_API const Type PR_CustomDeltaTimePerFrame;
			extern CSTYPES_API const Type PR_Custom;
			extern CSTYPES_API const Type EPlayRate_MAX;
		}

		extern CSTYPES_API const uint8 MAX;

		CSTYPES_API float GetDeltaTime(const EPlayRate& PlayRate);
	}
}
