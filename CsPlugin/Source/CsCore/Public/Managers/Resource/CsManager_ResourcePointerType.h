...
public:
		...
		AllocationOrder()
	{
		...
		AdvancePoolIndex = &TCsManager_ResourcePointerType<ResourceType, ResourceContainerType>::AdvancePoolIndexByOrder;
	}
...
private:
	...
	void (TCsManager_ResourcePointerType<ResourceType, ResourceContainerType>::* AdvancePoolIndex)();
