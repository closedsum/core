...
public:
	...
	UFUNCTION(BlueprintCallable, Category = "CsCore|Library|SkeletalMesh", meta = (DisplayName = "Unload (FCsSkeletalMesh)", CompactNodeTitle = "Unload"))
	static void FCsSkeletalMesh_Unload(UPARAM(ref) FCsSkeletalMesh& Mesh)
	{
		Mesh.Unload();
	}

	UFUNCTION(BlueprintCallable, Category = "CsCore|Library|SkeletalMesh", meta = (DisplayName = "Unload (TArray<FCsSkeletalMesh>)", CompactNodeTitle = "Unload"))
