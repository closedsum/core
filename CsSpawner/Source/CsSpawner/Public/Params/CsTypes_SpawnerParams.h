...
struct CSSPAWNER_API FCsSpawner_CountParams
{
...
struct CSSPAWNER_API EMCsSpawnerFrequency : public TCsEnumMap<ECsSpawnerFrequency>
{
...
namespace NCsSpawnerFrequency
{
	...
	namespace Ref
	{
		extern CSSPAWNER_API const Type Once;
		extern CSSPAWNER_API const Type Count;
		extern CSSPAWNER_API const Type TimeCount;
		extern CSSPAWNER_API const Type TimeInterval;
		extern CSSPAWNER_API const Type Infinite;
		extern CSSPAWNER_API const Type InfiniteFillToCount;
		extern CSSPAWNER_API const Type ECsSpawnerFrequency_MAX;
	}

	extern CSSPAWNER_API const uint8 MAX;
}
...
namespace NCsSpawner
{
	...
	*/
	...
	struct CSSPAWNER_API EMFrequency : public TCsEnumMap<EFrequency>
	{
	...
	namespace NFrequency
	{
		namespace Ref
		{
			...
			extern CSSPAWNER_API const Type Infinite;
			extern CSSPAWNER_API const Type InfiniteFillToCount;
			extern CSSPAWNER_API const Type EFrequency_MAX;
		}
...
*/
USTRUCT(BlueprintType)
struct CSSPAWNER_API FCsSpawner_FrequencyParams
{
	GENERATED_USTRUCT_BODY()
...
namespace NCsSpawner
{
	namespace NParams
	{
		struct CSSPAWNER_API FFrequency
		{
...
struct CSSPAWNER_API EMCsSpawnerPoint : public TCsEnumMap<ECsSpawnerPoint>
{
...
namespace NCsSpawnerPoint
{
	...
	namespace Ref
	{
		extern CSSPAWNER_API const Type Self;
		extern CSSPAWNER_API const Type Transform;
		extern CSSPAWNER_API const Type Actor;
		extern CSSPAWNER_API const Type Custom;
		extern CSSPAWNER_API const Type ECsSpawnerPoint_MAX;
	}
...
namespace NCsSpawner
{
	...
	struct CSSPAWNER_API EMPoint : public TCsEnumMap<EPoint>
	{
	...
	namespace NPoint
	{
		namespace Ref
		{
			...
			extern CSSPAWNER_API const Type Actor;
			extern CSSPAWNER_API const Type Custom;
			extern CSSPAWNER_API const Type EPoint_MAX;
		}
	}
}
...
struct CSSPAWNER_API EMCsSpawnerShape : public TCsEnumMap<ECsSpawnerShape>
{
...
namespace NCsSpawnerShape
{
	...
	namespace Ref
	{
		extern CSSPAWNER_API const Type Circle;
		extern CSSPAWNER_API const Type Rectangle;
		extern CSSPAWNER_API const Type Sphere;
		extern CSSPAWNER_API const Type Box;
		extern CSSPAWNER_API const Type Custom;
		extern CSSPAWNER_API const Type ECsSpawnerShape_MAX;
	}
...
namespace NCsSpawner
{
	...
	struct CSSPAWNER_API EMShape : public TCsEnumMap<EShape>
	{
	...
	namespace NShape
	{
		namespace Ref
		{
			...
			extern CSSPAWNER_API const Type Box;
			extern CSSPAWNER_API const Type Custom;
			extern CSSPAWNER_API const Type EShape_MAX;
		}
	}
}
...
struct CSSPAWNER_API EMCsSpawnerShapeCenter : public TCsEnumMap<ECsSpawnerShapeCenter>
{
...
namespace NCsSpawnerShapeCenter
{
	...
	namespace Ref
	{
		...
		extern CSSPAWNER_API const Type Actor;
		extern CSSPAWNER_API const Type Custom;
		extern CSSPAWNER_API const Type ECsSpawnerShapeCenter_MAX;
	}
...
namespace NCsSpawner
{
	namespace NShape
	{
		...
		struct CSSPAWNER_API EMCenter : public TCsEnumMap<ECenter>
		{
		...
		namespace NCenter
		{
			namespace Ref
			{
				...
				extern CSSPAWNER_API const Type Actor;
				extern CSSPAWNER_API const Type Custom;
				extern CSSPAWNER_API const Type ECenter_MAX;
			}
		}
	}
}
...
struct CSSPAWNER_API EMCsSpawnerDistribution : public TCsEnumMap<ECsSpawnerDistribution>
{
...
namespace NCsSpawnerDistribution
{
	...
	namespace Ref
	{
		extern CSSPAWNER_API const Type Uniform;
		extern CSSPAWNER_API const Type ECsSpawnerDistribution_MAX;
	}
...
namespace NCsSpawner
{
	...
	struct CSSPAWNER_API EMDistribution : public TCsEnumMap<EDistribution>
	{
	...
	namespace NDistribution
	{
		namespace Ref
		{
			...
			extern CSSPAWNER_API const Type Uniform;
			extern CSSPAWNER_API const Type EDistribution_MAX;
		}
	}
}
