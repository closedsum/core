...
namespace NCsSound
{
	namespace NManager
	{
		...
		UCsManager_Sound* FLibrary::GetSafe(const FString& Context, const UObject* ContextObject, void(*Log)(const FString&) /*= &NCsSound::FLog::Warning*/)
		{
		...
		const FCsSoundPooled* FLibrary::FindSafeObject(const FString& Context, const UObject* WorldContext, const FECsSound& Type, const int32& Index, void(*Log)(const FString&) /*=&NCsSound::FLog::Warning*/)
		{
		...
		PayloadType* FLibrary::SafeAllocatePayload(const FString& Context, const UObject* WorldContext, const FECsSound& Type, void(*Log)(const FString&) /*=&NCsSound::FLog::Warning*/)
		{
			if (UCsManager_Sound* Manager_Sound = GetSafe(Context, WorldContext, Log))
			{
				CS_IS_ENUM_STRUCT_VALID_RET_NULL(EMCsSound, FECsSound, Type)
		...
		const FCsSoundPooled* FLibrary::SafeSpawn(const FString& Context, const UObject* WorldContext, const FCsSound& Sound, void(*Log)(const FString&) /*=&NCsSound::FLog::Warning*/)
		{
