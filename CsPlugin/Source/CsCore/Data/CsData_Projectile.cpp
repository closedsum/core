...
const FName& ACsData_Projectile::GetItemShortCode() { return NCsCached::Name::None; }

const bool& ACsData_Projectile::GetOnAllocateDropItem() { return NCsCached::Ref::False;  }
const bool& ACsData_Projectile::GetOnAllocateConsumeItem() { return NCsCached::Ref::False; }

const float& ACsData_Projectile::GetLifeTime() { return NCsCached::Ref::Float; }
const float& ACsData_Projectile::GetMaxRange() { return NCsCached::Ref::Float; }
...
const float& ACsData_Projectile::GetInitialSpeed() { return NCsCached::Ref::Float; }
const float& ACsData_Projectile::GetMaxSpeed() { return NCsCached::Ref::Float; }
const float& ACsData_Projectile::GetGravityMultiplier() { return NCsCached::Ref::Float; }
...
const int32& ACsData_Projectile::GetDamage() { return NCsCached::Ref::SInt; }
const bool& ACsData_Projectile::CanDamageFalloff() { return NCsCached::Ref::False; }
float ACsData_Projectile::GetDamageFalloff(const float &Distance) { return 1.0f; }
const bool& ACsData_Projectile::CanDamageRadial() { return NCsCached::Ref::False; }
...
const float& ACsData_Projectile::GetSphereRadius() { return NCsCached::Ref::Float; }
...
const bool& ACsData_Projectile::GetUseTrailFX() { return NCsCached::Ref::False; }
