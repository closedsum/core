...
struct CSTYPES_API FCsTextureRenderTarget2D
{
	GENERATED_USTRUCT_BODY()

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "CsTypes|Render")
	TSoftObjectPtr<UTextureRenderTarget2D> Texture;

	UPROPERTY(BlueprintReadOnly, Category = "CsTypes|Render")
	int32 Texture_LoadFlags;

	UPROPERTY(Transient, BlueprintReadOnly, Category = "CsTypes|Render")
	...
	* return			Static Mesh
	*/
	UTextureRenderTarget2D* GetSafe(const FString& Context, void(*Log)(const FString&) = &NCsTypes::FLog::Warning) const
	{
...
USTRUCT(BlueprintType)
struct CSTYPES_API FCsTextureRenderTarget2D_Array
{
	GENERATED_USTRUCT_BODY()
...
*/
USTRUCT(BlueprintType)
struct CSTYPES_API FCsTArrayTextureRenderTarget2D
{
	GENERATED_USTRUCT_BODY()

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "CsTypes|Texture")
	TArray<TSoftObjectPtr<UTextureRenderTarget2D>> Textures;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "CsTypes|Texture", meta = (Bitmask, BitmaskEnum = "/Script/CsTypes.ECsLoadFlags"))
	int32 Textures_LoadFlags;

	UPROPERTY(Transient, BlueprintReadWrite, Category = "CsTypes|Texture")
...
public:
	...
	*/
	...
	{ 
		checkf(!Textures.IsEmpty(), TEXT("%s: No Textures set."), *Context);
	...
	*/
	...
	{
		checkf(!Textures.IsEmpty(), TEXT("FCsTArrayTextureRenderTarget2D::GetChecked: No Textures set."));
	...
	* return			Textures
	*/
	const TArray<UTextureRenderTarget2D*>* GetSafe(const FString& Context, void(*Log)(const FString&) = &NCsTypes::FLog::Warning) const
	{
		if (Textures.IsEmpty())
		{
			if (Log)
