...
struct CSBLOCKCHAIN_API EMCsBlockchainType : public TCsEnumMap<ECsBlockchainType>
{
...
namespace NCsBlockchainType
{
	namespace Ref
	{
		...
		extern CSBLOCKCHAIN_API const Type PrivateSingleNode;
		extern CSBLOCKCHAIN_API const Type Local;
		extern CSBLOCKCHAIN_API const Type Server;
		extern CSBLOCKCHAIN_API const Type ECsBlockchainType_MAX;
	}
}
...
struct CSBLOCKCHAIN_API EMCsBlockchainProcessType : public TCsEnumMap<ECsBlockchainProcessType>
{
...
namespace NCsBlockchainProcessType
{
	namespace Ref
	{
		...
		extern CSBLOCKCHAIN_API const Type RunningInstance;
		extern CSBLOCKCHAIN_API const Type Console;
		extern CSBLOCKCHAIN_API const Type ECsBlockchainProcessType_MAX;
	}
}
...
struct FCsBlockchainCommandInfo
{
	...
	FORCEINLINE void Reset()
	{
		...
		Payload_int32 = 0;
		Payload_float = 0.0f;
		Payload_FString = NCsCached::Str::Empty;
		Payload_ptr = nullptr;
	}
};
...
UCLASS(transient)
class CSBLOCKCHAIN_API UCsBlockchain: public UObject
{
