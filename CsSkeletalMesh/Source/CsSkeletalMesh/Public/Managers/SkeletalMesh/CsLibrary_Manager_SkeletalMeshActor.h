...
namespace NCsSkeletalMeshActor
{
	namespace NManager
	{
		struct CSSKELETALMESH_API FLibrary final
		{
		...
		public:
			...
			* return				UCsManager_SkeletalMeshActor.
			*/
			static UCsManager_SkeletalMeshActor* GetSafe(const FString& Context, const UObject* WorldContext, LogLevel);
		...
		#define ShotType NCsSkeletalMeshActor::NAnim::NSequence::FOneShot
			...
			* return				Spawned SkeletalMeshActor
			*/
			static const FCsSkeletalMeshActorPooled* SafeSpawn(const FString& Context, const UObject* WorldContext, const PooledPayloadType* PooledPayload, const ShotType& Shot, const FTransform3f& Transform = FTransform3f::Identity, LogLevel);
