...
{
	extern CSBLOCKCHAIN_API const FECsBlockchainCommand InitBlockchain;
	extern CSBLOCKCHAIN_API const FECsBlockchainCommand SetDataDirectory;
	extern CSBLOCKCHAIN_API const FECsBlockchainCommand AttachToConsole;
	extern CSBLOCKCHAIN_API const FECsBlockchainCommand ExitConsole;
	extern CSBLOCKCHAIN_API const FECsBlockchainCommand NewAccount;
	extern CSBLOCKCHAIN_API const FECsBlockchainCommand UnlockAccount;
	extern CSBLOCKCHAIN_API const FECsBlockchainCommand ListAccounts;
	extern CSBLOCKCHAIN_API const FECsBlockchainCommand SetEtherbase;
	extern CSBLOCKCHAIN_API const FECsBlockchainCommand GetBalanceEther;
	extern CSBLOCKCHAIN_API const FECsBlockchainCommand GetBalanceWei;
	extern CSBLOCKCHAIN_API const FECsBlockchainCommand StartMiner;
	extern CSBLOCKCHAIN_API const FECsBlockchainCommand StopMiner;
	extern CSBLOCKCHAIN_API const FECsBlockchainCommand DeployContract;
	extern CSBLOCKCHAIN_API const FECsBlockchainCommand LoadScript;
	extern CSBLOCKCHAIN_API const FECsBlockchainCommand CreateContractABI;
	extern CSBLOCKCHAIN_API const FECsBlockchainCommand CreateContractInstance;
	extern CSBLOCKCHAIN_API const FECsBlockchainCommand RunContractConstantFunction;
	extern CSBLOCKCHAIN_API const FECsBlockchainCommand RunContractStateChangeFunction;
	extern CSBLOCKCHAIN_API const FECsBlockchainCommand GetGasEstimate;
	extern CSBLOCKCHAIN_API const FECsBlockchainCommand GetTransactionReceipt;

	extern CSBLOCKCHAIN_API const FECsBlockchainCommand MAX;
}
...
USTRUCT(BlueprintType)
struct CSBLOCKCHAIN_API FECsEthereumJavascript : public FECsEnum_uint8
{
	GENERATED_USTRUCT_BODY()
...
struct CSBLOCKCHAIN_API EMCsEthereumJavascript : public TCsEnumStructMap<FECsEthereumJavascript, uint8>
{
	CS_DECLARE_ENUM_STRUCT_MAP_BODY(EMCsEthereumJavascript)
};

USTRUCT(BlueprintType)
struct CSBLOCKCHAIN_API FCsEthereumJavascriptContractLink
{
	GENERATED_USTRUCT_BODY()
...
UCLASS(transient)
class CSBLOCKCHAIN_API UCsEthereum : public UCsBlockchain
{
