...
struct CSSKELETALMESH_API FCsSettings_Manager_SkeletalMeshActor_PoolParams
{
...
USTRUCT(BlueprintType)
struct CSSKELETALMESH_API FCsSettings_Manager_SkeletalMeshActor
{
	GENERATED_USTRUCT_BODY()
...
USTRUCT(BlueprintType)
struct CSSKELETALMESH_API FCsSettings_Manager_SkeletalMeshActor_UnitTest
{
	GENERATED_USTRUCT_BODY()
...
public:
	...
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "CsCore|Managers|Skeletal Mesh", meta = (AllowedClasses = "/Script/Engine.World"))
	FSoftObjectPath Map;
