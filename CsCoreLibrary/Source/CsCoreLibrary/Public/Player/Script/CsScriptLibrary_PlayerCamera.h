...
UCLASS()
class CSCORELIBRARY_API UCsScriptLibrary_PlayerCamera : public UObject
{
...
public:
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "CsCoreLibrary|Library|Player|Camera", meta = (WorldContext = "WorldContextObject", AutoCreateRefTerm = "Context,ControllerId"))
	...
	* return					PlayerCameraManager
	*/
	UFUNCTION(BlueprintCallable, Category = "CsCoreLibrary|Library|Player|Camera", meta = (DisplayName = "Get (Checked)", WorldContext = "WorldContextObject", AutoCreateRefTerm = "Context,ControllerId"))
	...
	* return					PlayerCameraManager
	*/
	UFUNCTION(BlueprintCallable, Category = "CsCoreLibrary|Library|Player|Camera", meta = (AutoCreateRefTerm = "Context"))
	...
	* return					PlayerCameraManager
	*/
	UFUNCTION(BlueprintCallable, Category = "CsCoreLibrary|Library|Player|Camera", meta = (DisplayName = "Get by Pawn (Checked)", AutoCreateRefTerm = "Context,ControllerId"))
...
public:
	...
	UFUNCTION(BlueprintCallable, Category = "CsCoreLibrary|Library|Player|Camera", meta = (AutoCreateRefTerm = "Context,TransitionParams"))
	...
	UFUNCTION(BlueprintCallable, Category = "CsCoreLibrary|Library|Player|Camera", meta = (DisplayName = "Set View Target (Checked)", AutoCreateRefTerm = "Context,TransitionParams"))
	...
	UFUNCTION(BlueprintCallable, Category = "CsCoreLibrary|Library|Player|Camera", meta = (DisplayName = "Set View Target by Pawn", AutoCreateRefTerm = "Context,TransitionParams"))
	...
	UFUNCTION(BlueprintCallable, Category = "CsCoreLibrary|Library|Player|Camera", meta = (DisplayName = "Set View Target by Pawn (Checked)", AutoCreateRefTerm = "Context,TransitionParams"))
...
public:
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "CsCoreLibrary|Library|Player|Camera", meta = (WorldContext = "WorldContextObject", AutoCreateRefTerm = "Context,ControllerId,FOV"))
	...
	* @param OutSuccess			(out)
	*/
	UFUNCTION(BlueprintCallable, Category = "CsCoreLibrary|Library|Player|Camera", meta = (DisplayName = "Set FOV (Checked)", WorldContext = "WorldContextObject", AutoCreateRefTerm = "Context,ControllerId,FOV"))
	...
	* return			Whether the FOV was set or not.
	*/
	UFUNCTION(BlueprintCallable, Category = "CsCoreLibrary|Library|Player|Camera", meta = (DisplayName = "Set FOV by Pawn", AutoCreateRefTerm = "Context,FOV"))
	...
	* @param OutSuccess		(out)
	*/
	UFUNCTION(BlueprintCallable, Category = "CsCoreLibrary|Library|Player|Camera", meta = (DisplayName = "Set FOV by Pawn (Checked)", AutoCreateRefTerm = "Context,FOV"))
	...
	* return						FOV angle in degrees.
	*/
	UFUNCTION(BlueprintCallable, Category = "CsCoreLibrary|Library|Player|Camera", meta = (DisplayName = "Get FOV (Checked)", WorldContext = "WorldContextObject", AutoCreateRefTerm = "Context,ControllerId"))
	...
	* return				FOV angle in degrees.
	*/
	UFUNCTION(BlueprintCallable, Category = "CsCoreLibrary|Library|Player|Camera", meta = (DisplayName = "Get FOV by Pawn", AutoCreateRefTerm = "Context"))
	...
	* return				FOV angle in degrees.
	*/
	UFUNCTION(BlueprintCallable, Category = "CsCoreLibrary|Library|Player|Camera", meta = (DisplayName = "Get FOV by Pawn (Checked)", AutoCreateRefTerm = "Context"))
...
public:
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "CsCoreLibrary|Library|Player|Camera", meta = (WorldContext = "WorldContextObject", AutoCreateRefTerm = "Context,ControllerId,MinPitch"))
	...
	* @param OutSuccess			(out)
	*/
	UFUNCTION(BlueprintCallable, Category = "CsCoreLibrary|Library|Player|Camera", meta = (DisplayName = "Set View Pitch Min (Checked)", WorldContext = "WorldContextObject", AutoCreateRefTerm = "Context,ControllerId,MinPitch"))
	...
	* return			Whether the minimum view pitch was set or not.
	*/
	UFUNCTION(BlueprintCallable, Category = "CsCoreLibrary|Library|Player|Camera", meta = (DisplayName = "Set View Pitch Min by Pawn", AutoCreateRefTerm = "Context,MinPitch"))
	...
	* @param OutSuccess		(out)
	*/
	UFUNCTION(BlueprintCallable, Category = "CsCoreLibrary|Library|Player|Camera", meta = (DisplayName = "Set View Pitch Min by Pawn (Checked)", AutoCreateRefTerm = "Context,MinPitch"))
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "CsCoreLibrary|Library|Player|Camera", meta = (WorldContext = "WorldContextObject", AutoCreateRefTerm = "Context,ControllerId,MaxPitch"))
	...
	* @param OutSuccess			(out)
	*/
	UFUNCTION(BlueprintCallable, Category = "CsCoreLibrary|Library|Player|Camera", meta = (DisplayName = "Set View Pitch Max (Checked)", WorldContext = "WorldContextObject", AutoCreateRefTerm = "Context,ControllerId,MaxPitch"))
	...
	* return			Whether the maximum view pitch was set or not.
	*/
	UFUNCTION(BlueprintCallable, Category = "CsCoreLibrary|Library|Player|Camera", meta = (DisplayName = "Set View Pitch Max by Pawn", AutoCreateRefTerm = "Context,MaxPitch"))
	...
	* @param OutSuccess		(out)
	*/
	UFUNCTION(BlueprintCallable, Category = "CsCoreLibrary|Library|Player|Camera", meta = (DisplayName = "Set View Pitch Max by Pawn (Checked)", AutoCreateRefTerm = "Context,MaxPitch"))
