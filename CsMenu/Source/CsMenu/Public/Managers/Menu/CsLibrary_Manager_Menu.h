	...
	namespace NManager
	{
		namespace NLibrary
		{
			namespace NCached
			{
				namespace Str
				{
					extern CSMENU_API const FString GetSafe;
				}
			}
		}

		struct CSMENU_API FLibrary
		{
		...
		public:
			...
			* return				UCsManager_Menu.
			*/
			static UCsManager_Menu* GetSafe(const FString& Context, const UObject* ContextObject, LogLevel);
			...
			* return				UCsManager_Menu.
			*/
			static UCsManager_Menu* GetSafe(const FString& Context, const UObject* ContextObject, bool& OutSuccess, LogLevel);
