...
struct CSDATA_API FCsSettings_EnumStruct_PopulateByDataTable
{
	GENERATED_USTRUCT_BODY()

	/** Whether to populate the RowName, Name, and DisplayName from the Data. */
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "CsData|Settings")
	bool bPopulateNamesByData;

	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "CsData|Settings", meta = (DisplayName = "Remove From Start: Defualt__"))
	bool bRemoveFromStart_Default;

	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "CsData|Settings", meta = (DisplayName = "Remove From Start: BP_Data_"))
	bool bRemoveFromStart_BP_Data;

	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "CsData|Settings", meta = (DisplayName = "Remove From Start: BP_ScriptData_"))
