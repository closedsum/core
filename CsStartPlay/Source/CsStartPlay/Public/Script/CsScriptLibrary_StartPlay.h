...
UCLASS()
class CSSTARTPLAY_API UCsScriptLibrary_StartPlay : public UObject
{
...
public:
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "CsStartPlay|Library|Start Play", meta = (WorldContext = "WorldContextObject", AutoCreateRefTerm = "Context"))
